...
When you 're tasked by using "Les Journées de la Recherche Porcine (French)" (CRN) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Les Journées de la Recherche Porcine (French)

* Title: Les Journées de la Recherche Porcine (French)
* Short Title (Id): CRN)
* Authors: Les Journées de la Recherche Porcine (French)
* Download: Les Journées de la Recherche Porcine (French)
 --->

## How can CiteDrive help you with Les Journées de la Recherche Porcine (French)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Les Journées de la Recherche Porcine (French) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/les-journees-de-la-recherche-porcine-french.svg "Choose Les Journées de la Recherche Porcine (French) in the CiteDrive App")
...
## How do I cite in  Les Journées de la Recherche Porcine (French)?
...
## How do I create a bibliography in Les Journées de la Recherche Porcine (French)?
...
!!! Doe J., Doe J., Title #2. Consultable  : https://example.com/ [Consulté le 1 mai 2021].
