...
When you 're tasked by using "Taxon" (Struct Chem) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
and then to the third.  (Doe &amp; al., n.d.)
This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe, 2008; Doe &amp; al., n.d.)

:::

## How do I create a bibliography in Taxon?
...
<b>Doe, J., &amp; Doe, J.</b>.  (n.d.). Title #2. https://example.com/ (accessed 1 May 2021). 
