...
When you 're tasked by using "Palaeodiversity" (ABNT-IPEA) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Palaeodiversity?
...
This paragraph demonstrates the clustering of citations by citing the first and third item. (<span style={{"font-variant":"small-caps"}}>Doe et al.</span>n.d.; <span style={{"font-variant":"small-caps"}}>Doe</span> 2008)

:::

## How do I create a bibliography in Palaeodiversity?
...
<span style={{"font-variant":"small-caps"}}>Doe, J.</span> (2008): Title #1. – Imaginary Journal, <b>3</b> : 1–999.

<span style={{"font-variant":"small-caps"}}>Doe, J.&amp; Doe, J.</span> (n.d.): Title #2. . Retrieved  1 May 2021,  from https://example.com/

<span style={{"font-variant":"small-caps"}}>Doe, J., Doe, J.&amp; Python, M.</span> (n.d.): Title #3. – ABC.
