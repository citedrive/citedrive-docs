...
When you 're tasked by using "Springer - Basic (numeric, brackets, no "et al.", alphabetical)" (APJTD) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Springer - Basic (numeric, brackets, no "et al.", alphabetical)

* Title: Springer - Basic (numeric, brackets, no "et al.", alphabetical)
* Short Title (Id): APJTD)
* Authors: Springer - Basic (numeric, brackets, no "et al.", alphabetical)
* Download: Springer - Basic (numeric, brackets, no "et al.", alphabetical)
 --->

## How can CiteDrive help you with Springer - Basic (numeric, brackets, no "et al.", alphabetical)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Springer - Basic (numeric, brackets, no "et al.", alphabetical) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/springer--basic-numeric-brackets-no-et-al-alphabetical.svg "Choose Springer - Basic (numeric, brackets, no "et al.", alphabetical) in the CiteDrive App")
...
## How do I cite in  Springer - Basic (numeric, brackets, no "et al.", alphabetical)?
...
## How do I create a bibliography in Springer - Basic (numeric, brackets, no "et al.", alphabetical)?
