...
# Universitätsmedizin Göttingen (German)

When you 're tasked by using "Universitätsmedizin Göttingen (German)" (UMG) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Universitätsmedizin Göttingen (German)

* Title: Universitätsmedizin Göttingen (German)
* Short Title (Id): UMG)
* Authors: Universitätsmedizin Göttingen (German)
* Download: Universitätsmedizin Göttingen (German)
 --->

## How can CiteDrive help you with Universitätsmedizin Göttingen (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Universitätsmedizin Göttingen (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/universitatsmedizin-gottingen-german.svg "Choose Universitätsmedizin Göttingen (German) in the CiteDrive App")
...
## How do I cite in  Universitätsmedizin Göttingen (German)?
...
## How do I create a bibliography in Universitätsmedizin Göttingen (German)?
...
!!! **Bibliography**
!!! Doe J (2008): Title #1. Imaginary Journal <u>3</u>, 1–999
!!! Doe J, Doe J. https://example.com/; Zugriff am 01.05.2021
