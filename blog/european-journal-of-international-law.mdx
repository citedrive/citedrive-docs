...
When you 're tasked by using "European Journal of International Law" (J Autom Reasoning) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  European Journal of International Law?
...
This sentence refers to the first item from the table. Doe,  'Title #1',  3 <i>Imaginary Journal</i> (2008) 1. This, in turn, refers to the second J. Doe and J. Doe, <i>Title #2</i>, available at https://example.com/ (last visited 1 May 2021).
and then to the third.  Doe, Doe and Python,  'Title #3',  <i>ABC</i>.
This paragraph demonstrates the clustering of citations by citing the first and third item. Doe, <i>supra</i> note Doe, Doe and Python, <i>supra</i> note .

:::

## How do I create a bibliography in European Journal of International Law?
...
Doe,  'Title #1',  3 <i>Imaginary Journal</i> (2008) 1.

Doe J. and Doe J., <i>Title #2</i>, available at https://example.com/ (last visited 1 May 2021).

Doe, Doeand Python,  'Title #3',  <i>ABC</i>.
