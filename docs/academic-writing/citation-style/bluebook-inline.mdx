...
<!---
## About  Bluebook Inline

* Title: Bluebook Inline
* Short Title (Id): AAA)
* Authors: Bluebook Inline
* Download: Bluebook Inline
 --->
...
![citedrive_style](images/bluebook-inline.svg "Choose Bluebook Inline in the CiteDrive App")
