...
When you 're tasked by using "Journal of Field Ornithology" (Plant Reprod) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Journal of Field Ornithology?
...
## How do I create a bibliography in Journal of Field Ornithology?
...
<span style={{"font-variant":"small-caps"}}>Doe, J. and J. Doe</span> [online]. no date. Title #2. {"<"}https://example.com/{">"} (1 May 2021).

<span style={{"font-variant":"small-caps"}}>Doe, J., J. Doe and M. Python</span>. no date. Title #3. ABC.
