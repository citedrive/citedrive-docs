...
When you 're tasked by using "Palaios" (Radiol Phys Technol) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I create a bibliography in Palaios?
...
<span style={{"font-variant":"small-caps"}}>Doe</span>, J., 2008, Title #1: Imaginary Journal, v. 3, p. 1–999..

<span style={{"font-variant":"small-caps"}}>Doe</span>, J., and <span style={{"font-variant":"small-caps"}}>Doe</span>, J. Title #2:  https://example.com/. Checked May 2021.

<span style={{"font-variant":"small-caps"}}>Doe</span>, J., <span style={{"font-variant":"small-caps"}}>Doe</span>, J., and <span style={{"font-variant":"small-caps"}}>Python</span>, M. Title #3: ABC..
