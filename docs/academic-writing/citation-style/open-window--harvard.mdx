...
<!---
## About  Open Window - Harvard

* Title: Open Window - Harvard
* Short Title (Id): AMRE)
* Authors: Open Window - Harvard
* Download: Open Window - Harvard
 --->
...
![citedrive_style](images/open-window--harvard.svg "Choose Open Window - Harvard in the CiteDrive App")
