...
When you 're tasked by using "American Society for Pharmacology and Experimental Therapeutics" (ASPET) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  American Society for Pharmacology and Experimental Therapeutics
* **Title:** American Society for Pharmacology and Experimental Therapeutics
* **Type:** author-date
* **Short Title (Id):** ASPET)
* fields: , medicine

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with American Society for Pharmacology and Experimental Therapeutics? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in American Society for Pharmacology and Experimental Therapeutics for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["American Society for Pharmacology and Experimental Therapeutics"](images/american-society-for-pharmacology-and-experimental-therapeutics.svg "Choose American Society for Pharmacology and Experimental Therapeutics in the CiteDrive App")
...
## How do I cite in  American Society for Pharmacology and Experimental Therapeutics?
...
## How do I create a bibliography in American Society for Pharmacology and Experimental Therapeutics?
