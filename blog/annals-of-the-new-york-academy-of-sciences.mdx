...
When you 're tasked by using "Annals of the New York Academy of Sciences" (Eur J Endocrinol) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Annals of the New York Academy of Sciences
* **Title:** Annals of the New York Academy of Sciences
* **Type:** numeric
* **Short Title (Id):** Eur J Endocrinol)
* fields: , science

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Annals of the New York Academy of Sciences? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Annals of the New York Academy of Sciences for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Annals of the New York Academy of Sciences"](images/annals-of-the-new-york-academy-of-sciences.svg "Choose Annals of the New York Academy of Sciences in the CiteDrive App")
...
## How do I cite in  Annals of the New York Academy of Sciences?
...
## How do I create a bibliography in Annals of the New York Academy of Sciences?
...
2.Doe J. &amp; J. Doe. Accessed May 1, 2021. https://example.com/.

3.Doe J., J. Doe &amp; M. Python.  Title #3.  <i>ABC</i>.
