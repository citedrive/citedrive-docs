---
title: Institut Teknologi Bandung - Sekolah Pascasarjana
author: Jospeh Moe
author_title: CiteDrive Bot
author_url: https://citedrive.com/
tags: [author-date, engineering, generic-base]
---

When you 're tasked by using "Institut Teknologi Bandung - Sekolah Pascasarjana" (ITB - SPs) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Institut Teknologi Bandung - Sekolah Pascasarjana
* **Title:** Institut Teknologi Bandung - Sekolah Pascasarjana
* **Type:** author-date
* **Short Title (Id):** ITB - SPs)
* fields: , engineering, generic-base

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Institut Teknologi Bandung - Sekolah Pascasarjana? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Institut Teknologi Bandung - Sekolah Pascasarjana for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Institut Teknologi Bandung - Sekolah Pascasarjana"](images/institut-teknologi-bandung--sekolah-pascasarjana.svg "Choose Institut Teknologi Bandung - Sekolah Pascasarjana in the CiteDrive App")
...
## How do I cite in  Institut Teknologi Bandung - Sekolah Pascasarjana?
...
## How do I create a bibliography in Institut Teknologi Bandung - Sekolah Pascasarjana?
...
Doe, J.and Doe, J.  (n.d.): Title #2,  retrieved  May 1, 2021,  from  internet:  https://example.com/.
