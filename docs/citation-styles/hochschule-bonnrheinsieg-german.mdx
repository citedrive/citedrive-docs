...
# Hochschule Bonn-Rhein-Sieg (German)

When you 're tasked by using "Hochschule Bonn-Rhein-Sieg (German)" (Ophthalmol Ther) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Hochschule Bonn-Rhein-Sieg (German)

* Title: Hochschule Bonn-Rhein-Sieg (German)
* Short Title (Id): Ophthalmol Ther)
* Authors: Hochschule Bonn-Rhein-Sieg (German)
* Download: Hochschule Bonn-Rhein-Sieg (German)
 --->

## How can CiteDrive help you with Hochschule Bonn-Rhein-Sieg (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Hochschule Bonn-Rhein-Sieg (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/hochschule-bonnrheinsieg-german.svg "Choose Hochschule Bonn-Rhein-Sieg (German) in the CiteDrive App")
...
## How do I cite in  Hochschule Bonn-Rhein-Sieg (German)?
...
## How do I create a bibliography in Hochschule Bonn-Rhein-Sieg (German)?
