...
# Juristische Schulung (German)

When you 're tasked by using "Juristische Schulung (German)" (JuS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Juristische Schulung (German)

* Title: Juristische Schulung (German)
* Short Title (Id): JuS)
* Authors: Juristische Schulung (German)
* Download: Juristische Schulung (German)
 --->

## How can CiteDrive help you with Juristische Schulung (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Juristische Schulung (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/juristische-schulung-german.svg "Choose Juristische Schulung (German) in the CiteDrive App")
...
## How do I cite in  Juristische Schulung (German)?
...
## How do I create a bibliography in Juristische Schulung (German)?
