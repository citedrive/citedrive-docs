...
When you 're tasked by using "Journal for the History of Astronomy" (Agroforest Syst) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Journal for the History of Astronomy?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Jane Doe, “Title #1”, <i>Imaginary Journal</i>, iii (2008): 1–999. This, in turn, refers to the second Jane Doe and John  Doe, “Title #2” <https://example.com/> [accessed 1 May 2021].
...
## How do I create a bibliography in Journal for the History of Astronomy?
