...
When you 're tasked by using "University of Auckland - History" (Int Arch Occup Environ Health) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  University of Auckland - History?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Jane Doe, ‘Title #1’, <i>Imaginary Journal</i>, 3, 2008. This, in turn, refers to the second Jane Doe and John  Doe, ‘Title #2’, https://example.com/, accessed 1 May 2021.
...
## How do I create a bibliography in University of Auckland - History?
...
!!! Doe, Jane, and John  Doe, ‘Title #2’, https://example.com/, accessed 1 May 2021.
