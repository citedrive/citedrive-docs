...
When you 're tasked by using "Gallia (French)" (Drugs R D) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Gallia (French)?
...
## How do I create a bibliography in Gallia (French)?
...
<span style={{"font-variant":"small-caps"}}>Doe J., Doe J.</span>	s. d. : 	<i>Title #2</i>, https://example.com/ (consulté le 1 mai 2021).
