...
When you 're tasked by using "American Physical Society (without titles)" (APS (without titles)) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  American Physical Society (without titles)

* Title: American Physical Society (without titles)
* Short Title (Id): APS (without titles))
* Authors: American Physical Society (without titles)
* Download: American Physical Society (without titles)
 --->

## How can CiteDrive help you with American Physical Society (without titles)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in American Physical Society (without titles) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/american-physical-society-without-titles.svg "Choose American Physical Society (without titles) in the CiteDrive App")
...
## How do I cite in  American Physical Society (without titles)?
...
## How do I create a bibliography in American Physical Society (without titles)?
