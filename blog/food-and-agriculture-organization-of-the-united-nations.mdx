...
tags: [author-date, science, social_science]
---

When you 're tasked by using "Food and Agriculture Organization of the United Nations" (FAO) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Food and Agriculture Organization of the United Nations
* **Title:** Food and Agriculture Organization of the United Nations
* **Type:** author-date
* **Short Title (Id):** FAO)
* fields: , science, social_science

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Food and Agriculture Organization of the United Nations? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Food and Agriculture Organization of the United Nations for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Food and Agriculture Organization of the United Nations"](images/food-and-agriculture-organization-of-the-united-nations.svg "Choose Food and Agriculture Organization of the United Nations in the CiteDrive App")
...
## How do I cite in  Food and Agriculture Organization of the United Nations?
...
This sentence refers to the first item from the table. (Doe, 2008) This, in turn, refers to the second (Doe and Doe, undated)
and then to the third.  (Doe, Doe and Python, undated)
This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe, 2008; Doe, Doe and Python, undated)

:::

## How do I create a bibliography in Food and Agriculture Organization of the United Nations?
...
<b>Doe, J.</b>. 2008. Title #1<i>Imaginary Journal</i>, 3: 1–999.

<b>Doe, J. &amp; Doe, J.</b>. undated. <i>Title #2</i> [online][Cited 1May2021]. https://example.com/

<b>Doe, J., Doe, J. &amp; Python, M.</b>. undated. Title #3<i>ABC</i>.
