---
title: ISO-690 (author-date, Czech)
author: Jospeh Moe
...
When you 're tasked by using "ISO-690 (author-date, Czech)" (Curr Bladder Dysfunct Rep) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  ISO-690 (author-date, Czech)?
...
This sentence refers to the first item from the table. (Doe 2008) This, in turn, refers to the second (Doe a Doe nedatováno)
and then to the third.  (Doe et al. nedatováno)
This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe 2008; Doe et al. nedatováno)

:::

## How do I create a bibliography in ISO-690 (author-date, Czech)?
...
DOE, Jane, 2008. Title #1. <i>Imaginary Journal</i>. <b>3</b>, 1–999. 

DOE, Jane a John  DOE, nedatováno. <i>Title #2</i> [online]  [vid.. 2021-05-01]. Dostupné z: https://example.com/

DOE, Jane, John DOE a Monty PYTHON, nedatováno. Title #3. <i>ABC</i>. 
