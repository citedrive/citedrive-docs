...
<!---
## About  Histoire & Mesure (French)

* Title: Histoire & Mesure (French)
* Short Title (Id): JRS)
* Authors: Histoire & Mesure (French)
* Download: Histoire & Mesure (French)
 --->
...
![citedrive_style](images/histoire-and-mesure-french.svg "Choose Histoire & Mesure (French) in the CiteDrive App")
