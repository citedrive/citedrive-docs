---
title: ISO-690 (author-date, Slovak)
author: Jospeh Moe
...
When you 're tasked by using "ISO-690 (author-date, Slovak)" (AIP) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  ISO-690 (author-date, Slovak)
* **Title:** ISO-690 (author-date, Slovak)
* **Type:** author-date
* **Short Title (Id):** AIP)
* fields: , generic-base
...
## How do I cite in  ISO-690 (author-date, Slovak)?
...
This sentence refers to the first item from the table. (Doe 2008) This, in turn, refers to the second (Doe a Doe no date)
...
## How do I create a bibliography in ISO-690 (author-date, Slovak)?
