---
title: China National Standard GB/T 7714-2005 (numeric, Chinese)
author: Jospeh Moe
author_title: CiteDrive Bot
author_url: https://citedrive.com/
tags: [numeric, engineering, generic-base, science]
---

When you 're tasked by using "China National Standard GB/T 7714-2005 (numeric, Chinese)" (Arch Orthop Trauma Surg) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  China National Standard GB/T 7714-2005 (numeric, Chinese)
* **Title:** China National Standard GB/T 7714-2005 (numeric, Chinese)
* **Type:** numeric
* **Short Title (Id):** Arch Orthop Trauma Surg)
* fields: , engineering, generic-base, science

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with China National Standard GB/T 7714-2005 (numeric, Chinese)? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in China National Standard GB/T 7714-2005 (numeric, Chinese) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["China National Standard GB/T 7714-2005 (numeric, Chinese)"](images/china-national-standard-gbt-77142005-numeric-chinese.svg "Choose China National Standard GB/T 7714-2005 (numeric, Chinese) in the CiteDrive App")
...
## How do I cite in  China National Standard GB/T 7714-2005 (numeric, Chinese)?
...
## How do I create a bibliography in China National Standard GB/T 7714-2005 (numeric, Chinese)?
...
[2]DOE J, DOE J. Title #2[EB/OL]. [2021-05-01]. https://example.com/.

[3]DOE J, DOE J, PYTHON M. Title #3[J]. ABC, .
