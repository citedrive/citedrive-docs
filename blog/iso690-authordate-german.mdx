---
title: ISO-690 (author-date, German)
author: Jospeh Moe
...
When you 're tasked by using "ISO-690 (author-date, German)" (OSCOLA) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  ISO-690 (author-date, German)
* **Title:** ISO-690 (author-date, German)
* **Type:** author-date
...
## How do I cite in  ISO-690 (author-date, German)?
...
This sentence refers to the first item from the table. (Doe 2008) This, in turn, refers to the second (Doe, Doe [kein Datum])
and then to the third.  (Doe, Doe, Python [kein Datum])
This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe 2008; Doe, Doe, Python [kein Datum])

:::

## How do I create a bibliography in ISO-690 (author-date, German)?
...
DOE, Jane, 2008. Title #1. <i>Imaginary Journal</i>. 2008. Bd. 3, S. 1–999

DOE, Jane und John  DOE, [kein Datum]. Title #2.  [online].  [Zugriff am: 1 Mai 2021]. Verfügbar unter: https://example.com/

DOE, Jane, John DOE und Monty PYTHON, [kein Datum]. Title #3. <i>ABC</i>
