...
# Kommunikation und Recht (German)

When you 're tasked by using "Kommunikation und Recht (German)" (K&R) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Kommunikation und Recht (German)

* Title: Kommunikation und Recht (German)
* Short Title (Id): K&R)
* Authors: Kommunikation und Recht (German)
* Download: Kommunikation und Recht (German)
 --->

## How can CiteDrive help you with Kommunikation und Recht (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Kommunikation und Recht (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/kommunikation-und-recht-german.svg "Choose Kommunikation und Recht (German) in the CiteDrive App")
...
## How do I cite in  Kommunikation und Recht (German)?
...
## How do I create a bibliography in Kommunikation und Recht (German)?
