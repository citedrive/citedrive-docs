...
When you 're tasked by using "Chicago Manual of Style 16th edition (author-date)" (Learning Environ Res) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Chicago Manual of Style 16th edition (author-date)
* **Title:** Chicago Manual of Style 16th edition (author-date)
* **Type:** author-date
* **Short Title (Id):** Learning Environ Res)
* fields: , generic-base

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Chicago Manual of Style 16th edition (author-date)? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Chicago Manual of Style 16th edition (author-date) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Chicago Manual of Style 16th edition (author-date)"](images/chicago-manual-of-style-16th-edition-authordate.svg "Choose Chicago Manual of Style 16th edition (author-date) in the CiteDrive App")
...
## How do I cite in  Chicago Manual of Style 16th edition (author-date)?
...
## How do I create a bibliography in Chicago Manual of Style 16th edition (author-date)?
