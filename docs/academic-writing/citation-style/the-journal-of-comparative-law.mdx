...
When you 're tasked by using "The Journal of Comparative Law" (LAP) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  The Journal of Comparative Law

* Title: The Journal of Comparative Law
* Short Title (Id): LAP)
* Authors: The Journal of Comparative Law
* Download: The Journal of Comparative Law
 --->

## How can CiteDrive help you with The Journal of Comparative Law?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in The Journal of Comparative Law for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/the-journal-of-comparative-law.svg "Choose The Journal of Comparative Law in the CiteDrive App")
...
## How do I cite in  The Journal of Comparative Law?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Doe, J (2008) ‘Title #1’ (3) <i>Imaginary Journal</i> 1. This, in turn, refers to the second Doe, J and Doe, J <i>Title #2</i> Available at: <https://example.com/>.
! and then to the third.  Doe, J; Doe, J and Python, M ‘Title #3’ <i>ABC</i>.
...
## How do I create a bibliography in The Journal of Comparative Law?
