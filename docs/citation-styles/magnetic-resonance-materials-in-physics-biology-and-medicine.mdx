...
When you 're tasked by using "Magnetic Resonance Materials in Physics, Biology and Medicine" (Magn Reson Mater Phy) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Magnetic Resonance Materials in Physics, Biology and Medicine

* Title: Magnetic Resonance Materials in Physics, Biology and Medicine
* Short Title (Id): Magn Reson Mater Phy)
* Authors: Magnetic Resonance Materials in Physics, Biology and Medicine
* Download: Magnetic Resonance Materials in Physics, Biology and Medicine
 --->

## How can CiteDrive help you with Magnetic Resonance Materials in Physics, Biology and Medicine?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Magnetic Resonance Materials in Physics, Biology and Medicine for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/magnetic-resonance-materials-in-physics-biology-and-medicine.svg "Choose Magnetic Resonance Materials in Physics, Biology and Medicine in the CiteDrive App")
...
## How do I cite in  Magnetic Resonance Materials in Physics, Biology and Medicine?
...
## How do I create a bibliography in Magnetic Resonance Materials in Physics, Biology and Medicine?
...
!!! 2. Doe J, Doe J Title #2. https://example.com/. Accessed 1 May 2021
