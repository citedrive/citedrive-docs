...
When you 're tasked by using "Zilsel (French)" (Zilsel) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Zilsel (French)?
...
This sentence refers to the first item from the table. Jane Doe, « <i>Title #1</i> », <i>Imaginary Journal</i>, vol. 3, 2008, p.. 1‑999 This, in turn, refers to the second Jane Doe et John  Doe, « <i>Title #2</i> », s. d., p.. 
and then to the third.  Jane Doe, John Doe et Monty Python, « <i>Title #3</i> », <i>ABC</i>, s. d., p.. 
This paragraph demonstrates the clustering of citations by citing the first and third item. Jane Doe, « <i>Title #1</i> », <i>Imaginary Journal</i>, vol. 3, 2008, p.. 1‑999Jane Doe, John Doe et Monty Python, « <i>Title #3</i> », <i>ABC</i>, s. d., p.. 

:::

## How do I create a bibliography in Zilsel (French)?
...
Jane Doe, « <i>Title #1</i> », <i>Imaginary Journal</i>, vol. 3, 2008, p.. 1‑999

Jane Doe et John  Doe, « <i>Title #2</i> », s. d., p.. 

Jane Doe, John Doe et Monty Python, « <i>Title #3</i> », <i>ABC</i>, s. d., p.. 
