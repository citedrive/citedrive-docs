---
title: Manchester University Press monographs (note)
author: Jospeh Moe
...
When you 're tasked by using "Manchester University Press monographs (note)" (Comput. Methods Funct. Theory) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Manchester University Press monographs (note)
* **Title:** Manchester University Press monographs (note)
* **Type:** note
...
## How do I cite in  Manchester University Press monographs (note)?
...
This sentence refers to the first item from the table. J. Doe, ‘Title #1’, <i>Imaginary Journal</i>, 3 (2008), 1–999. This, in turn, refers to the second J. Doe and J. Doe, ‘Title #2’, p. , https://example.com/ [accessed 1 May 2021].
and then to the third.  J. Doe, J. Doe, and M. Python, ‘Title #3’, <i>ABC</i>.
...
## How do I create a bibliography in Manchester University Press monographs (note)?
