...
# University of Zabol (Persian)

When you 're tasked by using "University of Zabol (Persian)" (UOZ (Fa)) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  University of Zabol (Persian)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. )Doe، 2008( This, in turn, refers to the second )Doe و Doe، بدون تاریخ(
! and then to the third.  )Doe و همکاران، بدون تاریخ(
! This paragraph demonstrates the clustering of citations by citing the first and third item. )Doe، 2008؛ Doe و همکاران، بدون تاریخ(



## How do I create a bibliography in University of Zabol (Persian)?
