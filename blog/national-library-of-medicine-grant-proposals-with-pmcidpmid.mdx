...
## Details  National Library of Medicine (grant proposals with PMCID/PMID)
* **Title:** National Library of Medicine (grant proposals with PMCID/PMID)
* **Type:** numeric
* **Short Title (Id):** NLM)
* fields: , medicine
...
!["National Library of Medicine (grant proposals with PMCID/PMID)"](images/national-library-of-medicine-grant-proposals-with-pmcidpmid.svg "Choose National Library of Medicine (grant proposals with PMCID/PMID) in the CiteDrive App")
