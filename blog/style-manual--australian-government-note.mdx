---
title: Style Manual - Australian Government (note)
author: Jospeh Moe
...
When you 're tasked by using "Style Manual - Australian Government (note)" (Public Organiz Rev) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Style Manual - Australian Government (note)
* **Title:** Style Manual - Australian Government (note)
* **Type:** note
* **Short Title (Id):** Public Organiz Rev)
* fields: , generic-base

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Style Manual - Australian Government (note)? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Style Manual - Australian Government (note) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Style Manual - Australian Government (note)"](images/style-manual--australian-government-note.svg "Choose Style Manual - Australian Government (note) in the CiteDrive App")
...
## How do I cite in  Style Manual - Australian Government (note)?
...
This sentence refers to the first item from the table. Jane Doe, ‘Title #1’, <i>Imaginary Journal</i>, vol. 3, 2008, pp. 1–999. This, in turn, refers to the second Jane Doe &amp; John  Doe, <i>Title #2</i>, n.d., p. , retrieved 1 May 2021, {"<"}https://example.com/{">"}.
...
## How do I create a bibliography in Style Manual - Australian Government (note)?
...
Doe, J &amp; Doe, J n.d., <i>Title #2</i>, p. , retrieved 1 May 2021, {"<"}https://example.com/{">"}.

Doe, J, Doe, J &amp; Python, M n.d., ‘Title #3’, <i>ABC</i>, p. .
