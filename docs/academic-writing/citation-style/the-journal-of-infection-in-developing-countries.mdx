...
When you 're tasked by using "The Journal of Infection in Developing Countries" (JIDC) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  The Journal of Infection in Developing Countries

* Title: The Journal of Infection in Developing Countries
* Short Title (Id): JIDC)
* Authors: The Journal of Infection in Developing Countries
* Download: The Journal of Infection in Developing Countries
 --->

## How can CiteDrive help you with The Journal of Infection in Developing Countries?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in The Journal of Infection in Developing Countries for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/the-journal-of-infection-in-developing-countries.svg "Choose The Journal of Infection in Developing Countries in the CiteDrive App")
...
## How do I cite in  The Journal of Infection in Developing Countries?
...
## How do I create a bibliography in The Journal of Infection in Developing Countries?
...
!!! 2. Doe J, Doe J (n.d.) Title #2. Available: https://example.com/. Accessed 1 May 2021..
!!! 3. Doe J, Doe J, Python M (n.d.) Title #3. ABC.
