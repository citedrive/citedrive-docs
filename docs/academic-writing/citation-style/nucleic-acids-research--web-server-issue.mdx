...
When you 're tasked by using "Nucleic Acids Research - Web Server Issue" (Curr Atheroscler Rep) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Nucleic Acids Research - Web Server Issue

* Title: Nucleic Acids Research - Web Server Issue
* Short Title (Id): Curr Atheroscler Rep)
* Authors: Nucleic Acids Research - Web Server Issue
* Download: Nucleic Acids Research - Web Server Issue
 --->

## How can CiteDrive help you with Nucleic Acids Research - Web Server Issue?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Nucleic Acids Research - Web Server Issue for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/nucleic-acids-research--web-server-issue.svg "Choose Nucleic Acids Research - Web Server Issue in the CiteDrive App")
...
## How do I cite in  Nucleic Acids Research - Web Server Issue?
...
## How do I create a bibliography in Nucleic Acids Research - Web Server Issue?
