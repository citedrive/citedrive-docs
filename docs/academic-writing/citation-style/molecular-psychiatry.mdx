...
* Short Title (Id): MP)
* Authors: Molecular Psychiatry
* Download: Molecular Psychiatry
 --->
...
![citedrive_style](images/molecular-psychiatry.svg "Choose Molecular Psychiatry in the CiteDrive App")
