...
When you 're tasked by using "Medical History" (Jpn J Ophthalmol) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Medical History?
...
This sentence refers to the first item from the table. Jane Doe, ‘Title #1’, <i>Imaginary Journal</i>, 3 (2008), 1–999. This, in turn, refers to the second Jane Doe and John  Doe, ‘Title #2’ (n.d.), online: {"<"}https://example.com/{">"}, accessed 1 May 2021.
and then to the third.  Jane Doe et al., ‘Title #3’, <i>ABC</i> (n.d.).
This paragraph demonstrates the clustering of citations by citing the first and third item. Doe, ‘Title #1’<i>op. cit.</i>; Doe et al., ‘Title #3’<i>op. cit.</i>.

:::

## How do I create a bibliography in Medical History?
