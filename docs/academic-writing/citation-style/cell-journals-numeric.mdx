...
<!---
## About  Cell journals (numeric)

* Title: Cell journals (numeric)
* Short Title (Id): Polar Biol)
* Authors: Cell journals (numeric)
* Download: Cell journals (numeric)
 --->
...
![citedrive_style](images/cell-journals-numeric.svg "Choose Cell journals (numeric) in the CiteDrive App")
