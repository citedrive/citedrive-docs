...
When you 're tasked by using "Journal of International Economic Law" (TUD BWL/Logistik (author-date)) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Journal of International Economic Law
* **Title:** Journal of International Economic Law
* **Type:** note
...
## How do I cite in  Journal of International Economic Law?
...
This sentence refers to the first item from the table. Jane Doe‘Title #1’, Imaginary Journal 3 (2008), at 1. This, in turn, refers to the second Jane Doe and John  Doe‘Title #2’, https://example.com/ (visited 1 May 2021).
and then to the third.  Jane Doe, John Doe and Monty Python‘Title #3’, ABC at.
This paragraph demonstrates the clustering of citations by citing the first and third item. See Doe; See Doe, Doeand Python.

:::

## How do I create a bibliography in Journal of International Economic Law?
...
Doe, Jane, ‘Title #1’, Imaginary Journal 3 (2008), at 1.

Doe, Jane and Doe, John , ‘Title #2’, https://example.com/ (visited 1 May 2021).

Doe, Jane, Doe, Johnand Python, Monty, ‘Title #3’, ABC at.
