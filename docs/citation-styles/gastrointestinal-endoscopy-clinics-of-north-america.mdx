...
When you 're tasked by using "Gastrointestinal Endoscopy Clinics of North America" (GEC) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Gastrointestinal Endoscopy Clinics of North America

* Title: Gastrointestinal Endoscopy Clinics of North America
* Short Title (Id): GEC)
* Authors: Gastrointestinal Endoscopy Clinics of North America
* Download: Gastrointestinal Endoscopy Clinics of North America
 --->

## How can CiteDrive help you with Gastrointestinal Endoscopy Clinics of North America?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Gastrointestinal Endoscopy Clinics of North America for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/gastrointestinal-endoscopy-clinics-of-north-america.svg "Choose Gastrointestinal Endoscopy Clinics of North America in the CiteDrive App")
...
## How do I cite in  Gastrointestinal Endoscopy Clinics of North America?
...
## How do I create a bibliography in Gastrointestinal Endoscopy Clinics of North America?
