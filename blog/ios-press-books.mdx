...
When you 're tasked by using "IOS Press (books)" (JAAOS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  IOS Press (books)?
...
## How do I create a bibliography in IOS Press (books)?
...
[2]J. Doe, and J. Doe, Title #2, (n.d.). https://example.com/ (accessed May 1, 2021).
