---
title: ISO-690 (author-date, Spanish)
author: Jospeh Moe
...
When you 're tasked by using "ISO-690 (author-date, Spanish)" (TOMS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  ISO-690 (author-date, Spanish)
* **Title:** ISO-690 (author-date, Spanish)
* **Type:** author-date
* **Short Title (Id):** TOMS)
* fields: , generic-base
...
## How do I cite in  ISO-690 (author-date, Spanish)?
...
This sentence refers to the first item from the table. (Doe 2008) This, in turn, refers to the second (Doe y Doe [sin fecha])
and then to the third.  (Doe, Doe y Python [sin fecha])
This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe 2008; Doe, Doe y Python [sin fecha])

:::

## How do I create a bibliography in ISO-690 (author-date, Spanish)?
...
DOE, J. y DOE, J., [sin fecha]. Title #2.  [en línea].  [Consulta: 1 mayo 2021]. Disponible en: https://example.com/. 

DOE, J., DOE, J. y PYTHON, M., [sin fecha]. Title #3. <i>ABC</i>, 
