...
When you 're tasked by using "Myrmecological News" (3 Biotech) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Myrmecological News?
...
This sentence refers to the first item from the table. (<span style={{"font-variant":"small-caps"}}>Doe</span> 2008) This, in turn, refers to the second (<span style={{"font-variant":"small-caps"}}>Doe</span> &amp; <span style={{"font-variant":"small-caps"}}>Doe</span> no date)
and then to the third.  (<span style={{"font-variant":"small-caps"}}>Doe</span> &amp; al. no date)
This paragraph demonstrates the clustering of citations by citing the first and third item. (<span style={{"font-variant":"small-caps"}}>Doe</span> 2008, <span style={{"font-variant":"small-caps"}}>Doe</span> &amp; al. no date)

:::

## How do I create a bibliography in Myrmecological News?
...
<span style={{"font-variant":"small-caps"}}>Doe, J. &amp; Doe, J.</span> Title #2. –

<span style={{"font-variant":"small-caps"}}>Doe, J., Doe, J. &amp; Python, M.</span> Title #3. – ABC. 
