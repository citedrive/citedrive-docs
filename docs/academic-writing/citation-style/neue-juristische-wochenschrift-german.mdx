...
# Neue Juristische Wochenschrift (German)

When you 're tasked by using "Neue Juristische Wochenschrift (German)" (NJW (Articles)) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Neue Juristische Wochenschrift (German)

* Title: Neue Juristische Wochenschrift (German)
* Short Title (Id): NJW (Articles))
* Authors: Neue Juristische Wochenschrift (German)
* Download: Neue Juristische Wochenschrift (German)
 --->

## How can CiteDrive help you with Neue Juristische Wochenschrift (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Neue Juristische Wochenschrift (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/neue-juristische-wochenschrift-german.svg "Choose Neue Juristische Wochenschrift (German) in the CiteDrive App")
...
## How do I cite in  Neue Juristische Wochenschrift (German)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. <i>Doe</i>, 2008, 1 This, in turn, refers to the second <i>Doe/Doe</i>, , https://example.com/
...
## How do I create a bibliography in Neue Juristische Wochenschrift (German)?
