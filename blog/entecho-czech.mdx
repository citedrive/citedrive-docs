...
When you 're tasked by using "ENTECHO (Czech)" (UAFM) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  ENTECHO (Czech)?
...
This sentence refers to the first item from the table. (Doe, 2008) This, in turn, refers to the second (Doe a Doe, b.r.)
and then to the third.  (Doe et al., b.r.)
This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe, 2008; Doe et al., b.r.)

:::

## How do I create a bibliography in ENTECHO (Czech)?
...
Doe, J.; Doe, J., b.r.. <i>Title #2</i>.. https://example.com/ (viděno 1. 5. 2021).

Doe, J.; Doe, J.; Python, M., b.r.. <i>Title #3</i>. ABC.
