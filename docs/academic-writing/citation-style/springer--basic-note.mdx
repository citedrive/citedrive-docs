...
<!---
## About  Springer - Basic (note)

* Title: Springer - Basic (note)
* Short Title (Id): Adv Data Anal Classif)
* Authors: Springer - Basic (note)
* Download: Springer - Basic (note)
 --->
...
![citedrive_style](images/springer--basic-note.svg "Choose Springer - Basic (note) in the CiteDrive App")
