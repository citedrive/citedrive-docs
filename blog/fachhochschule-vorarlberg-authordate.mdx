---
title: Fachhochschule Vorarlberg (author-date)
author: Jospeh Moe
...
When you 're tasked by using "Fachhochschule Vorarlberg (author-date)" (FHV Autor-Jahr) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Fachhochschule Vorarlberg (author-date)?
...
This sentence refers to the first item from the table. (Doe 2008) This, in turn, refers to the second (Doe; Doe n. y.)
and then to the third.  (Doe; Doe; Python n. y.)
This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe 2008; Doe; Doe; Python n. y.)

:::

## How do I create a bibliography in Fachhochschule Vorarlberg (author-date)?
...
Doe, Jane (2008): “Title #1”. In: Imaginary Journal,  3 (2008), p. 1–999. 

Doe, Jane; Doe, John  (n. y.):  Title #2. . Available at: URL: https://example.com/ (Accessed on:  1 May 2021).

Doe, Jane; Doe, John; Python, Monty (n. y.): “Title #3”. In: ABC, . . 
