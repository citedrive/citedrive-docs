...
When you 're tasked by using "SPIP - Cite plugin" (Econ Gov) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  SPIP - Cite plugin?
...
This sentence refers to the first item from the table. (Doe, Jane  2008)  This, in turn, refers to the second (Doe, Jane et al. 
and then to the third.  (Doe, Jane et al. 
This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe, Jane  2008) (Doe, Jane et al. 

:::

## How do I create a bibliography in SPIP - Cite plugin?
...
<cite|journal|title=Title #1           |authors=Doe, Jane            |journal=Imaginary Journal          |year=2008          |volume=3        |page=1–999          >

<cite|web|title=Title #2           |authors=Doe, Jane; Doe, John             |accessdate=2021/05/1       |url=https://example.com/             >

<cite|journal|title=Title #3           |authors=Doe, Jane; Doe, John; Python, Monty            |journal=ABC          >
