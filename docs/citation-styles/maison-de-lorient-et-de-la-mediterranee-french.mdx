...
When you 're tasked by using "Maison de l'Orient et de la Méditerranée (French)" (MOM Éditions (FR)) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Maison de l'Orient et de la Méditerranée (French)

* Title: Maison de l'Orient et de la Méditerranée (French)
* Short Title (Id): MOM Éditions (FR))
* Authors: Maison de l'Orient et de la Méditerranée (French)
* Download: Maison de l'Orient et de la Méditerranée (French)
 --->

## How can CiteDrive help you with Maison de l'Orient et de la Méditerranée (French)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Maison de l'Orient et de la Méditerranée (French) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/maison-de-lorient-et-de-la-mediterranee-french.svg "Choose Maison de l'Orient et de la Méditerranée (French) in the CiteDrive App")
...
## How do I cite in  Maison de l'Orient et de la Méditerranée (French)?
...
## How do I create a bibliography in Maison de l'Orient et de la Méditerranée (French)?
...
!!! **Bibliography**
!!! Doe 2008 : J. Doe, « Title #1 », <i>Imaginary Journal</i> 3, 2008, p. 1‑999.
