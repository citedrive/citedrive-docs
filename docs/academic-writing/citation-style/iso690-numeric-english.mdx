...
<!---
## About  ISO-690 (numeric, English)

* Title: ISO-690 (numeric, English)
* Short Title (Id): TUD BWL/Logistik (author-date))
* Authors: ISO-690 (numeric, English)
* Download: ISO-690 (numeric, English)
 --->
...
![citedrive_style](images/iso690-numeric-english.svg "Choose ISO-690 (numeric, English) in the CiteDrive App")
