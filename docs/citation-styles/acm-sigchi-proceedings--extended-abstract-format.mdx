...
<!---
## About  ACM SIGCHI Proceedings - Extended Abstract Format

* Title: ACM SIGCHI Proceedings - Extended Abstract Format
* Short Title (Id): CHI Extended Abstract Format)
* Authors: ACM SIGCHI Proceedings - Extended Abstract Format
* Download: ACM SIGCHI Proceedings - Extended Abstract Format
 --->
...
![citedrive_style](images/acm-sigchi-proceedings--extended-abstract-format.svg "Choose ACM SIGCHI Proceedings - Extended Abstract Format in the CiteDrive App")
