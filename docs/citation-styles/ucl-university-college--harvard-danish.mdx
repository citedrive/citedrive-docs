...
# UCL University College - Harvard (Danish)

When you 're tasked by using "UCL University College - Harvard (Danish)" (Extremes) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  UCL University College - Harvard (Danish)

* Title: UCL University College - Harvard (Danish)
* Short Title (Id): Extremes)
* Authors: UCL University College - Harvard (Danish)
* Download: UCL University College - Harvard (Danish)
 --->

## How can CiteDrive help you with UCL University College - Harvard (Danish)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in UCL University College - Harvard (Danish) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/ucl-university-college--harvard-danish.svg "Choose UCL University College - Harvard (Danish) in the CiteDrive App")
...
## How do I cite in  UCL University College - Harvard (Danish)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. (Doe 2008) This, in turn, refers to the second (Doe &amp; Doe u. å.)
! and then to the third.  (Doe, Doe &amp; Python u. å.)
! This paragraph demonstrates the clustering of citations by citing the first and third item. (ibid., Doe 2008)



## How do I create a bibliography in UCL University College - Harvard (Danish)?
...
!!! **Bibliography**
!!! Doe, J., 2008. Title #1, <i>Imaginary Journal</i>, årg. 3, s. 1–999..
!!! Doe, J. &amp; Doe, J., u. å.. <i>Title #2</i>  [Online].Tilgængelig fra: <u>https://example.com/</u> [Lokaliseret 01-05-2021].
!!! Doe, J., Doe, J. &amp; Python, M., u. å.. Title #3, <i>ABC</i>..
