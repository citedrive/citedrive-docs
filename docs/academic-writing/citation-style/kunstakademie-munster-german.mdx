...
# Kunstakademie Münster (German)

When you 're tasked by using "Kunstakademie Münster (German)" (uwf) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Kunstakademie Münster (German)

* Title: Kunstakademie Münster (German)
* Short Title (Id): uwf)
* Authors: Kunstakademie Münster (German)
* Download: Kunstakademie Münster (German)
 --->

## How can CiteDrive help you with Kunstakademie Münster (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Kunstakademie Münster (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/kunstakademie-munster-german.svg "Choose Kunstakademie Münster (German) in the CiteDrive App")
...
## How do I cite in  Kunstakademie Münster (German)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Doe 2008 . This, in turn, refers to the second Doe .
...
## How do I create a bibliography in Kunstakademie Münster (German)?
...
!!! **Bibliography**
!!! <span style="font-variant:small-caps;">Doe, Jane</span>, Title #1, in: <i>Imaginary Journal</i> 3 (2008), S. 1–999.
!!! <span style="font-variant:small-caps;">Doe, Jane / Doe, John </span>, Title #2 (01.05.2021), online verfügbar unter: https://example.com/ (Zugriff am 01.05.2021).
!!! <span style="font-variant:small-caps;">Doe, Jane / Doe, John / Python, Monty</span>, Title #3, in: <i>ABC</i>.
