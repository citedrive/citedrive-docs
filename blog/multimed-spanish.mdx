...
When you 're tasked by using "Multimed (Spanish)" (EJT) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Multimed (Spanish)?
...
## How do I create a bibliography in Multimed (Spanish)?
...
2. Doe J, Doe J. Title #2 [Internet].  [Citado 01/05/2021].. Disponible en: https://example.com/
