...
## Details  CLARA Architecture/Recherche (French)
* **Title:** CLARA Architecture/Recherche (French)
* **Type:** author-date
* **Short Title (Id):** UFJF)
* fields: 
...
!["CLARA Architecture/Recherche (French)"](images/clara-architecturerecherche-french.svg "Choose CLARA Architecture/Recherche (French) in the CiteDrive App")
