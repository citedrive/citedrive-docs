...
<!---
## About  Smithsonian Institution Scholarly Press (author-date)

* Title: Smithsonian Institution Scholarly Press (author-date)
* Short Title (Id): SISP)
* Authors: Smithsonian Institution Scholarly Press (author-date)
* Download: Smithsonian Institution Scholarly Press (author-date)
 --->
...
![citedrive_style](images/smithsonian-institution-scholarly-press-authordate.svg "Choose Smithsonian Institution Scholarly Press (author-date) in the CiteDrive App")
