...
When you 're tasked by using "France (tous les auteurs, auteur-date, French)" (UNA SN) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  France (tous les auteurs, auteur-date, French)

* Title: France (tous les auteurs, auteur-date, French)
* Short Title (Id): UNA SN)
* Authors: France (tous les auteurs, auteur-date, French)
* Download: France (tous les auteurs, auteur-date, French)
 --->

## How can CiteDrive help you with France (tous les auteurs, auteur-date, French)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in France (tous les auteurs, auteur-date, French) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/france-tous-les-auteurs-auteurdate-french.svg "Choose France (tous les auteurs, auteur-date, French) in the CiteDrive App")
...
## How do I cite in  France (tous les auteurs, auteur-date, French)?
...
## How do I create a bibliography in France (tous les auteurs, auteur-date, French)?
...
!!! **Bibliography**
!!! DOE J.. « Title #1 ».. <i>Imaginary Journal</i>. 2008.. Vol. 3, p. 1‑999.. 
!!! DOE J., DOE J.. « Title #2 »..  [s.l.] : [s.n.], [s.d.]. Disponible sur : < https://example.com/ > (consulté le 1 mai 2021)
