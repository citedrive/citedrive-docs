---
title: Quaderni Materialisti (Italian)
author: Jospeh Moe
...
When you 're tasked by using "Quaderni Materialisti (Italian)" (Purinergic Signalling) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Quaderni Materialisti (Italian)?
...
This sentence refers to the first item from the table. J. Doe, Title #1, <i>Imaginary Journal</i>, vol. 3, 2008, pp. 1–999. This, in turn, refers to the second J. Doe, J. Doe, Title #2, s.d., https://example.com/, p. .
and then to the third.  J. Doe, J. Doe, M. Python, Title #3, <i>ABC</i>, s.d., p. .
...
## How do I create a bibliography in Quaderni Materialisti (Italian)?
...
Doe, J., J. Doe, «Title #2», s.d.. https://example.com/.

Doe, J., J. Doe, M. Python, «Title #3», <i>ABC</i>, s.d., p. .
