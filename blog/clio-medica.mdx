...
When you 're tasked by using "Clio Medica" (JMIS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
This sentence refers to the first item from the table. J. Doe, ‘Title #1’, <i>Imaginary Journal</i>, 3 (2008), 1–999. This, in turn, refers to the second J. Doe and J. Doe, ‘Title #2’, n.d., https://example.com/, accessed 1 May 2021.
and then to the third.  J. Doe, J. Doe, and M. Python, ‘Title #3’, <i>ABC</i> (n.d.).
This paragraph demonstrates the clustering of citations by citing the first and third item. Doe, ‘Title #1’<i>op. cit.</i>; Doe, Doe, and Python, ‘Title #3’<i>op. cit.</i>.

:::

## How do I create a bibliography in Clio Medica?
...
Doe, J., and Doe, J., ‘Title #2’, n.d., https://example.com/, accessed 1 May 2021.

Doe, J., Doe, J., and Python, M., ‘Title #3’, <i>ABC</i> (n.d.).
