---
title: Estudios de Fonética Experimental
author: Jospeh Moe
...
When you 're tasked by using "Estudios de Fonética Experimental" (EFE) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Estudios de Fonética Experimental
* **Title:** Estudios de Fonética Experimental
* **Type:** author-date
* **Short Title (Id):** EFE)
* fields: , linguistics
...
## How do I cite in  Estudios de Fonética Experimental?
...
## How do I create a bibliography in Estudios de Fonética Experimental?
...
<span style={{"font-variant":"small-caps"}}>Doe, J.</span> (2008): «Title #1», <i>Imaginary Journal</i>, 3, pp. 1–999.

<span style={{"font-variant":"small-caps"}}>Doe, J. and Doe, J.</span> (no date): <i>Title #2</i>. Available at: https://example.com/ (Accessed: May 1, 2021).

<span style={{"font-variant":"small-caps"}}>Doe, J., Doe, J. and Python, M.</span> (no date): «Title #3», <i>ABC</i>.
