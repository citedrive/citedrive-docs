...
When you 're tasked by using "Philosophiques (French)" (Nonlinear Differ. Equ. Appl.) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Philosophiques (French)?
...
This sentence refers to the first item from the table. Doe, Jane, « Title #1 », <i>Imaginary Journal</i>, vol. 3, , 2008, pp. 1‑999. This, in turn, refers to the second Doe, Jane et Doe, John , « Title #2 », [s. d.], {"<"}https://example.com/{">"}, consulté le le , 1 mai 2021.
...
## How do I create a bibliography in Philosophiques (French)?
...
Doe, Jane et Doe, John , « Title #2 », [s. d.], {"<"}https://example.com/{">"}, consulté le le , 1 mai 2021.
