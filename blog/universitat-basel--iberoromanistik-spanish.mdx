---
title: Universität Basel - Iberoromanistik (Spanish)
author: Jospeh Moe
author_title: CiteDrive Bot
author_url: https://citedrive.com/
tags: [author-date, linguistics, humanities]
---

When you 're tasked by using "Universität Basel - Iberoromanistik (Spanish)" (TGM ÖNORM) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Universität Basel - Iberoromanistik (Spanish)
* **Title:** Universität Basel - Iberoromanistik (Spanish)
* **Type:** author-date
* **Short Title (Id):** TGM ÖNORM)
* fields: , linguistics, humanities

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Universität Basel - Iberoromanistik (Spanish)? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Universität Basel - Iberoromanistik (Spanish) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Universität Basel - Iberoromanistik (Spanish)"](images/universitat-basel--iberoromanistik-spanish.svg "Choose Universität Basel - Iberoromanistik (Spanish) in the CiteDrive App")
...
## How do I cite in  Universität Basel - Iberoromanistik (Spanish)?
...
and then to the third.  (Doe et al. s. f.)
This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe 2008; Doe et al. s. f.)

:::

## How do I create a bibliography in Universität Basel - Iberoromanistik (Spanish)?
...
Doe, Jane / Doe, John  (s. f.): «Title #2», https://example.com/ [fecha de consulta: 1 de mayo de 2021]..

Doe, Jane / Doe, John / Python, Monty (s. f.): «Title #3», <i>ABC</i>..
