...
When you 're tasked by using "The Open University - M801 - Research Project and Dissertation" (JNCI) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  The Open University - M801 - Research Project and Dissertation

* Title: The Open University - M801 - Research Project and Dissertation
* Short Title (Id): JNCI)
* Authors: The Open University - M801 - Research Project and Dissertation
* Download: The Open University - M801 - Research Project and Dissertation
 --->

## How can CiteDrive help you with The Open University - M801 - Research Project and Dissertation?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in The Open University - M801 - Research Project and Dissertation for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/the-open-university--m801--research-project-and-dissertation.svg "Choose The Open University - M801 - Research Project and Dissertation in the CiteDrive App")
...
## How do I cite in  The Open University - M801 - Research Project and Dissertation?
...
## How do I create a bibliography in The Open University - M801 - Research Project and Dissertation?
...
!!! Doe, J. and Doe, J., 2021. <i>Title #2</i>..
