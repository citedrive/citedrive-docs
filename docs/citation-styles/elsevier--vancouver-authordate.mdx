...
<!---
## About  Elsevier - Vancouver (author-date)

* Title: Elsevier - Vancouver (author-date)
* Short Title (Id): European View)
* Authors: Elsevier - Vancouver (author-date)
* Download: Elsevier - Vancouver (author-date)
 --->
...
![citedrive_style](images/elsevier--vancouver-authordate.svg "Choose Elsevier - Vancouver (author-date) in the CiteDrive App")
