...
When you 're tasked by using "Springer - SocPsych (numeric, brackets)" (BNE) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Springer - SocPsych (numeric, brackets)
* **Title:** Springer - SocPsych (numeric, brackets)
* **Type:** numeric
* **Short Title (Id):** BNE)
...
## How do I cite in  Springer - SocPsych (numeric, brackets)?
...
## How do I create a bibliography in Springer - SocPsych (numeric, brackets)?
...
2. Doe, J., &amp; Doe, J..  (n.d.).  Title #2. Retrieved  May 1, 2021,  from https://example.com/
