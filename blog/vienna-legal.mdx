...
When you 're tasked by using "Vienna Legal" (J Exp Criminol) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
This sentence refers to the first item from the table. Doe,  Title #1,  <i>Imaginary Journal</i> vol. 3 2008. This, in turn, refers to the second Doe/Doe,  Title #2,  accessed 1 may 2021, at https://example.com/.
and then to the third.  Doe/Doe/Python,  Title #3,  <i>ABC</i>.
This paragraph demonstrates the clustering of citations by citing the first and third item. Doe,  <i>Imaginary Journal</i> vol. 3 2008Doe/Doe/Python,  <i>ABC</i>.

:::

## How do I create a bibliography in Vienna Legal?
...
Doe, Title #1,  <i>Imaginary Journal</i> vol. 3 2008.

Doe/Doe, Title #2,  accessed 1 may 2021, at https://example.com/, accessed 1 may 2021, at https://example.com/.

Doe/Doe/Python, Title #3,  <i>ABC</i>.
