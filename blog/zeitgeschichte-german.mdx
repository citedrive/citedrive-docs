...
When you 're tasked by using "Zeitgeschichte (German)" (Zeitgeschichte) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Zeitgeschichte (German)?
...
This sentence refers to the first item from the table. Jane Doe, Title #1, in: Imaginary Journal, 3  (2008), 1–999. This, in turn, refers to the second Jane Doe/John  Doe, Title #2, URL: https://example.com/ (abgerufen  1. 5. 2021).
...
## How do I create a bibliography in Zeitgeschichte (German)?
