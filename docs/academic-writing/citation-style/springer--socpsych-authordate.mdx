...
<!---
## About  Springer - SocPsych (author-date)

* Title: Springer - SocPsych (author-date)
* Short Title (Id): J Mol Neurosci)
* Authors: Springer - SocPsych (author-date)
* Download: Springer - SocPsych (author-date)
 --->
...
![citedrive_style](images/springer--socpsych-authordate.svg "Choose Springer - SocPsych (author-date) in the CiteDrive App")
