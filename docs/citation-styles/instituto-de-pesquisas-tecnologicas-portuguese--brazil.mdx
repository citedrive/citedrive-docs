...
# Instituto de Pesquisas Tecnológicas (Portuguese - Brazil)

When you 're tasked by using "Instituto de Pesquisas Tecnológicas (Portuguese - Brazil)" (IPT) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Instituto de Pesquisas Tecnológicas (Portuguese - Brazil)

* Title: Instituto de Pesquisas Tecnológicas (Portuguese - Brazil)
* Short Title (Id): IPT)
* Authors: Instituto de Pesquisas Tecnológicas (Portuguese - Brazil)
* Download: Instituto de Pesquisas Tecnológicas (Portuguese - Brazil)
 --->

## How can CiteDrive help you with Instituto de Pesquisas Tecnológicas (Portuguese - Brazil)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Instituto de Pesquisas Tecnológicas (Portuguese - Brazil) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/instituto-de-pesquisas-tecnologicas-portuguese--brazil.svg "Choose Instituto de Pesquisas Tecnológicas (Portuguese - Brazil) in the CiteDrive App")
...
## How do I cite in  Instituto de Pesquisas Tecnológicas (Portuguese - Brazil)?
...
## How do I create a bibliography in Instituto de Pesquisas Tecnológicas (Portuguese - Brazil)?
...
!!! DOE, J.; DOE, J.. <b>Title #2</b>. Disponível em: <https://example.com/>. Acesso em: 1 mai. 2021.
!!! DOE, J.; DOE, J.; PYTHON, M.. Title #3. <b>ABC</b>,
