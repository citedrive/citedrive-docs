...
When you 're tasked by using "Mimbar Hukum" (TCG) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
This sentence refers to the first item from the table. Jane Doe“Title #1”, <i>Imaginary Journal</i>, Vol. 32008. This, in turn, refers to the second Jane Doe and John  Doe https://example.com/, accessed on May 1, 2021.
and then to the third.  Jane Doe, John Doeand Monty Python“Title #3”, <i>ABC</i>,.
This paragraph demonstrates the clustering of citations by citing the first and third item. Jane Doe; Jane Doe, John Doeand Monty Python.

:::

## How do I create a bibliography in Mimbar Hukum?
...
Doe, Jane“Title #1”, <i>Imaginary Journal</i>, Vol. 32008.

Doe, Jane and John  Doe https://example.com/, accessed on May 1, 2021.
