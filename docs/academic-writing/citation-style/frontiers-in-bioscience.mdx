...
* Short Title (Id): FBS)
* Authors: Frontiers in Bioscience
* Download: Frontiers in Bioscience
 --->
...
![citedrive_style](images/frontiers-in-bioscience.svg "Choose Frontiers in Bioscience in the CiteDrive App")
