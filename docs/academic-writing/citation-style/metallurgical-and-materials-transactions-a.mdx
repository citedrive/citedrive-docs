...
When you 're tasked by using "Metallurgical and Materials Transactions A" (Metall and Mat Trans A) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Metallurgical and Materials Transactions A

* Title: Metallurgical and Materials Transactions A
* Short Title (Id): Metall and Mat Trans A)
* Authors: Metallurgical and Materials Transactions A
* Download: Metallurgical and Materials Transactions A
 --->

## How can CiteDrive help you with Metallurgical and Materials Transactions A?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Metallurgical and Materials Transactions A for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/metallurgical-and-materials-transactions-a.svg "Choose Metallurgical and Materials Transactions A in the CiteDrive App")
...
## How do I cite in  Metallurgical and Materials Transactions A?
...
## How do I create a bibliography in Metallurgical and Materials Transactions A?
...
!!! **Bibliography**
!!! 1J. Doe: <i>Imaginary Journal</i>, 2008vol. 3pp. 1–999.
!!! 2J. Doe and J. Doe: Title #2, https://example.com/, (accessed 1 May 2021).
!!! 3J. Doe, J. Doe, and M. Python: <i>ABC</i>.
