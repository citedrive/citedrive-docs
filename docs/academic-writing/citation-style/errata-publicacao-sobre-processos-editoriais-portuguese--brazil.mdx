...
# Errata: Publicação sobre processos editoriais (Portuguese - Brazil)

When you 're tasked by using "Errata: Publicação sobre processos editoriais (Portuguese - Brazil)" (TOP) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Errata: Publicação sobre processos editoriais (Portuguese - Brazil)

* Title: Errata: Publicação sobre processos editoriais (Portuguese - Brazil)
* Short Title (Id): TOP)
* Authors: Errata: Publicação sobre processos editoriais (Portuguese - Brazil)
* Download: Errata: Publicação sobre processos editoriais (Portuguese - Brazil)
 --->

## How can CiteDrive help you with Errata: Publicação sobre processos editoriais (Portuguese - Brazil)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Errata: Publicação sobre processos editoriais (Portuguese - Brazil) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/errata-publicacao-sobre-processos-editoriais-portuguese--brazil.svg "Choose Errata: Publicação sobre processos editoriais (Portuguese - Brazil) in the CiteDrive App")
...
## How do I cite in  Errata: Publicação sobre processos editoriais (Portuguese - Brazil)?
...
## How do I create a bibliography in Errata: Publicação sobre processos editoriais (Portuguese - Brazil)?
