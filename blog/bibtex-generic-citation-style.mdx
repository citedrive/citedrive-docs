---
title: BibTeX generic citation style
author: Jospeh Moe
...
When you 're tasked by using "BibTeX generic citation style" (Plant Growth Regul) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  BibTeX generic citation style
* **Title:** BibTeX generic citation style
* **Type:** author-date
...
## How do I cite in  BibTeX generic citation style?
...
This sentence refers to the first item from the table. doe_2008 This, in turn, refers to the second doe_doe
and then to the third.  doe_doe_python
This paragraph demonstrates the clustering of citations by citing the first and third item. doe_2008_doe_doe_python

:::

## How do I create a bibliography in BibTeX generic citation style?
...
:::note Bibliography
 ...
 @article{doe_2008,  title={Title #1},  volume={3},  journal={Imaginary Journal},  author={Doe, Jane},  year={2008},  pages={1–999} }

 @misc{doe_doe,  title={Title #2},  url={https://example.com/},  author={Doe, Jane and Doe, John } }

 @article{doe_doe_python,  title={Title #3},  journal={ABC},  author={Doe, Jane and Doe, John and Python, Monty} }
