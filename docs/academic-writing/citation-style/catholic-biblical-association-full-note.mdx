...
When you 're tasked by using "Catholic Biblical Association (full note)" (Aust. Educ. Res.) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Catholic Biblical Association (full note)

* Title: Catholic Biblical Association (full note)
* Short Title (Id): Aust. Educ. Res.)
* Authors: Catholic Biblical Association (full note)
* Download: Catholic Biblical Association (full note)
 --->

## How can CiteDrive help you with Catholic Biblical Association (full note)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Catholic Biblical Association (full note) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/catholic-biblical-association-full-note.svg "Choose Catholic Biblical Association (full note) in the CiteDrive App")
...
## How do I cite in  Catholic Biblical Association (full note)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Jane Doe, “Title #1”, <i>Imaginary Journal</i> 3 (2008)  1–999 This, in turn, refers to the second Jane Doe and John  Doe, “Title #2”, [https://example.com/; accessed: May 1, 2021]
! and then to the third.  Jane Doe, John Doe, and Monty Python, “Title #3”, <i>ABC</i> (no date)
...
## How do I create a bibliography in Catholic Biblical Association (full note)?
