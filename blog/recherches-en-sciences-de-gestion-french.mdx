---
title: Recherches en Sciences de Gestion (French)
author: Jospeh Moe
...
When you 're tasked by using "Recherches en Sciences de Gestion (French)" (LUSEM) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Recherches en Sciences de Gestion (French)
* **Title:** Recherches en Sciences de Gestion (French)
* **Type:** author-date
...
## How do I cite in  Recherches en Sciences de Gestion (French)?
...
and then to the third.  (Doe, Doeet Python, s. d.)
This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe, 2008; Doe, Doeet Python, s. d.)

:::

## How do I create a bibliography in Recherches en Sciences de Gestion (French)?
...
<span style={{"font-variant":"small-caps"}}>Doe J.</span>, « Title #1 », <i>Imaginary journal</i>, tome III, 2008, p. 1‑999.

<span style={{"font-variant":"small-caps"}}>Doe J. et Doe J.</span>, « Title #2 », 2021. Consulté le mai 1. doi:https://example.com/.

<span style={{"font-variant":"small-caps"}}>Doe J., Doe J. et Python M.</span>, « Title #3 », <i>ABC</i>, s. d..
