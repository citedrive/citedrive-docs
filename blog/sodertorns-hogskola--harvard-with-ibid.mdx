---
title: Södertörns högskola - Harvard (with Ibid.)
author: Jospeh Moe
...
When you 're tasked by using "Södertörns högskola - Harvard (with Ibid.)" (SH - Harvard (Ibid.)) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Södertörns högskola - Harvard (with Ibid.)?
...
## How do I create a bibliography in Södertörns högskola - Harvard (with Ibid.)?
...
Doe, J. &amp; Doe, J. (2021). <i>Title #2</i>. https://example.com/ [2021-05-1].
