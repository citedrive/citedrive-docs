...
When you 're tasked by using "Proceedings of the Royal Society B" (Metallogr. Microstruct. Anal.) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Proceedings of the Royal Society B

* Title: Proceedings of the Royal Society B
* Short Title (Id): Metallogr. Microstruct. Anal.)
* Authors: Proceedings of the Royal Society B
* Download: Proceedings of the Royal Society B
 --->

## How can CiteDrive help you with Proceedings of the Royal Society B?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Proceedings of the Royal Society B for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/proceedings-of-the-royal-society-b.svg "Choose Proceedings of the Royal Society B in the CiteDrive App")
...
## How do I cite in  Proceedings of the Royal Society B?
...
## How do I create a bibliography in Proceedings of the Royal Society B?
...
!!! 2.Doe J, Doe J. In press. Title #2.  See https://example.com/ (accessed on 1 May 2021).
!!! 3.Doe J, Doe J, Python M. In press. Title #3. <i>ABC</i> 
