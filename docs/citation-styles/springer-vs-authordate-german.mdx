...
<!---
## About  Springer VS (author-date, German)

* Title: Springer VS (author-date, German)
* Short Title (Id): EuRJ)
* Authors: Springer VS (author-date, German)
* Download: Springer VS (author-date, German)
 --->
...
![citedrive_style](images/springer-vs-authordate-german.svg "Choose Springer VS (author-date, German) in the CiteDrive App")
