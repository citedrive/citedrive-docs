...
## Details  Vancouver (superscript, brackets, only year in date)
* **Title:** Vancouver (superscript, brackets, only year in date)
* **Type:** numeric
...
!["Vancouver (superscript, brackets, only year in date)"](images/vancouver-superscript-brackets-only-year-in-date.svg "Choose Vancouver (superscript, brackets, only year in date) in the CiteDrive App")
