...
When you 're tasked by using "Boreal Environment Research" (JAAA) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Boreal Environment Research

* Title: Boreal Environment Research
* Short Title (Id): JAAA)
* Authors: Boreal Environment Research
* Download: Boreal Environment Research
 --->

## How can CiteDrive help you with Boreal Environment Research?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Boreal Environment Research for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/boreal-environment-research.svg "Choose Boreal Environment Research in the CiteDrive App")
...
## How do I cite in  Boreal Environment Research?
...
## How do I create a bibliography in Boreal Environment Research?
