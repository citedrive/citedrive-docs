...
When you 're tasked by using "Sheffield Hallam University - History" (Electron Markets) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Sheffield Hallam University - History

* Title: Sheffield Hallam University - History
* Short Title (Id): Electron Markets)
* Authors: Sheffield Hallam University - History
* Download: Sheffield Hallam University - History
 --->

## How can CiteDrive help you with Sheffield Hallam University - History?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Sheffield Hallam University - History for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/sheffield-hallam-university--history.svg "Choose Sheffield Hallam University - History in the CiteDrive App")
...
## How do I cite in  Sheffield Hallam University - History?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. J. Doe, ‘Title #1’, <i>Imaginary Journal</i>, 3 (2008), pp. 1–999. This, in turn, refers to the second J. Doe and J. Doe, ‘Title #2’, https://example.com/, accessed 1 May 2021.
...
## How do I create a bibliography in Sheffield Hallam University - History?
...
!!! **Bibliography**
!!! Doe, J., ‘Title #1’, <i>Imaginary Journal</i>, 3 (2008), pp. 1–999.
!!! Doe, J., and J. Doe, ‘Title #2’, https://example.com/, accessed 1 May 2021.
!!! Doe, J., J. Doe, and M. Python, ‘Title #3’, <i>ABC</i>, n.d..
