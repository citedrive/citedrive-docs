...
When you 're tasked by using "Textual Practice" (TextPrac) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Textual Practice?
...
This sentence refers to the first item from the table. Jane Doe, ‘Title #1’, <i>Imaginary Journal</i>, 3 (2008), pp. 1–999. This, in turn, refers to the second Jane Doe and John  Doe, ‘Title #2’ [https://example.com/], accessed 1/5/2021.
and then to the third.  Jane Doe, John Doe, and Monty Python, ‘Title #3’, <i>ABC</i>, pp. .
This paragraph demonstrates the clustering of citations by citing the first and third item. Doe, <i>Title #1</i>; Doe, Doe, and Python, <i>Title #3</i>.

:::

## How do I create a bibliography in Textual Practice?
