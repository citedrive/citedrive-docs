---
title: ProInflow (note, Czech)
author: Jospeh Moe
author_title: CiteDrive Bot
author_url: https://citedrive.com/
tags: [note, communications]
---

When you 're tasked by using "ProInflow (note, Czech)" (ACS Photonics) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  ProInflow (note, Czech)?
...
This sentence refers to the first item from the table. DOE, Jane. Title #1. <i>Imaginary Journal</i>. 2008, roč. 3, s. 1–999.  This, in turn, refers to the second DOE, Jane a John  DOE. Title #2 [online].  [vid.. 1. květen 2021]. Získáno z: https://example.com/
and then to the third.  DOE, Jane, John DOE a Monty PYTHON. Title #3. <i>ABC</i>. nedatováno. 
This paragraph demonstrates the clustering of citations by citing the first and third item. DOE, Jane. Title #1. <i>Imaginary Journal</i>. 2008, roč. 3, s. 1–999. ; DOE, Jane, John DOE a Monty PYTHON. Title #3. <i>ABC</i>. nedatováno. 

:::

## How do I create a bibliography in ProInflow (note, Czech)?
...
DOE, Jane. Title #1. <i>Imaginary Journal</i>. 2008, roč. 3, s. 1–999. 

DOE, Jane a John  DOE. Title #2 [online].  [vid.. 1. květen 2021]. Získáno z: https://example.com/

DOE, Jane, John DOE a Monty PYTHON. Title #3. <i>ABC</i>. nedatováno. 
