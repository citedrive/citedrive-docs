...
## Details  Elsevier - Harvard (without titles)
* **Title:** Elsevier - Harvard (without titles)
* **Type:** author-date
...
!["Elsevier - Harvard (without titles)"](images/elsevier--harvard-without-titles.svg "Choose Elsevier - Harvard (without titles) in the CiteDrive App")
