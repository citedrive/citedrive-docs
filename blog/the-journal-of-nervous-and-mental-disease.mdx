...
When you 're tasked by using "The Journal of Nervous and Mental Disease" (Environ Sci Pollut Res) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  The Journal of Nervous and Mental Disease
* **Title:** The Journal of Nervous and Mental Disease
* **Type:** author-date
* **Short Title (Id):** Environ Sci Pollut Res)
* fields: , medicine

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with The Journal of Nervous and Mental Disease? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in The Journal of Nervous and Mental Disease for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["The Journal of Nervous and Mental Disease"](images/the-journal-of-nervous-and-mental-disease.svg "Choose The Journal of Nervous and Mental Disease in the CiteDrive App")
...
## How do I cite in  The Journal of Nervous and Mental Disease?
...
## How do I create a bibliography in The Journal of Nervous and Mental Disease?
...
Doe J, Doe J (2021) Title #2.. https://example.com/ (last accessed 1 May 2021).
