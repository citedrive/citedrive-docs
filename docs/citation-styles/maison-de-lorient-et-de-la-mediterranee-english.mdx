...
When you 're tasked by using "Maison de l'Orient et de la Méditerranée (English)" (MOM Éditions (EN)) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Maison de l'Orient et de la Méditerranée (English)

* Title: Maison de l'Orient et de la Méditerranée (English)
* Short Title (Id): MOM Éditions (EN))
* Authors: Maison de l'Orient et de la Méditerranée (English)
* Download: Maison de l'Orient et de la Méditerranée (English)
 --->

## How can CiteDrive help you with Maison de l'Orient et de la Méditerranée (English)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Maison de l'Orient et de la Méditerranée (English) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/maison-de-lorient-et-de-la-mediterranee-english.svg "Choose Maison de l'Orient et de la Méditerranée (English) in the CiteDrive App")
...
## How do I cite in  Maison de l'Orient et de la Méditerranée (English)?
...
## How do I create a bibliography in Maison de l'Orient et de la Méditerranée (English)?
...
!!! **Bibliography**
!!! Doe 2008: J. Doe, “Title #1”, <i>Imaginary Journal</i> 3, 2008, pp. 1–999.
!!! Doe, Doe s.d.: J. Doe, J. Doe, “Title #2”, , s.d., https://example.com/ (accessed 01/05/2021).
!!! Doe, Doe, Python s.d.: J. Doe, J. Doe, M. Python, “Title #3”, <i>ABC</i>, s.d..
