...
This paragraph demonstrates the clustering of citations by citing the first and third item. Jane Doe, « Title #1 », dans <i>Imaginary Journal</i>, vol. 3, 2008, p. 1‑999
