...
<!---
## About  Interaction Design & Architecture(s)

* Title: Interaction Design & Architecture(s)
* Short Title (Id): IxD&A)
* Authors: Interaction Design & Architecture(s)
* Download: Interaction Design & Architecture(s)
 --->
...
![citedrive_style](images/interaction-design-and-architectures.svg "Choose Interaction Design & Architecture(s) in the CiteDrive App")
