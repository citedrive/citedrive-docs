...
When you 're tasked by using "Helsingin yliopisto - Teologinen tiedekunta (Finnish)" (Minds & Machines) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Helsingin yliopisto - Teologinen tiedekunta (Finnish)

* Title: Helsingin yliopisto - Teologinen tiedekunta (Finnish)
* Short Title (Id): Minds & Machines)
* Authors: Helsingin yliopisto - Teologinen tiedekunta (Finnish)
* Download: Helsingin yliopisto - Teologinen tiedekunta (Finnish)
 --->

## How can CiteDrive help you with Helsingin yliopisto - Teologinen tiedekunta (Finnish)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Helsingin yliopisto - Teologinen tiedekunta (Finnish) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/helsingin-yliopisto--teologinen-tiedekunta-finnish.svg "Choose Helsingin yliopisto - Teologinen tiedekunta (Finnish) in the CiteDrive App")
...
## How do I cite in  Helsingin yliopisto - Teologinen tiedekunta (Finnish)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Doe 2008. This, in turn, refers to the second Doe &amp; Doe <i>s.a.</i>.
! and then to the third.  Doe, Doe&amp; Python <i>s.a.</i>.
! This paragraph demonstrates the clustering of citations by citing the first and third item. Doe 2008; Doe, Doe&amp; Python <i>s.a.</i>.



## How do I create a bibliography in Helsingin yliopisto - Teologinen tiedekunta (Finnish)?
...
!!! Doe, Jane &amp; John  Doe (s.a.). Title #2.  https://example.com/. (luettu1.5.2021).
!!! Doe, Jane, John Doe &amp; Monty Python (s.a.). Title #3. <i>ABC</i>.
