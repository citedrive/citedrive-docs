...
<!---
## About  Springer - Basic (author-date, no "et al.")

* Title: Springer - Basic (author-date, no "et al.")
* Short Title (Id): BiEtud)
* Authors: Springer - Basic (author-date, no "et al.")
* Download: Springer - Basic (author-date, no "et al.")
 --->
...
![citedrive_style](images/springer--basic-authordate-no-et-al.svg "Choose Springer - Basic (author-date, no "et al.") in the CiteDrive App")
