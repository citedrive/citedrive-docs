...
# Enfermería Clínica (Spanish)

When you 're tasked by using "Enfermería Clínica (Spanish)" (ENFCLI) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Enfermería Clínica (Spanish)

* Title: Enfermería Clínica (Spanish)
* Short Title (Id): ENFCLI)
* Authors: Enfermería Clínica (Spanish)
* Download: Enfermería Clínica (Spanish)
 --->

## How can CiteDrive help you with Enfermería Clínica (Spanish)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Enfermería Clínica (Spanish) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/enfermeria-clinica-spanish.svg "Choose Enfermería Clínica (Spanish) in the CiteDrive App")
...
## How do I cite in  Enfermería Clínica (Spanish)?
...
## How do I create a bibliography in Enfermería Clínica (Spanish)?
