...
When you 're tasked by using "The Journal of Clinical Ethics" (JCE) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  The Journal of Clinical Ethics

* Title: The Journal of Clinical Ethics
* Short Title (Id): JCE)
* Authors: The Journal of Clinical Ethics
* Download: The Journal of Clinical Ethics
 --->

## How can CiteDrive help you with The Journal of Clinical Ethics?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in The Journal of Clinical Ethics for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/the-journal-of-clinical-ethics.svg "Choose The Journal of Clinical Ethics in the CiteDrive App")
...
## How do I cite in  The Journal of Clinical Ethics?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. J. Doe, “Title #1”, <i>Imaginary Journal</i> 3 (2008): 1–999. This, in turn, refers to the second J. Doe and J. Doe, Title #2, n.d... Available at: https://example.com/. [Accessed: 01-May-2021].
! and then to the third.  J. Doe, J. Doe and M. Python, “Title #3”, <i>ABC</i> (n.d.).
! This paragraph demonstrates the clustering of citations by citing the first and third item. J. Doe, Title #1; J. Doe, J. Doe and M. Python, Title #3.



## How do I create a bibliography in The Journal of Clinical Ethics?
