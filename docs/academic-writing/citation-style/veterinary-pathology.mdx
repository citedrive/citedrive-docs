...
* Short Title (Id): NRR)
* Authors: Veterinary Pathology
* Download: Veterinary Pathology
 --->
...
![citedrive_style](images/veterinary-pathology.svg "Choose Veterinary Pathology in the CiteDrive App")
