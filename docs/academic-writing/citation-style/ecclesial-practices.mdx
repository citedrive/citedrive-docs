...
<!---
## About  Ecclesial Practices

* Title: Ecclesial Practices
* Short Title (Id): Bull. Chem. Soc. Jpn.)
* Authors: Ecclesial Practices
* Download: Ecclesial Practices
 --->
...
![citedrive_style](images/ecclesial-practices.svg "Choose Ecclesial Practices in the CiteDrive App")
