...
<!---
## About  Springer - Basic (numeric, brackets)

* Title: Springer - Basic (numeric, brackets)
* Short Title (Id): Veget Hist Archaeobot)
* Authors: Springer - Basic (numeric, brackets)
* Download: Springer - Basic (numeric, brackets)
 --->
...
![citedrive_style](images/springer--basic-numeric-brackets.svg "Choose Springer - Basic (numeric, brackets) in the CiteDrive App")
