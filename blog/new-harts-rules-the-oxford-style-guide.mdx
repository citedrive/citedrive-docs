...
When you 're tasked by using "New Hart''s Rules: The Oxford Style Guide" (IAI) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  New Hart''s Rules: The Oxford Style Guide
* **Title:** New Hart''s Rules: The Oxford Style Guide
* **Type:** note
* **Short Title (Id):** IAI)
* fields: , generic-base
...
## How do I cite in  New Hart''s Rules: The Oxford Style Guide?
...
This sentence refers to the first item from the table. Jane Doe, ‘Title #1’, <i>Imaginary Journal</i>, 3 (2008), 1–999. This, in turn, refers to the second Jane Doe and John  Doe, ‘Title #2’ {"<"}https://example.com/{">"} [accessed 1 May 2021].
...
## How do I create a bibliography in New Hart''s Rules: The Oxford Style Guide?
