...
When you 're tasked by using "American Journal of Respiratory and Critical Care Medicine" (Proc. Natl. Acad. Sci., India, Sect. A Phys. Sci.) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  American Journal of Respiratory and Critical Care Medicine
* **Title:** American Journal of Respiratory and Critical Care Medicine
* **Type:** numeric
* **Short Title (Id):** Proc. Natl. Acad. Sci., India, Sect. A Phys. Sci.)
* fields: , medicine

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with American Journal of Respiratory and Critical Care Medicine? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in American Journal of Respiratory and Critical Care Medicine for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["American Journal of Respiratory and Critical Care Medicine"](images/american-journal-of-respiratory-and-critical-care-medicine.svg "Choose American Journal of Respiratory and Critical Care Medicine in the CiteDrive App")
...
## How do I cite in  American Journal of Respiratory and Critical Care Medicine?
...
## How do I create a bibliography in American Journal of Respiratory and Critical Care Medicine?
