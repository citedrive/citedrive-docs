...
<!---
## About  Vancouver (brackets, no "et al.")

* Title: Vancouver (brackets, no "et al.")
* Short Title (Id): Biometals)
* Authors: Vancouver (brackets, no "et al.")
* Download: Vancouver (brackets, no "et al.")
 --->
...
![citedrive_style](images/vancouver-brackets-no-et-al.svg "Choose Vancouver (brackets, no "et al.") in the CiteDrive App")
