---
title: The Open University (numeric)
author: Jospeh Moe
...
When you 're tasked by using "The Open University (numeric)" (KJR) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  The Open University (numeric)
* **Title:** The Open University (numeric)
* **Type:** numeric
* **Short Title (Id):** KJR)
* fields: , generic-base
...
## How do I cite in  The Open University (numeric)?
...
## How do I create a bibliography in The Open University (numeric)?
