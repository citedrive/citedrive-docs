...
<!---
## About  Haute école de gestion de Genève - ISO-690 (English)

* Title: Haute école de gestion de Genève - ISO-690 (English)
* Short Title (Id): IBICT)
* Authors: Haute école de gestion de Genève - ISO-690 (English)
* Download: Haute école de gestion de Genève - ISO-690 (English)
 --->
...
![citedrive_style](images/haute-ecole-de-gestion-de-geneve--iso690-english.svg "Choose Haute école de gestion de Genève - ISO-690 (English) in the CiteDrive App")
