...
<!---
## About  Springer - Vancouver (brackets)

* Title: Springer - Vancouver (brackets)
* Short Title (Id): IJPR)
* Authors: Springer - Vancouver (brackets)
* Download: Springer - Vancouver (brackets)
 --->
...
![citedrive_style](images/springer--vancouver-brackets.svg "Choose Springer - Vancouver (brackets) in the CiteDrive App")
