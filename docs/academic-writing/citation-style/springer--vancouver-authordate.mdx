...
<!---
## About  Springer - Vancouver (author-date)

* Title: Springer - Vancouver (author-date)
* Short Title (Id): JPIM)
* Authors: Springer - Vancouver (author-date)
* Download: Springer - Vancouver (author-date)
 --->
...
![citedrive_style](images/springer--vancouver-authordate.svg "Choose Springer - Vancouver (author-date) in the CiteDrive App")
