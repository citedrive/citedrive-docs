...
# ISO-690 (author-date, Portuguese - Brazil)

When you 're tasked by using "ISO-690 (author-date, Portuguese - Brazil)" (J. Am. Chem. Soc.) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  ISO-690 (author-date, Portuguese - Brazil)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. (Doe 2008) This, in turn, refers to the second (Doe, Doe [sem data])
! and then to the third.  (Doe, Doe, Python [sem data])
! This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe 2008; Doe, Doe, Python [sem data])



## How do I create a bibliography in ISO-690 (author-date, Portuguese - Brazil)?
...
!!! DOE, Jane e DOE, John , [sem data]. Title #2.  [em linha].  [Acesso em 1 maio 2021]. Disponível em: https://example.com/
!!! DOE, Jane, DOE, John e PYTHON, Monty, [sem data]. Title #3. <i>ABC</i>. 
