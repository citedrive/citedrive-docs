...
When you 're tasked by using "Journal of Plant Nutrition and Soil Science" (JPNSS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Journal of Plant Nutrition and Soil Science?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. (<i><i>Doe</i></i>, 2008) This, in turn, refers to the second (<i><i>Doe</i> and <i>Doe</i></i>, n.d.)
! and then to the third.  (<i><i>Doe</i></i>, n.d.)
! This paragraph demonstrates the clustering of citations by citing the first and third item. (<i><i>Doe</i></i>, n.d.; <i><i>Doe</i></i>, 2008)



## How do I create a bibliography in Journal of Plant Nutrition and Soil Science?
...
!!! **Bibliography**
!!! <i>Doe, J.</i> (2008): Title #1. <i>Imaginary Journal</i> 3, 1–999.
!!! <i>Doe, J., Doe, J.</i> (n.d.): Title #2 [WWW Document].. URL https://example.com/ (accessed 5.1.21).
!!! <i>Doe, J., Doe, J., Python, M.</i> (n.d.): Title #3. <i>ABC</i>.
