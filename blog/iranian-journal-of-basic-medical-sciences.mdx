...
When you 're tasked by using "Iranian Journal of Basic Medical Sciences" (IJBMS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Iranian Journal of Basic Medical Sciences
* **Title:** Iranian Journal of Basic Medical Sciences
* **Type:** numeric
* **Short Title (Id):** IJBMS)
* fields: , medicine

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Iranian Journal of Basic Medical Sciences? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Iranian Journal of Basic Medical Sciences for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Iranian Journal of Basic Medical Sciences"](images/iranian-journal-of-basic-medical-sciences.svg "Choose Iranian Journal of Basic Medical Sciences in the CiteDrive App")
...
## How do I cite in  Iranian Journal of Basic Medical Sciences?
...
## How do I create a bibliography in Iranian Journal of Basic Medical Sciences?
...
3. Doe J, Doe Jand Python M. Title #3. ABC. 
