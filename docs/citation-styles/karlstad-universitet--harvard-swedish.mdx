...
# Karlstad Universitet - Harvard (Swedish)

When you 're tasked by using "Karlstad Universitet - Harvard (Swedish)" (KAU Harvard) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Karlstad Universitet - Harvard (Swedish)

* Title: Karlstad Universitet - Harvard (Swedish)
* Short Title (Id): KAU Harvard)
* Authors: Karlstad Universitet - Harvard (Swedish)
* Download: Karlstad Universitet - Harvard (Swedish)
 --->

## How can CiteDrive help you with Karlstad Universitet - Harvard (Swedish)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Karlstad Universitet - Harvard (Swedish) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/karlstad-universitet--harvard-swedish.svg "Choose Karlstad Universitet - Harvard (Swedish) in the CiteDrive App")
...
## How do I cite in  Karlstad Universitet - Harvard (Swedish)?
...
! and then to the third.  (Doe m.fl.)
! This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe 2008; Doe m.fl.)



## How do I create a bibliography in Karlstad Universitet - Harvard (Swedish)?
