---
title: Zdravniški Vestnik (Slovenian Medical Journal)
author: Jospeh Moe
...
When you 're tasked by using "Zdravniški Vestnik (Slovenian Medical Journal)" (Vdrav Vestn) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Zdravniški Vestnik (Slovenian Medical Journal)
* **Title:** Zdravniški Vestnik (Slovenian Medical Journal)
* **Type:** numeric
* **Short Title (Id):** Vdrav Vestn)
* fields: , medicine

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Zdravniški Vestnik (Slovenian Medical Journal)? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Zdravniški Vestnik (Slovenian Medical Journal) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Zdravniški Vestnik (Slovenian Medical Journal)"](images/zdravniski-vestnik-slovenian-medical-journal.svg "Choose Zdravniški Vestnik (Slovenian Medical Journal) in the CiteDrive App")
...
## How do I cite in  Zdravniški Vestnik (Slovenian Medical Journal)?
...
## How do I create a bibliography in Zdravniški Vestnik (Slovenian Medical Journal)?
