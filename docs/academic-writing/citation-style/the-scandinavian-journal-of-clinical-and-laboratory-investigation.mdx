...
When you 're tasked by using "The Scandinavian Journal of Clinical & Laboratory Investigation" (Environ Fluid Mech) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  The Scandinavian Journal of Clinical & Laboratory Investigation

* Title: The Scandinavian Journal of Clinical & Laboratory Investigation
* Short Title (Id): Environ Fluid Mech)
* Authors: The Scandinavian Journal of Clinical & Laboratory Investigation
* Download: The Scandinavian Journal of Clinical & Laboratory Investigation
 --->

## How can CiteDrive help you with The Scandinavian Journal of Clinical & Laboratory Investigation?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in The Scandinavian Journal of Clinical & Laboratory Investigation for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/the-scandinavian-journal-of-clinical-and-laboratory-investigation.svg "Choose The Scandinavian Journal of Clinical & Laboratory Investigation in the CiteDrive App")
...
## How do I cite in  The Scandinavian Journal of Clinical & Laboratory Investigation?
...
## How do I create a bibliography in The Scandinavian Journal of Clinical & Laboratory Investigation?
