...
When you 're tasked by using "Freie Universität Berlin - Geographische Wissenschaften (German)" (Strat Traum Limb Recon) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Freie Universität Berlin - Geographische Wissenschaften (German)

* Title: Freie Universität Berlin - Geographische Wissenschaften (German)
* Short Title (Id): Strat Traum Limb Recon)
* Authors: Freie Universität Berlin - Geographische Wissenschaften (German)
* Download: Freie Universität Berlin - Geographische Wissenschaften (German)
 --->

## How can CiteDrive help you with Freie Universität Berlin - Geographische Wissenschaften (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Freie Universität Berlin - Geographische Wissenschaften (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/freie-universitat-berlin--geographische-wissenschaften-german.svg "Choose Freie Universität Berlin - Geographische Wissenschaften (German) in the CiteDrive App")
...
## How do I cite in  Freie Universität Berlin - Geographische Wissenschaften (German)?
...
## How do I create a bibliography in Freie Universität Berlin - Geographische Wissenschaften (German)?
...
!!! **Bibliography**
!!! DOE, J. (2008): Title #1. Imaginary Journal <b>3</b>. S. 1–999.
!!! DOE, J. &amp; DOE, J. (o. J.): Title #2. https://example.com/ (01.05.2021) 
