...
# Zeitschrift für digitale Geisteswissenschaften (German)

When you 're tasked by using "Zeitschrift für digitale Geisteswissenschaften (German)" (ZfdG) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Zeitschrift für digitale Geisteswissenschaften (German)

* Title: Zeitschrift für digitale Geisteswissenschaften (German)
* Short Title (Id): ZfdG)
* Authors: Zeitschrift für digitale Geisteswissenschaften (German)
* Download: Zeitschrift für digitale Geisteswissenschaften (German)
 --->

## How can CiteDrive help you with Zeitschrift für digitale Geisteswissenschaften (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Zeitschrift für digitale Geisteswissenschaften (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/zeitschrift-fur-digitale-geisteswissenschaften-german.svg "Choose Zeitschrift für digitale Geisteswissenschaften (German) in the CiteDrive App")
...
## How do I cite in  Zeitschrift für digitale Geisteswissenschaften (German)?
...
! This paragraph demonstrates the clustering of citations by citing the first and third item. Doe 2008Doe et al..



## How do I create a bibliography in Zeitschrift für digitale Geisteswissenschaften (German)?
...
!!! Jane Doe / John  Doe: Title #2.  https://example.com/..
