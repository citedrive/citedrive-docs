---
title: Pädagogische Hochschule Heidelberg (German)
author: Jospeh Moe
...
When you 're tasked by using "Pädagogische Hochschule Heidelberg (German)" (PH Heidelberg) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Pädagogische Hochschule Heidelberg (German)
* **Title:** Pädagogische Hochschule Heidelberg (German)
* **Type:** author-date
* **Short Title (Id):** PH Heidelberg)
* fields: , generic-base

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Pädagogische Hochschule Heidelberg (German)? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Pädagogische Hochschule Heidelberg (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Pädagogische Hochschule Heidelberg (German)"](images/padagogische-hochschule-heidelberg-german.svg "Choose Pädagogische Hochschule Heidelberg (German) in the CiteDrive App")
...
## How do I cite in  Pädagogische Hochschule Heidelberg (German)?
...
## How do I create a bibliography in Pädagogische Hochschule Heidelberg (German)?
...
Doe, Jane (2008). Title #1. In: Imaginary Journal, 3 (2008), S. 1–999.

Doe, Jane; Doe, John  (o. J.). Title #2. Online im Internet: https://example.com/ (Zugriff am: 01.05.2021).

Doe, Jane; Doe, John; Python, Monty (o. J.). Title #3. In: ABC, , S. .
