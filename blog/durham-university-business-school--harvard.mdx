---
title: Durham University Business School - Harvard
author: Jospeh Moe
...
When you 're tasked by using "Durham University Business School - Harvard" (Virus Genes) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Durham University Business School - Harvard
* **Title:** Durham University Business School - Harvard
* **Type:** author-date
* **Short Title (Id):** Virus Genes)
* fields: , generic-base

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Durham University Business School - Harvard? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Durham University Business School - Harvard for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Durham University Business School - Harvard"](images/durham-university-business-school--harvard.svg "Choose Durham University Business School - Harvard in the CiteDrive App")
...
## How do I cite in  Durham University Business School - Harvard?
...
## How do I create a bibliography in Durham University Business School - Harvard?
...
Doe, J. and Doe, J. (n.d.) <i>Title #2</i>. [Online]. Available at: https://example.com/ (Accessed: 1 May 2021).
