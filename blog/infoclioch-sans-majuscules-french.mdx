---
title: infoclio.ch (sans majuscules, French)
author: Jospeh Moe
...
When you 're tasked by using "infoclio.ch (sans majuscules, French)" (EER) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  infoclio.ch (sans majuscules, French)
* **Title:** infoclio.ch (sans majuscules, French)
* **Type:** note
* **Short Title (Id):** EER)
...
## How do I cite in  infoclio.ch (sans majuscules, French)?
...
This sentence refers to the first item from the table. Doe Jane, « Title #1 », <i>Imaginary Journal</i> 3, 2008, pp. 1‑999. This, in turn, refers to the second Doe Jane et Doe John , « Title #2 », {"<"}https://example.com/{">"}, consulté le 01.05.2021.
and then to the third.  Doe Jane, Doe John et Python Monty, « Title #3 », <i>ABC</i>, s. d..
This paragraph demonstrates the clustering of citations by citing the first and third item. Doe, « Title #1 », <i>art. cit.</i>., 2008 ; Doe, Doe et Python, « Title #3 », <i>art. cit.</i>..

:::

## How do I create a bibliography in infoclio.ch (sans majuscules, French)?
...
Doe Jane, « Title #1 », <i>Imaginary Journal</i> 3, 2008, pp. 1‑999.

Doe Jane et Doe John , « Title #2 », {"<"}https://example.com/{">"}, consulté le 01.05.2021.
