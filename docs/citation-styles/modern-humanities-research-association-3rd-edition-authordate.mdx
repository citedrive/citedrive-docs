...
When you 're tasked by using "Modern Humanities Research Association 3rd edition (author-date)" (MHRA) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Modern Humanities Research Association 3rd edition (author-date)

* Title: Modern Humanities Research Association 3rd edition (author-date)
* Short Title (Id): MHRA)
* Authors: Modern Humanities Research Association 3rd edition (author-date)
* Download: Modern Humanities Research Association 3rd edition (author-date)
 --->

## How can CiteDrive help you with Modern Humanities Research Association 3rd edition (author-date)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Modern Humanities Research Association 3rd edition (author-date) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/modern-humanities-research-association-3rd-edition-authordate.svg "Choose Modern Humanities Research Association 3rd edition (author-date) in the CiteDrive App")
...
## How do I cite in  Modern Humanities Research Association 3rd edition (author-date)?
...
! and then to the third.  (Doe and others [n.d.])
! This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe 2008; Doe and others [n.d.])



## How do I create a bibliography in Modern Humanities Research Association 3rd edition (author-date)?
...
!!! Doe, Jane, and John  Doe. [n.d.]. ‘Title #2’, p.  <https://example.com/> [accessed 1 May 2021]
