---
title: ISO-690 (numeric, parentheses, Czech)
author: Jospeh Moe
...
When you 're tasked by using "ISO-690 (numeric, parentheses, Czech)" (Public Choice) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  ISO-690 (numeric, parentheses, Czech)?
...
## How do I create a bibliography in ISO-690 (numeric, parentheses, Czech)?
...
1. DOE, Jane. Title #1. <i>Imaginary Journal</i>. 2008, <b>3</b>, 1–999. 

2. DOE, Jane a John  DOE. <i>Title #2</i> [online].  [vid.. 2021-05-01]. Dostupné z: https://example.com/

3. DOE, Jane, John DOE a Monty PYTHON. Title #3. <i>ABC</i>. nedatováno. 
