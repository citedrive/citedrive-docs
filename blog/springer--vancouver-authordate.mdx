---
title: Springer - Vancouver (author-date)
author: Jospeh Moe
...
When you 're tasked by using "Springer - Vancouver (author-date)" (JPIM) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Springer - Vancouver (author-date)
* **Title:** Springer - Vancouver (author-date)
* **Type:** author-date
* **Short Title (Id):** JPIM)
* fields: , generic-base
...
## How do I cite in  Springer - Vancouver (author-date)?
...
## How do I create a bibliography in Springer - Vancouver (author-date)?
