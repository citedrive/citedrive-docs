...
When you 're tasked by using "Journal of the Association of Environmental and Resource Economists" (JAERE) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Journal of the Association of Environmental and Resource Economists

* Title: Journal of the Association of Environmental and Resource Economists
* Short Title (Id): JAERE)
* Authors: Journal of the Association of Environmental and Resource Economists
* Download: Journal of the Association of Environmental and Resource Economists
 --->

## How can CiteDrive help you with Journal of the Association of Environmental and Resource Economists?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Journal of the Association of Environmental and Resource Economists for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/journal-of-the-association-of-environmental-and-resource-economists.svg "Choose Journal of the Association of Environmental and Resource Economists in the CiteDrive App")
...
## How do I cite in  Journal of the Association of Environmental and Resource Economists?
...
## How do I create a bibliography in Journal of the Association of Environmental and Resource Economists?
...
!!! Doe, Jand J Doe. Title #2. https://example.com/.
!!! Doe, J, J Doeand M Python. Title #3. <i>ABC</i>.
