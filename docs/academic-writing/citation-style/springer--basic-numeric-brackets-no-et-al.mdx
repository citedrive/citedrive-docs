...
<!---
## About  Springer - Basic (numeric, brackets, no "et al.")

* Title: Springer - Basic (numeric, brackets, no "et al.")
* Short Title (Id): Popul Ecol)
* Authors: Springer - Basic (numeric, brackets, no "et al.")
* Download: Springer - Basic (numeric, brackets, no "et al.")
 --->
...
![citedrive_style](images/springer--basic-numeric-brackets-no-et-al.svg "Choose Springer - Basic (numeric, brackets, no "et al.") in the CiteDrive App")
