...
When you 're tasked by using "ACM SIG Proceedings ("et al." for 3+ authors)" (Patient) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  ACM SIG Proceedings ("et al." for 3+ authors)?
...
## How do I create a bibliography in ACM SIG Proceedings ("et al." for 3+ authors)?
