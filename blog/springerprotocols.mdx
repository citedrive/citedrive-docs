...
When you 're tasked by using "SpringerProtocols" (IS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  SpringerProtocols?
...
This paragraph demonstrates the clustering of citations by citing the first and third item. <b><i>(1, 3)</i></b>

:::

## How do I create a bibliography in SpringerProtocols?
...
1. Doe J (2008) Title #1. 3:1–999

2. Doe J and Doe J Title #2, https://example.com/

3. Doe J, Doe Jand Python M Title #3.
