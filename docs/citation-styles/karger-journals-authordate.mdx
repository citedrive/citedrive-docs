...
<!---
## About  Karger journals (author-date)

* Title: Karger journals (author-date)
* Short Title (Id): Ann Univ Ferrara)
* Authors: Karger journals (author-date)
* Download: Karger journals (author-date)
 --->
...
![citedrive_style](images/karger-journals-authordate.svg "Choose Karger journals (author-date) in the CiteDrive App")
