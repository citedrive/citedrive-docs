...
## Details  Springer - Basic (author-date, no "et al.", with issue numbers)
* **Title:** Springer - Basic (author-date, no "et al.", with issue numbers)
* **Type:** author-date
...
!["Springer - Basic (author-date, no "et al.", with issue numbers)"](images/springer--basic-authordate-no-et-al-with-issue-numbers.svg "Choose Springer - Basic (author-date, no "et al.", with issue numbers) in the CiteDrive App")
