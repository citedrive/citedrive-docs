...
When you 're tasked by using "Integrative & Comparative Biology" (UWE Bristol) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Integrative & Comparative Biology

* Title: Integrative & Comparative Biology
* Short Title (Id): UWE Bristol)
* Authors: Integrative & Comparative Biology
* Download: Integrative & Comparative Biology
 --->

## How can CiteDrive help you with Integrative & Comparative Biology?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Integrative & Comparative Biology for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/integrative-and-comparative-biology.svg "Choose Integrative & Comparative Biology in the CiteDrive App")
...
## How do I cite in  Integrative & Comparative Biology?
...
## How do I create a bibliography in Integrative & Comparative Biology?
...
!!! Doe J, Doe J. 2021. Title #2. (https://example.com/).
