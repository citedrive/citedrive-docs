...
<!---
## About  The Open University (numeric, superscript)

* Title: The Open University (numeric, superscript)
* Short Title (Id): Ann Nucl Med)
* Authors: The Open University (numeric, superscript)
* Download: The Open University (numeric, superscript)
 --->
...
![citedrive_style](images/the-open-university-numeric-superscript.svg "Choose The Open University (numeric, superscript) in the CiteDrive App")
