...
<!---
## About  ISO-690 (author-date, French)

* Title: ISO-690 (author-date, French)
* Short Title (Id): AOSIS)
* Authors: ISO-690 (author-date, French)
* Download: ISO-690 (author-date, French)
 --->
...
![citedrive_style](images/iso690-authordate-french.svg "Choose ISO-690 (author-date, French) in the CiteDrive App")
