...
When you 're tasked by using "International Journal of Oral and Maxillofacial Surgery" (IJOM) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  International Journal of Oral and Maxillofacial Surgery

* Title: International Journal of Oral and Maxillofacial Surgery
* Short Title (Id): IJOM)
* Authors: International Journal of Oral and Maxillofacial Surgery
* Download: International Journal of Oral and Maxillofacial Surgery
 --->

## How can CiteDrive help you with International Journal of Oral and Maxillofacial Surgery?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in International Journal of Oral and Maxillofacial Surgery for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/international-journal-of-oral-and-maxillofacial-surgery.svg "Choose International Journal of Oral and Maxillofacial Surgery in the CiteDrive App")
...
## How do I cite in  International Journal of Oral and Maxillofacial Surgery?
...
## How do I create a bibliography in International Journal of Oral and Maxillofacial Surgery?
...
!!! 3.Doe J, Doe J, Python M. Title #3. <i>ABC</i> n.d..
