...
When you 're tasked by using "Revista Chilena de Derecho y Tecnología (Spanish - Chile)" (RChDT) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Revista Chilena de Derecho y Tecnología (Spanish - Chile)

* Title: Revista Chilena de Derecho y Tecnología (Spanish - Chile)
* Short Title (Id): RChDT)
* Authors: Revista Chilena de Derecho y Tecnología (Spanish - Chile)
* Download: Revista Chilena de Derecho y Tecnología (Spanish - Chile)
 --->

## How can CiteDrive help you with Revista Chilena de Derecho y Tecnología (Spanish - Chile)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Revista Chilena de Derecho y Tecnología (Spanish - Chile) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/revista-chilena-de-derecho-y-tecnologia-spanish--chile.svg "Choose Revista Chilena de Derecho y Tecnología (Spanish - Chile) in the CiteDrive App")
...
## How do I cite in  Revista Chilena de Derecho y Tecnología (Spanish - Chile)?
...
## How do I create a bibliography in Revista Chilena de Derecho y Tecnología (Spanish - Chile)?
...
!!! **Bibliography**
!!! Doe Jane (2008). “Title #1”. Imaginary Journal.  vol. 3.
!!! Doe Jane y John  Doe (2021). “Title #2”. Disponible en <https://example.com/>.
!!! Doe Jane. John Doe y Monty Python (s/f). “Title #3”. ABC.
