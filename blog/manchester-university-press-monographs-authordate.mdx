---
title: Manchester University Press monographs (author-date)
author: Jospeh Moe
...
When you 're tasked by using "Manchester University Press monographs (author-date)" (Onkologe) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Manchester University Press monographs (author-date)
* **Title:** Manchester University Press monographs (author-date)
* **Type:** author-date
* **Short Title (Id):** Onkologe)
* fields: , generic-base

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Manchester University Press monographs (author-date)? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Manchester University Press monographs (author-date) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Manchester University Press monographs (author-date)"](images/manchester-university-press-monographs-authordate.svg "Choose Manchester University Press monographs (author-date) in the CiteDrive App")
...
## How do I cite in  Manchester University Press monographs (author-date)?
...
## How do I create a bibliography in Manchester University Press monographs (author-date)?
...
Doe, J., and J. Doe (n.d.), ‘Title #2’, p. , https://example.com/ [accessed 1 May 2021]

Doe, J., J. Doe, and M. Python (n.d.), ‘Title #3’, <i>ABC</i>
