...
When you 're tasked by using "Elsevier (numeric, with titles)" (KRCP) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Elsevier (numeric, with titles)
* **Title:** Elsevier (numeric, with titles)
* **Type:** numeric
* **Short Title (Id):** KRCP)
* fields: , generic-base
...
## How do I cite in  Elsevier (numeric, with titles)?
...
## How do I create a bibliography in Elsevier (numeric, with titles)?
