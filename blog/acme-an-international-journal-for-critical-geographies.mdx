...
## Details  ACME: An International Journal for Critical Geographies
* **Title:** ACME: An International Journal for Critical Geographies
* **Type:** author-date
* **Short Title (Id):** AIP)
* fields: , humanities
...
!["ACME: An International Journal for Critical Geographies"](images/acme-an-international-journal-for-critical-geographies.svg "Choose ACME: An International Journal for Critical Geographies in the CiteDrive App")
