...
When you 're tasked by using "Council of Science Editors, Citation-Sequence (numeric)" (CSE C-S) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Council of Science Editors, Citation-Sequence (numeric)

* Title: Council of Science Editors, Citation-Sequence (numeric)
* Short Title (Id): CSE C-S)
* Authors: Council of Science Editors, Citation-Sequence (numeric)
* Download: Council of Science Editors, Citation-Sequence (numeric)
 --->

## How can CiteDrive help you with Council of Science Editors, Citation-Sequence (numeric)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Council of Science Editors, Citation-Sequence (numeric) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/council-of-science-editors-citationsequence-numeric.svg "Choose Council of Science Editors, Citation-Sequence (numeric) in the CiteDrive App")
...
## How do I cite in  Council of Science Editors, Citation-Sequence (numeric)?
...
## How do I create a bibliography in Council of Science Editors, Citation-Sequence (numeric)?
