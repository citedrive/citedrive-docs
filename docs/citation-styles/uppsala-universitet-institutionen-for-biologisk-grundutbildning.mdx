...
When you 're tasked by using "Uppsala universitet, Institutionen för biologisk grundutbildning" (IBG Uppsala) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Uppsala universitet, Institutionen för biologisk grundutbildning

* Title: Uppsala universitet, Institutionen för biologisk grundutbildning
* Short Title (Id): IBG Uppsala)
* Authors: Uppsala universitet, Institutionen för biologisk grundutbildning
* Download: Uppsala universitet, Institutionen för biologisk grundutbildning
 --->

## How can CiteDrive help you with Uppsala universitet, Institutionen för biologisk grundutbildning?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Uppsala universitet, Institutionen för biologisk grundutbildning for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/uppsala-universitet-institutionen-for-biologisk-grundutbildning.svg "Choose Uppsala universitet, Institutionen för biologisk grundutbildning in the CiteDrive App")
...
## How do I cite in  Uppsala universitet, Institutionen för biologisk grundutbildning?
...
## How do I create a bibliography in Uppsala universitet, Institutionen för biologisk grundutbildning?
...
!!! Doe J, Doe J. Title #2. online: https://example.com/. Accessed May 1, 2021.
