...
When you 're tasked by using "International Conference on Information Systems Development" (ISD Conference) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  International Conference on Information Systems Development

* Title: International Conference on Information Systems Development
* Short Title (Id): ISD Conference)
* Authors: International Conference on Information Systems Development
* Download: International Conference on Information Systems Development
 --->

## How can CiteDrive help you with International Conference on Information Systems Development?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in International Conference on Information Systems Development for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/international-conference-on-information-systems-development.svg "Choose International Conference on Information Systems Development in the CiteDrive App")
...
## How do I cite in  International Conference on Information Systems Development?
...
## How do I create a bibliography in International Conference on Information Systems Development?
...
!!! 2.Doe, J., Doe, J.: Title #2, https://example.com/, Accessed: May 01, 2021
