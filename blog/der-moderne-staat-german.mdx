---
title: der moderne staat (German)
author: Jospeh Moe
...
When you 're tasked by using "der moderne staat (German)" (dms) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  der moderne staat (German)
* **Title:** der moderne staat (German)
* **Type:** author-date
* **Short Title (Id):** dms)
...
## How do I cite in  der moderne staat (German)?
...
This sentence refers to the first item from the table. (<i><i>Doe</i></i> 2008) This, in turn, refers to the second (<i><i>Doe/Doe</i></i> o. J.)
and then to the third.  (<i><i>Doe/Doe/Python</i></i> o. J.)
This paragraph demonstrates the clustering of citations by citing the first and third item. (<i><i>Doe</i></i> 2008; <i><i>Doe/Doe/Python</i></i> o. J.)

:::

## How do I create a bibliography in der moderne staat (German)?
...
<i>Doe, Jane</i>, 2008: Title #1, in: Imaginary Journal, 3, S. 1–999.

<i>Doe, Jane/Doe, John </i> Title #2, https://example.com/, Stand: 1.5.2021.

<i>Doe, Jane/Doe, John/Python, Monty</i> Title #3, in: ABC.
