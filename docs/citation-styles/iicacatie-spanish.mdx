...
<!---
## About  IICA-CATIE (Spanish)

* Title: IICA-CATIE (Spanish)
* Short Title (Id): J Pharmacokinet Pharmacodyn)
* Authors: IICA-CATIE (Spanish)
* Download: IICA-CATIE (Spanish)
 --->
...
![citedrive_style](images/iicacatie-spanish.svg "Choose IICA-CATIE (Spanish) in the CiteDrive App")
