...
<!---
## About  Springer - MathPhys (author-date)

* Title: Springer - MathPhys (author-date)
* Short Title (Id): Cell. Mol. Life Sci.)
* Authors: Springer - MathPhys (author-date)
* Download: Springer - MathPhys (author-date)
 --->
...
![citedrive_style](images/springer--mathphys-authordate.svg "Choose Springer - MathPhys (author-date) in the CiteDrive App")
