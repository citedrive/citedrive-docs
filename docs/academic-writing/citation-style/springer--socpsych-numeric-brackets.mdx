...
<!---
## About  Springer - SocPsych (numeric, brackets)

* Title: Springer - SocPsych (numeric, brackets)
* Short Title (Id): BNE)
* Authors: Springer - SocPsych (numeric, brackets)
* Download: Springer - SocPsych (numeric, brackets)
 --->
...
![citedrive_style](images/springer--socpsych-numeric-brackets.svg "Choose Springer - SocPsych (numeric, brackets) in the CiteDrive App")
