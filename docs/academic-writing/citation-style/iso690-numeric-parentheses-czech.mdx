...
<!---
## About  ISO-690 (numeric, parentheses, Czech)

* Title: ISO-690 (numeric, parentheses, Czech)
* Short Title (Id): Public Choice)
* Authors: ISO-690 (numeric, parentheses, Czech)
* Download: ISO-690 (numeric, parentheses, Czech)
 --->
...
![citedrive_style](images/iso690-numeric-parentheses-czech.svg "Choose ISO-690 (numeric, parentheses, Czech) in the CiteDrive App")
