...
<!---
## About  Citation Compass (Kildekompasset) - APA (note)

* Title: Citation Compass (Kildekompasset) - APA (note)
* Short Title (Id): Rev Account Stud)
* Authors: Citation Compass (Kildekompasset) - APA (note)
* Download: Citation Compass (Kildekompasset) - APA (note)
 --->
...
![citedrive_style](images/citation-compass-kildekompasset--apa-note.svg "Choose Citation Compass (Kildekompasset) - APA (note) in the CiteDrive App")
