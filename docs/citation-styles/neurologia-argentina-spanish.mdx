...
# Neurología Argentina (Spanish)

When you 're tasked by using "Neurología Argentina (Spanish)" (NEUARG) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Neurología Argentina (Spanish)

* Title: Neurología Argentina (Spanish)
* Short Title (Id): NEUARG)
* Authors: Neurología Argentina (Spanish)
* Download: Neurología Argentina (Spanish)
 --->

## How can CiteDrive help you with Neurología Argentina (Spanish)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Neurología Argentina (Spanish) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/neurologia-argentina-spanish.svg "Choose Neurología Argentina (Spanish) in the CiteDrive App")
...
## How do I cite in  Neurología Argentina (Spanish)?
...
## How do I create a bibliography in Neurología Argentina (Spanish)?
