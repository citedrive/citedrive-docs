---
title: University for the Creative Arts - Harvard
author: Jospeh Moe
...
When you 're tasked by using "University for the Creative Arts - Harvard" (UCA) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  University for the Creative Arts - Harvard
* **Title:** University for the Creative Arts - Harvard
* **Type:** author-date
* **Short Title (Id):** UCA)
* fields: , generic-base
...
## How do I cite in  University for the Creative Arts - Harvard?
...
This sentence refers to the first item from the table. (Doe, 2008) This, in turn, refers to the second (Doe and Doe, s.d.)
...
## How do I create a bibliography in University for the Creative Arts - Harvard?
...
Doe, J. (2008) 'Title #1'   In: <i>Imaginary Journal</i>  3 pp.1–999.

Doe, J. and Doe, J. (s.d.) <i>Title #2</i>. At: https://example.com/ (Accessed  01/05/2021).

Doe, J. (s.d.) 'Title #3'   In: <i>ABC</i> 
