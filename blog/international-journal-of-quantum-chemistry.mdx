...
When you 're tasked by using "International Journal of Quantum Chemistry" (TACCESS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  International Journal of Quantum Chemistry
* **Title:** International Journal of Quantum Chemistry
* **Type:** numeric
* **Short Title (Id):** TACCESS)
* fields: , chemistry

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with International Journal of Quantum Chemistry? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in International Journal of Quantum Chemistry for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["International Journal of Quantum Chemistry"](images/international-journal-of-quantum-chemistry.svg "Choose International Journal of Quantum Chemistry in the CiteDrive App")
...
## How do I cite in  International Journal of Quantum Chemistry?
...
## How do I create a bibliography in International Journal of Quantum Chemistry?
...
1.J. Doe, <i>Imaginary Journal</i>, 2008, 3, 1–999.

2.J. Doe and J. Doe, .

3.J. Doe, J. Doe and M. Python, <i>ABC</i>.
