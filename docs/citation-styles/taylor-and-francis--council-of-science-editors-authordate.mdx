...
When you 're tasked by using "Taylor & Francis - Council of Science Editors (author-date)" (TF-CSE) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Taylor & Francis - Council of Science Editors (author-date)

* Title: Taylor & Francis - Council of Science Editors (author-date)
* Short Title (Id): TF-CSE)
* Authors: Taylor & Francis - Council of Science Editors (author-date)
* Download: Taylor & Francis - Council of Science Editors (author-date)
 --->

## How can CiteDrive help you with Taylor & Francis - Council of Science Editors (author-date)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Taylor & Francis - Council of Science Editors (author-date) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/taylor-and-francis--council-of-science-editors-authordate.svg "Choose Taylor & Francis - Council of Science Editors (author-date) in the CiteDrive App")
...
## How do I cite in  Taylor & Francis - Council of Science Editors (author-date)?
...
## How do I create a bibliography in Taylor & Francis - Council of Science Editors (author-date)?
...
!!! Doe J, Doe J.. Title #2  [Internet].  [Internet]. [accessed 2021 May 1].. https://example.com/
