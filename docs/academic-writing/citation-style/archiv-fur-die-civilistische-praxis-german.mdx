...
# Archiv für die civilistische Praxis (German)

When you 're tasked by using "Archiv für die civilistische Praxis (German)" (AcP) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Archiv für die civilistische Praxis (German)

* Title: Archiv für die civilistische Praxis (German)
* Short Title (Id): AcP)
* Authors: Archiv für die civilistische Praxis (German)
* Download: Archiv für die civilistische Praxis (German)
 --->

## How can CiteDrive help you with Archiv für die civilistische Praxis (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Archiv für die civilistische Praxis (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/archiv-fur-die-civilistische-praxis-german.svg "Choose Archiv für die civilistische Praxis (German) in the CiteDrive App")
...
## How do I cite in  Archiv für die civilistische Praxis (German)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. <i>Doe</i> Imaginary Journal3 (2008), 1 ff. This, in turn, refers to the second <i>Doe/Doe</i>Title #2o. J.
! and then to the third.  <i>Doe/Doe/Python</i> ABCo. J.
! This paragraph demonstrates the clustering of citations by citing the first and third item. <i>Doe</i>; <i>Doe/Doe/Python</i>



## How do I create a bibliography in Archiv für die civilistische Praxis (German)?
...
!!! **Bibliography**
!!! <i>Doe</i>, Imaginary Journal3 (2008)1 ff.
!!! <i>Doe/Doe</i>, Title #2o. J.
!!! <i>Doe/Doe/Python</i>, ABCo. J.
