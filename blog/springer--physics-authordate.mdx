...
tags: [author-date, physics, generic-base]
---

When you 're tasked by using "Springer - Physics (author-date)" (HEDU) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Springer - Physics (author-date)
* **Title:** Springer - Physics (author-date)
* **Type:** author-date
* **Short Title (Id):** HEDU)
...
## How do I cite in  Springer - Physics (author-date)?
...
## How do I create a bibliography in Springer - Physics (author-date)?
...
:::note Bibliography
 ...
 J. Doe, Imaginary Journal <b>3</b>, 1 (2008).

 J. Doe and J. Doe, (n.d.).

 J. Doe, J. Doe, and M. Python, ABC (n.d.).
