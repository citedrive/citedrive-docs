...
# Hamburg School of Food Science (diploma, German)

When you 're tasked by using "Hamburg School of Food Science (diploma, German)" (Diplom-LC-UHH) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Hamburg School of Food Science (diploma, German)

* Title: Hamburg School of Food Science (diploma, German)
* Short Title (Id): Diplom-LC-UHH)
* Authors: Hamburg School of Food Science (diploma, German)
* Download: Hamburg School of Food Science (diploma, German)
 --->

## How can CiteDrive help you with Hamburg School of Food Science (diploma, German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Hamburg School of Food Science (diploma, German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/hamburg-school-of-food-science-diploma-german.svg "Choose Hamburg School of Food Science (diploma, German) in the CiteDrive App")
...
## How do I cite in  Hamburg School of Food Science (diploma, German)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. (<b>DOE</b>, 2008) This, in turn, refers to the second (<b>DOE und DOE</b>, 2021)
! and then to the third.  (<b>DOE et al.</b>, o. J.)
! This paragraph demonstrates the clustering of citations by citing the first and third item. (<b>DOE</b>, 2008, <b>DOE et al.</b>, o. J.)



## How do I create a bibliography in Hamburg School of Food Science (diploma, German)?
