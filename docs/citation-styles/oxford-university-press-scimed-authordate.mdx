...
<!---
## About  Oxford University Press SciMed (author-date)

* Title: Oxford University Press SciMed (author-date)
* Short Title (Id): Hum Nat)
* Authors: Oxford University Press SciMed (author-date)
* Download: Oxford University Press SciMed (author-date)
 --->
...
![citedrive_style](images/oxford-university-press-scimed-authordate.svg "Choose Oxford University Press SciMed (author-date) in the CiteDrive App")
