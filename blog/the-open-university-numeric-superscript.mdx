---
title: The Open University (numeric, superscript)
author: Jospeh Moe
...
When you 're tasked by using "The Open University (numeric, superscript)" (Ann Nucl Med) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  The Open University (numeric, superscript)
* **Title:** The Open University (numeric, superscript)
* **Type:** numeric
...
## How do I cite in  The Open University (numeric, superscript)?
...
## How do I create a bibliography in The Open University (numeric, superscript)?
...
1 Doe, Jane (2008)  ‘Title #1’. <i>Imaginary Journal</i>, 3, pp. 1–999.

2 Doe, Jane and Doe, John  (n.d.)  ‘Title #2’. , p. . [online] Available from: https://example.com/ (Accessed 1 May 2021)

3 Doe, Jane, Doe, John and Python, Monty (n.d.)  ‘Title #3’. <i>ABC</i>, p. .
