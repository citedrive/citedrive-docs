...
When you 're tasked by using "ISO-690 (numeric, English)" (TUD BWL/Logistik (author-date)) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  ISO-690 (numeric, English)
* **Title:** ISO-690 (numeric, English)
* **Type:** numeric
...
## How do I cite in  ISO-690 (numeric, English)?
...
## How do I create a bibliography in ISO-690 (numeric, English)?
...
1. DOE, Jane. Title #1. <i>Imaginary Journal</i>. 2008. Vol. 3, p. 1–999. 

2. DOE, Jane and DOE, John . Title #2.  [online].  [Accessed 1 May 2021]. Available from: https://example.com/

3. DOE, Jane, DOE, John and PYTHON, Monty. Title #3. <i>ABC</i>. 
