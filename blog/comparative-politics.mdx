...
tags: [note, political_science, social_science]
---

When you 're tasked by using "Comparative Politics" (J Genet Counsel) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Comparative Politics?
...
This sentence refers to the first item from the table. Jane Doe, “Title #1”,, <i>Imaginary Journal</i>, 3 (2008), 1–999. This, in turn, refers to the second Jane Doe and John  Doe, Title #2, n.d... Available at: https://example.com/. [Accessed: 01-May-2021].
and then to the third.  Jane Doe, John Doe and Monty Python, “Title #3”,, <i>ABC</i>, (n.d.).
This paragraph demonstrates the clustering of citations by citing the first and third item. Jane Doe, “Title #1”,, <i>Imaginary Journal</i>, 3 (2008), 1–999; Jane Doe, John Doe and Monty Python, “Title #3”,, <i>ABC</i>, (n.d.).

:::

## How do I create a bibliography in Comparative Politics?
