...
When you 're tasked by using "I.B. Tauris (note)" (bursauludaguniversitesifenbilimlerienstitusu) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  I.B. Tauris (note)?
...
This sentence refers to the first item from the table. Jane Doe, ‘Title #1’, <i>Imaginary Journal</i>, iii (2008), pp. 1–999. This, in turn, refers to the second Jane Doe and John  Doe, ‘Title #2’, Available at https://example.com/ (accessed 1 May 2021).
and then to the third.  Jane Doe, John Doeand Monty Python, ‘Title #3’, <i>ABC</i>.
This paragraph demonstrates the clustering of citations by citing the first and third item. Jane Doe, ‘Title #1’; Jane Doe, John Doeand Monty Python, ‘Title #3’.

:::

## How do I create a bibliography in I.B. Tauris (note)?
...
Doe, Jane, ‘Title #1’, <i>Imaginary Journal</i>, iii (2008), pp. 1–999.

Doe, Jane and John  Doe, ‘Title #2’, Available at https://example.com/ (accessed 1 May 2021).

Doe, Jane, John Doeand Monty Python, ‘Title #3’, <i>ABC</i>.
