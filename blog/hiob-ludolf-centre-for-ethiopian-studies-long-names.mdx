---
title: Hiob Ludolf Centre for Ethiopian Studies (long names)
author: Jospeh Moe
...
When you 're tasked by using "Hiob Ludolf Centre for Ethiopian Studies (long names)" (HLCES (Hamburg) long names) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Hiob Ludolf Centre for Ethiopian Studies (long names)
* **Title:** Hiob Ludolf Centre for Ethiopian Studies (long names)
* **Type:** author-date
* **Short Title (Id):** HLCES (Hamburg) long names)
* fields: , humanities

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Hiob Ludolf Centre for Ethiopian Studies (long names)? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Hiob Ludolf Centre for Ethiopian Studies (long names) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Hiob Ludolf Centre for Ethiopian Studies (long names)"](images/hiob-ludolf-centre-for-ethiopian-studies-long-names.svg "Choose Hiob Ludolf Centre for Ethiopian Studies (long names) in the CiteDrive App")
...
## How do I cite in  Hiob Ludolf Centre for Ethiopian Studies (long names)?
...
## How do I create a bibliography in Hiob Ludolf Centre for Ethiopian Studies (long names)?
...
Doe, Jane 2008. “Title #1”, <i>Imaginary Journal</i>,, 3 (2008), 1–999.

Doe, Jane and John  Doe <i>Title #2</i> {"<"}https://example.com/{">"}, accessed 1 May 2021.

Doe, Jane, John Doeand Monty Python n.d.. “Title #3”, <i>ABC</i>,.
