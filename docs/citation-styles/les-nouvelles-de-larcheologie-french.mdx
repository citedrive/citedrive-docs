...
# Les nouvelles de l'archéologie (French)

When you 're tasked by using "Les nouvelles de l'archéologie (French)" (NDA) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Les nouvelles de l'archéologie (French)

* Title: Les nouvelles de l'archéologie (French)
* Short Title (Id): NDA)
* Authors: Les nouvelles de l'archéologie (French)
* Download: Les nouvelles de l'archéologie (French)
 --->

## How can CiteDrive help you with Les nouvelles de l'archéologie (French)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Les nouvelles de l'archéologie (French) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/les-nouvelles-de-larcheologie-french.svg "Choose Les nouvelles de l'archéologie (French) in the CiteDrive App")
...
## How do I cite in  Les nouvelles de l'archéologie (French)?
...
! This paragraph demonstrates the clustering of citations by citing the first and third item. Doe et al. s. d. ; Doe 2008



## How do I create a bibliography in Les nouvelles de l'archéologie (French)?
...
!!! **Bibliography**
!!! <span style="font-variant:small-caps;">Doe J.</span>. 2008. « Title #1 », <i>Imaginary Journal</i>, 3 : 1‑999.
!!! <span style="font-variant:small-caps;">Doe J. &amp; Doe J.</span>. s. d.. « Title #2 ». https://example.com/.
