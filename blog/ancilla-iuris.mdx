...
When you 're tasked by using "Ancilla Iuris" (Anci) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Ancilla Iuris?
...
This sentence refers to the first item from the table. <i>Jane Doe</i>Title #1Imaginary Journal 3 (2008)1–999. This, in turn, refers to the second <i>Jane Doe/John  Doe</i>, Title #2, https://example.com/, last access: May 1, 2021..
and then to the third.  <i>Jane Doe/John Doe/Monty Python</i>Title #3ABC .
This paragraph demonstrates the clustering of citations by citing the first and third item. <i>Jane Doe</i>Title #1Imaginary Journal 3 (2008)1–999; <i>Jane Doe/John Doe/Monty Python</i>Title #3ABC .

:::

## How do I create a bibliography in Ancilla Iuris?
