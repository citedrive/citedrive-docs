...
When you 're tasked by using "Obesity" (Calc. Var.) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I create a bibliography in Obesity?
...
2. Doe J, Doe J. (2021). Title #2. [WWW document]. URL https://example.com/
