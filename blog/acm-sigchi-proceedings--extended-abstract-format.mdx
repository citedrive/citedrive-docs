---
title: ACM SIGCHI Proceedings - Extended Abstract Format
author: Jospeh Moe
...
When you 're tasked by using "ACM SIGCHI Proceedings - Extended Abstract Format" (CHI Extended Abstract Format) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  ACM SIGCHI Proceedings - Extended Abstract Format
* **Title:** ACM SIGCHI Proceedings - Extended Abstract Format
* **Type:** numeric
* **Short Title (Id):** CHI Extended Abstract Format)
* fields: , engineering

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with ACM SIGCHI Proceedings - Extended Abstract Format? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in ACM SIGCHI Proceedings - Extended Abstract Format for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["ACM SIGCHI Proceedings - Extended Abstract Format"](images/acm-sigchi-proceedings--extended-abstract-format.svg "Choose ACM SIGCHI Proceedings - Extended Abstract Format in the CiteDrive App")
...
## How do I cite in  ACM SIGCHI Proceedings - Extended Abstract Format?
...
## How do I create a bibliography in ACM SIGCHI Proceedings - Extended Abstract Format?
...
1.Jane Doe.. 2008. Title #1. <i>Imaginary Journal</i> 3: 1–999..

2.Jane Doe and John  Doe.. Title #2.  Retrieved May 1, 2021 from https://example.com/.

3.Jane Doe, John Doe, and Monty Python.. Title #3. <i>ABC</i>..
