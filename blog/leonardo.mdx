...
When you 're tasked by using "Leonardo" (J Consum Policy) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
This sentence refers to the first item from the table. Jane Doe, “Title #1”,, <i>Imaginary Journal</i> <b>3</b>,, 1–999 (2008). This, in turn, refers to the second Jane Doe and John  Doe, “Title #2”,, https://example.com/.
and then to the third.  Jane Doe, John Doeand Monty Python, “Title #3”,, <i>ABC</i>.
This paragraph demonstrates the clustering of citations by citing the first and third item. Doe; Doe, Doeand Python.

:::

## How do I create a bibliography in Leonardo?
