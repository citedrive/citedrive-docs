---
title: La Revue des Sciences de Gestion (French)
author: Jospeh Moe
...
When you 're tasked by using "La Revue des Sciences de Gestion (French)" (RSG) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  La Revue des Sciences de Gestion (French)
* **Title:** La Revue des Sciences de Gestion (French)
* **Type:** author-date
* **Short Title (Id):** RSG)
...
## How do I cite in  La Revue des Sciences de Gestion (French)?
...
This sentence refers to the first item from the table. (J. Doe, 2008) This, in turn, refers to the second (J. Doe et J. Doe, s. d.)
and then to the third.  (J. Doe, J. Doe et M. Python, s. d.)
This paragraph demonstrates the clustering of citations by citing the first and third item. (J. Doe, 2008 ; J. Doe, J. Doe et M. Python, s. d.)

:::

## How do I create a bibliography in La Revue des Sciences de Gestion (French)?
...
Doe J.  (2008). « Title #1 », <i>Imaginary Journal</i>, <i>3</i>, traduit par , p.. 1‑999.

Doe J., Doe J.  (s. d.). « Title #2 », traduit par .

Doe J., Doe J., Python M.  (s. d.). « Title #3 », <i>ABC</i>, traduit par .
