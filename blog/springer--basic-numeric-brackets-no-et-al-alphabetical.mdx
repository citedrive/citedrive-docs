...
## Details  Springer - Basic (numeric, brackets, no "et al.", alphabetical)
* **Title:** Springer - Basic (numeric, brackets, no "et al.", alphabetical)
* **Type:** numeric
...
!["Springer - Basic (numeric, brackets, no "et al.", alphabetical)"](images/springer--basic-numeric-brackets-no-et-al-alphabetical.svg "Choose Springer - Basic (numeric, brackets, no "et al.", alphabetical) in the CiteDrive App")
