...
When you 're tasked by using "User Modeling and User-Adapted Interaction" (UMUAI) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  User Modeling and User-Adapted Interaction
* **Title:** User Modeling and User-Adapted Interaction
* **Type:** author-date
* **Short Title (Id):** UMUAI)
* fields: , science

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with User Modeling and User-Adapted Interaction? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in User Modeling and User-Adapted Interaction for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["User Modeling and User-Adapted Interaction"](images/user-modeling-and-useradapted-interaction.svg "Choose User Modeling and User-Adapted Interaction in the CiteDrive App")
...
## How do I cite in  User Modeling and User-Adapted Interaction?
...
## How do I create a bibliography in User Modeling and User-Adapted Interaction?
...
Doe, Jane.: 2008. 'Title #1.' <i>Imaginary Journal</i> 3, pp. 1–999.

Doe, Jane, and John  Doe. 'Title #2.' Available at: https://example.com/ [Accessed May 1, 2021].
