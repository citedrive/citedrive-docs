...
When you 're tasked by using "German Yearbook of International Law" (GYIL) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  German Yearbook of International Law

* Title: German Yearbook of International Law
* Short Title (Id): GYIL)
* Authors: German Yearbook of International Law
* Download: German Yearbook of International Law
 --->

## How can CiteDrive help you with German Yearbook of International Law?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in German Yearbook of International Law for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/german-yearbook-of-international-law.svg "Choose German Yearbook of International Law in the CiteDrive App")
...
## How do I cite in  German Yearbook of International Law?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. J. Doe,  'Title #1',  3 <i>Imaginary Journal</i> (2008) 1. This, in turn, refers to the second J. Doe and J. Doe, <i>Title #2</i>, available at https://example.com/.
...
## How do I create a bibliography in German Yearbook of International Law?
