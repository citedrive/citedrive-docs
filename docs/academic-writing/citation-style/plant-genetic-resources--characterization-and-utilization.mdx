...
When you 're tasked by using "Plant Genetic Resources - Characterization and Utilization" (Surv Geophys) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Plant Genetic Resources - Characterization and Utilization

* Title: Plant Genetic Resources - Characterization and Utilization
* Short Title (Id): Surv Geophys)
* Authors: Plant Genetic Resources - Characterization and Utilization
* Download: Plant Genetic Resources - Characterization and Utilization
 --->

## How can CiteDrive help you with Plant Genetic Resources - Characterization and Utilization?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Plant Genetic Resources - Characterization and Utilization for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/plant-genetic-resources--characterization-and-utilization.svg "Choose Plant Genetic Resources - Characterization and Utilization in the CiteDrive App")
...
## How do I cite in  Plant Genetic Resources - Characterization and Utilization?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. (Doe, 2008) This, in turn, refers to the second (Title #2, 2021)
...
## How do I create a bibliography in Plant Genetic Resources - Characterization and Utilization?
...
!!! Title #2 (2021) See https://example.com/ (accessed 1 May 2021).
