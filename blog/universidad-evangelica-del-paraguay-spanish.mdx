---
title: Universidad Evangélica del Paraguay (Spanish)
author: Jospeh Moe
...
When you 're tasked by using "Universidad Evangélica del Paraguay (Spanish)" (UiO-rettsvitenskap) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Universidad Evangélica del Paraguay (Spanish)
* **Title:** Universidad Evangélica del Paraguay (Spanish)
* **Type:** author-date
...
## How do I cite in  Universidad Evangélica del Paraguay (Spanish)?
...
This sentence refers to the first item from the table. (Doe, 2008) This, in turn, refers to the second (Doe y Doe [En línea], 2021)
...
## How do I create a bibliography in Universidad Evangélica del Paraguay (Spanish)?
...
DOE, J. (2008) "Title #1". En <i>Imaginary Journal</i>. Año 3, , Págs. 1-999. s.e..

DOE, J. y J. DOE  [En línea]  <i>Title #2</i>. {"<"}https://example.com/{">"} (mayo de 2021). 

DOE, J.; J. DOE y M. PYTHON (s.f.) "Title #3". En <i>ABC</i>. s.d. , s.d.. s.e..
