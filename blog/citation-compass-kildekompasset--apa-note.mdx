---
title: Citation Compass (Kildekompasset) - APA (note)
author: Jospeh Moe
...
When you 're tasked by using "Citation Compass (Kildekompasset) - APA (note)" (Rev Account Stud) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Citation Compass (Kildekompasset) - APA (note)
* **Title:** Citation Compass (Kildekompasset) - APA (note)
* **Type:** note
* **Short Title (Id):** Rev Account Stud)
* fields: , generic-base

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Citation Compass (Kildekompasset) - APA (note)? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Citation Compass (Kildekompasset) - APA (note) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Citation Compass (Kildekompasset) - APA (note)"](images/citation-compass-kildekompasset--apa-note.svg "Choose Citation Compass (Kildekompasset) - APA (note) in the CiteDrive App")
...
## How do I cite in  Citation Compass (Kildekompasset) - APA (note)?
...
## How do I create a bibliography in Citation Compass (Kildekompasset) - APA (note)?
