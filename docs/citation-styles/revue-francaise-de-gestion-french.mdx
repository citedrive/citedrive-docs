...
# Revue française de gestion (French)
...
<!---
## About  Revue française de gestion (French)

* Title: Revue française de gestion (French)
* Short Title (Id): RFG)
* Authors: Revue française de gestion (French)
* Download: Revue française de gestion (French)
 --->
...
![citedrive_style](images/revue-francaise-de-gestion-french.svg "Choose Revue française de gestion (French) in the CiteDrive App")
