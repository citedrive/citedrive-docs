...
When you 're tasked by using "Politix (French)" (J Elast) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Politix (French)?
...
This sentence refers to the first item from the table. Doe (J.), « Title #1 », <i>Imaginary Journal</i>, 3, 2008. This, in turn, refers to the second Doe (J.), Doe (J.), <i>Title #2</i>, <u>https://example.com/</u>,  consulté le 1 mai 2021.
and then to the third.  Doe (J.), Doe (J.), Python (M.), « Title #3 », <i>ABC</i>.
This paragraph demonstrates the clustering of citations by citing the first and third item. Doe (J.), « Title #1 », <i>art. cit.</i> ; Doe (J.), Doe (J.), Python (M.), « Title #3 », <i>art. cit.</i>.

:::

## How do I create a bibliography in Politix (French)?
