...
# Zeitschrift für Internationale Beziehungen (German)

When you 're tasked by using "Zeitschrift für Internationale Beziehungen (German)" (ZIB) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Zeitschrift für Internationale Beziehungen (German)

* Title: Zeitschrift für Internationale Beziehungen (German)
* Short Title (Id): ZIB)
* Authors: Zeitschrift für Internationale Beziehungen (German)
* Download: Zeitschrift für Internationale Beziehungen (German)
 --->

## How can CiteDrive help you with Zeitschrift für Internationale Beziehungen (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Zeitschrift für Internationale Beziehungen (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/zeitschrift-fur-internationale-beziehungen-german.svg "Choose Zeitschrift für Internationale Beziehungen (German) in the CiteDrive App")
...
## How do I cite in  Zeitschrift für Internationale Beziehungen (German)?
...
## How do I create a bibliography in Zeitschrift für Internationale Beziehungen (German)?
...
!!! **Bibliography**
!!! <i>Doe, J.</i> 2008: Title #1, in: Imaginary Journal 3: 1-999.
!!! <i>Doe, J./Doe, J.</i> o. J.: Title #2, in: https://example.com/; 1.5.2021.
!!! <i>Doe, J./Doe, J./Python, M.</i> o. J.: Title #3, in: ABC.
