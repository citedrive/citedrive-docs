...
<!---
## About  Métropolitiques (French)

* Title: Métropolitiques (French)
* Short Title (Id): Journal of AAPOS)
* Authors: Métropolitiques (French)
* Download: Métropolitiques (French)
 --->
...
![citedrive_style](images/metropolitiques-french.svg "Choose Métropolitiques (French) in the CiteDrive App")
