...
tags: [numeric, history]
---

When you 're tasked by using "Revue des Études Byzantines" (FBR) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Revue des Études Byzantines
* **Title:** Revue des Études Byzantines
* **Type:** numeric
* **Short Title (Id):** FBR)
* fields: , history
...
## How do I cite in  Revue des Études Byzantines?
...
## How do I create a bibliography in Revue des Études Byzantines?
...
<span style={{"font-variant":"small-caps"}}>J.</span> <span style={{"font-variant":"small-caps"}}>Doe</span>, Title #1, <i>Imaginary Journal</i> 3, 2008, pp.. 1–999.

<span style={{"font-variant":"small-caps"}}>J.</span> <span style={{"font-variant":"small-caps"}}>Doe</span> and <span style={{"font-variant":"small-caps"}}>J.</span> <span style={{"font-variant":"small-caps"}}>Doe</span>, Title #2. [Online]. Available at: https://example.com/. [Accessed: 01-May-2021].

<span style={{"font-variant":"small-caps"}}>J.</span> <span style={{"font-variant":"small-caps"}}>Doe</span>, <span style={{"font-variant":"small-caps"}}>J.</span> <span style={{"font-variant":"small-caps"}}>Doe</span> and <span style={{"font-variant":"small-caps"}}>M.</span> <span style={{"font-variant":"small-caps"}}>Python</span>, Title #3, <i>ABC</i> .
