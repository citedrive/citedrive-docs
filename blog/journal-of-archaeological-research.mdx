---
title: Journal of Archaeological Research
author: Jospeh Moe
...
When you 're tasked by using "Journal of Archaeological Research" (BPJ) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Journal of Archaeological Research
* **Title:** Journal of Archaeological Research
* **Type:** author-date
* **Short Title (Id):** BPJ)
* fields: , anthropology
...
## How do I cite in  Journal of Archaeological Research?
...
This sentence refers to the first item from the table. (Doe 2008) This, in turn, refers to the second (Doe and Doe forthcoming)
and then to the third.  (Doe et al. forthcoming)
This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe 2008; Doe et al. forthcoming)

:::

## How do I create a bibliography in Journal of Archaeological Research?
...
Doe, J. and Doe, J. (forthcoming). Title #2  (consulted May 2021: https://example.com/).

Doe, J., Doe, J. and Python, M. (forthcoming). Title #3. <i>ABC</i>..
