...
<!---
## About  Generic Style Rules for Linguistics

* Title: Generic Style Rules for Linguistics
* Short Title (Id): CNS Drugs)
* Authors: Generic Style Rules for Linguistics
* Download: Generic Style Rules for Linguistics
 --->
...
![citedrive_style](images/generic-style-rules-for-linguistics.svg "Choose Generic Style Rules for Linguistics in the CiteDrive App")
