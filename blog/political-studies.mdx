...
When you 're tasked by using "Political Studies" (Environ Resource Econ) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Political Studies?
...
This sentence refers to the first item from the table. (Doe, 2008) This, in turn, refers to the second (Doe and Doe, nd)
and then to the third.  (Doe, Doe, and Python, nd)
This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe, 2008; Doe, Doe, and Python, nd)

:::

## How do I create a bibliography in Political Studies?
...
Doe, J. and Doe, J. (n.d.). Title #2 [online]. .. Available from: https://example.com/ [Accessed1 May 2021 ]
