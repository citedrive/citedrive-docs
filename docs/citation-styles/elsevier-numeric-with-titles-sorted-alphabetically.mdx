...
<!---
## About  Elsevier (numeric, with titles, sorted alphabetically)

* Title: Elsevier (numeric, with titles, sorted alphabetically)
* Short Title (Id): AA)
* Authors: Elsevier (numeric, with titles, sorted alphabetically)
* Download: Elsevier (numeric, with titles, sorted alphabetically)
 --->
...
![citedrive_style](images/elsevier-numeric-with-titles-sorted-alphabetically.svg "Choose Elsevier (numeric, with titles, sorted alphabetically) in the CiteDrive App")
