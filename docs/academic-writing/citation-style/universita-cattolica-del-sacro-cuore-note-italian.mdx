...
When you 're tasked by using "Università Cattolica del Sacro Cuore (note, Italian)" (BNE) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Università Cattolica del Sacro Cuore (note, Italian)

* Title: Università Cattolica del Sacro Cuore (note, Italian)
* Short Title (Id): BNE)
* Authors: Università Cattolica del Sacro Cuore (note, Italian)
* Download: Università Cattolica del Sacro Cuore (note, Italian)
 --->

## How can CiteDrive help you with Università Cattolica del Sacro Cuore (note, Italian)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Università Cattolica del Sacro Cuore (note, Italian) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/universita-cattolica-del-sacro-cuore-note-italian.svg "Choose Università Cattolica del Sacro Cuore (note, Italian) in the CiteDrive App")
...
## How do I cite in  Università Cattolica del Sacro Cuore (note, Italian)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Doe, <i>Title #1</i>. This, in turn, refers to the second Doe e Doe, <i>Title #2</i>.
! and then to the third.  Doe, Doe, e Python, <i>Title #3</i>.
! This paragraph demonstrates the clustering of citations by citing the first and third item. Doe, <i>Title #1</i>; Doe, Doe, e Python, <i>Title #3</i>.



## How do I create a bibliography in Università Cattolica del Sacro Cuore (note, Italian)?
...
!!! **Bibliography**
!!! Doe, Jane. <i>Title #1</i>. «Imaginary journal» (2008) 3: 1–999, 3:pp. .
!!! Doe, Jane e John  Doe. <i>Title #2</i>, s.d. (recuperato da  <https://example.com/>).
!!! Doe, Jane, John Doe e Monty Python. <i>Title #3</i>. «ABC» (s.d.).
