...
When you 're tasked by using "Leiden Journal of International Law" (LJIL) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Leiden Journal of International Law?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. J. Doe, 'Title #1', (2008) 3 Imaginary Journal 1–999 This, in turn, refers to the second Not supported
! and then to the third.  J. Doe et al, 'Title #3', ABC 
! This paragraph demonstrates the clustering of citations by citing the first and third item. Doe (2008); Doe et al



## How do I create a bibliography in Leiden Journal of International Law?
...
!!! **Bibliography**
!!! J. Doe, 'Title #1', (2008) 3 Imaginary Journal, 1–999.
!!! Else
!!! J. Doe et al, 'Title #3', ABC, 
