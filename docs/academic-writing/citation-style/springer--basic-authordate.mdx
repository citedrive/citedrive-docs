...
<!---
## About  Springer - Basic (author-date)

* Title: Springer - Basic (author-date)
* Short Title (Id): JBCS)
* Authors: Springer - Basic (author-date)
* Download: Springer - Basic (author-date)
 --->
...
![citedrive_style](images/springer--basic-authordate.svg "Choose Springer - Basic (author-date) in the CiteDrive App")
