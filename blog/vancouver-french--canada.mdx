...
When you 're tasked by using "Vancouver (French - Canada)" (WA) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Vancouver (French - Canada)
* **Title:** Vancouver (French - Canada)
* **Type:** numeric
* **Short Title (Id):** WA)
* fields: , medicine
...
## How do I cite in  Vancouver (French - Canada)?
...
## How do I create a bibliography in Vancouver (French - Canada)?
...
2.  [En ligne]. Doe J, Doe J. Title #2; [cité le 1mai2021]. Disponible: https://example.com/
