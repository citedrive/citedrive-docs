...
# Cardiff University BIOSI and CARBS - Harvard

When you 're tasked by using "Cardiff University BIOSI and CARBS - Harvard" (Orthopäde) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Cardiff University BIOSI and CARBS - Harvard

* Title: Cardiff University BIOSI and CARBS - Harvard
* Short Title (Id): Orthopäde)
* Authors: Cardiff University BIOSI and CARBS - Harvard
* Download: Cardiff University BIOSI and CARBS - Harvard
 --->

## How can CiteDrive help you with Cardiff University BIOSI and CARBS - Harvard?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Cardiff University BIOSI and CARBS - Harvard for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/cardiff-university-biosi-and-carbs--harvard.svg "Choose Cardiff University BIOSI and CARBS - Harvard in the CiteDrive App")
...
## How do I cite in  Cardiff University BIOSI and CARBS - Harvard?
...
!!! Doe, J. and Doe, J. [no date]. Title #2... Available at: https://example.com/ [Accessed: 1 May 2021].
