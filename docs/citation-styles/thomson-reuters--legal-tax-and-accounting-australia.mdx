...
When you 're tasked by using "Thomson Reuters - Legal, Tax & Accounting Australia" (EJMO) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Thomson Reuters - Legal, Tax & Accounting Australia

* Title: Thomson Reuters - Legal, Tax & Accounting Australia
* Short Title (Id): EJMO)
* Authors: Thomson Reuters - Legal, Tax & Accounting Australia
* Download: Thomson Reuters - Legal, Tax & Accounting Australia
 --->

## How can CiteDrive help you with Thomson Reuters - Legal, Tax & Accounting Australia?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Thomson Reuters - Legal, Tax & Accounting Australia for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/thomson-reuters--legal-tax-and-accounting-australia.svg "Choose Thomson Reuters - Legal, Tax & Accounting Australia in the CiteDrive App")
...
## How do I cite in  Thomson Reuters - Legal, Tax & Accounting Australia?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Doe J, “Title #1” (2008) 3 Imaginary Journal 1. This, in turn, refers to the second Doe J and Doe J, <i>Title #2</i>, https://example.com/ viewed 1 May 2021.
! and then to the third.  Doe J, Doe J and Python M, “Title #3” ABC.
...
## How do I create a bibliography in Thomson Reuters - Legal, Tax & Accounting Australia?
