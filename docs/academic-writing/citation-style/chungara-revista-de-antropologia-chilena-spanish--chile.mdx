...
# Chungara Revista de Antropología Chilena (Spanish - Chile)

When you 're tasked by using "Chungara Revista de Antropología Chilena (Spanish - Chile)" (Chungara) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Chungara Revista de Antropología Chilena (Spanish - Chile)

* Title: Chungara Revista de Antropología Chilena (Spanish - Chile)
* Short Title (Id): Chungara)
* Authors: Chungara Revista de Antropología Chilena (Spanish - Chile)
* Download: Chungara Revista de Antropología Chilena (Spanish - Chile)
 --->

## How can CiteDrive help you with Chungara Revista de Antropología Chilena (Spanish - Chile)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Chungara Revista de Antropología Chilena (Spanish - Chile) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/chungara-revista-de-antropologia-chilena-spanish--chile.svg "Choose Chungara Revista de Antropología Chilena (Spanish - Chile) in the CiteDrive App")
...
## How do I cite in  Chungara Revista de Antropología Chilena (Spanish - Chile)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. (Doe 2008) This, in turn, refers to the second (Doe y Doe)
...
## How do I create a bibliography in Chungara Revista de Antropología Chilena (Spanish - Chile)?
...
!!! Doe, J. y J. DoeTitle #2.. https://example.com/, accedido 1 de mayo de 2021..
!!! Doe, J., J. Doe y M. PythonTitle #3.. <i>ABC</i>..
