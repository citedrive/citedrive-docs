...
When you 're tasked by using "Feminist Economics" (ALTEX) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Feminist Economics?
...
This sentence refers to the first item from the table. (Jane Doe 2008) This, in turn, refers to the second (Jane Doe and John  Doe 2021)
and then to the third.  (Jane Doe, John Doeand Monty Python)
This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe 2008; Doe, Doe, and Python)

:::

## How do I create a bibliography in Feminist Economics?
