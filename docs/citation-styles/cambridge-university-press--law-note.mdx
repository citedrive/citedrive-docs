...
When you 're tasked by using "Cambridge University Press - Law (note)" (CUP) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Cambridge University Press - Law (note)

* Title: Cambridge University Press - Law (note)
* Short Title (Id): CUP)
* Authors: Cambridge University Press - Law (note)
* Download: Cambridge University Press - Law (note)
 --->

## How can CiteDrive help you with Cambridge University Press - Law (note)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Cambridge University Press - Law (note) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/cambridge-university-press--law-note.svg "Choose Cambridge University Press - Law (note) in the CiteDrive App")
...
## How do I cite in  Cambridge University Press - Law (note)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. J. Doe, ‘Title #1’  (2008) 3 <i>Imaginary Journal</i> 1–999. This, in turn, refers to the second J. Doe and J. Doe, ‘Title #2’.
...
## How do I create a bibliography in Cambridge University Press - Law (note)?
