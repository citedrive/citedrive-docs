...
When you 're tasked by using "Chicago Manual of Style 16th edition (author-date, Basque)" (Popul Ecol) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Chicago Manual of Style 16th edition (author-date, Basque)

* Title: Chicago Manual of Style 16th edition (author-date, Basque)
* Short Title (Id): Popul Ecol)
* Authors: Chicago Manual of Style 16th edition (author-date, Basque)
* Download: Chicago Manual of Style 16th edition (author-date, Basque)
 --->

## How can CiteDrive help you with Chicago Manual of Style 16th edition (author-date, Basque)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Chicago Manual of Style 16th edition (author-date, Basque) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/chicago-manual-of-style-16th-edition-authordate-basque.svg "Choose Chicago Manual of Style 16th edition (author-date, Basque) in the CiteDrive App")
...
## How do I cite in  Chicago Manual of Style 16th edition (author-date, Basque)?
...
## How do I create a bibliography in Chicago Manual of Style 16th edition (author-date, Basque)?
...
!!! Doe, Jane &amp; Doe, John . «Title #2». https://example.com/.
