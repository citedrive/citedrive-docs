...
# U Schyłku Starożytności (Polish)

When you 're tasked by using "U Schyłku Starożytności (Polish)" (USS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  U Schyłku Starożytności (Polish)

* Title: U Schyłku Starożytności (Polish)
* Short Title (Id): USS)
* Authors: U Schyłku Starożytności (Polish)
* Download: U Schyłku Starożytności (Polish)
 --->

## How can CiteDrive help you with U Schyłku Starożytności (Polish)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in U Schyłku Starożytności (Polish) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/u-schyku-starozytnosci-polish.svg "Choose U Schyłku Starożytności (Polish) in the CiteDrive App")
...
## How do I cite in  U Schyłku Starożytności (Polish)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. J. Doe, „Title #1”, <i>Imaginary Journal</i> 3 (2008), ss. 1–999. This, in turn, refers to the second J. Doe, J. Doe, <i>Title #2</i>.
! and then to the third.  J. Doe, J. Doe, M. Python, „Title #3”, <i>ABC</i>, s. .
! This paragraph demonstrates the clustering of citations by citing the first and third item. J. Doe, „Title #1”, ss. 1–999; J. Doe, J. Doe, i M. Python, „Title #3”, s. .



## How do I create a bibliography in U Schyłku Starożytności (Polish)?
