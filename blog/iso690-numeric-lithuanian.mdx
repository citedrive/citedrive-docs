---
title: ISO-690 (numeric, Lithuanian)
author: Jospeh Moe
...
When you 're tasked by using "ISO-690 (numeric, Lithuanian)" (IJOM) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  ISO-690 (numeric, Lithuanian)
* **Title:** ISO-690 (numeric, Lithuanian)
* **Type:** numeric
* **Short Title (Id):** IJOM)
* fields: , generic-base
...
## How do I cite in  ISO-690 (numeric, Lithuanian)?
...
## How do I create a bibliography in ISO-690 (numeric, Lithuanian)?
