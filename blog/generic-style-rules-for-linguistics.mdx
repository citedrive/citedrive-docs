...
When you 're tasked by using "Generic Style Rules for Linguistics" (CNS Drugs) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Generic Style Rules for Linguistics
* **Title:** Generic Style Rules for Linguistics
* **Type:** author-date
...
## How do I cite in  Generic Style Rules for Linguistics?
...
## How do I create a bibliography in Generic Style Rules for Linguistics?
...
Doe, Jane & Doe, John . Title #2. (https://example.com/) (Accessed May 1, 2021.)
