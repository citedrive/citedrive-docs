...
<!---
## About  SPIP - Cite plugin

* Title: SPIP - Cite plugin
* Short Title (Id): Econ Gov)
* Authors: SPIP - Cite plugin
* Download: SPIP - Cite plugin
 --->
...
![citedrive_style](images/spip--cite-plugin.svg "Choose SPIP - Cite plugin in the CiteDrive App")
