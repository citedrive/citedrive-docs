...
When you 're tasked by using "Juristische Zitierweise (Stüber) (German)" (ULg) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Juristische Zitierweise (Stüber) (German)

* Title: Juristische Zitierweise (Stüber) (German)
* Short Title (Id): ULg)
* Authors: Juristische Zitierweise (Stüber) (German)
* Download: Juristische Zitierweise (Stüber) (German)
 --->

## How can CiteDrive help you with Juristische Zitierweise (Stüber) (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Juristische Zitierweise (Stüber) (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/juristische-zitierweise-stuber-german.svg "Choose Juristische Zitierweise (Stüber) (German) in the CiteDrive App")
...
## How do I cite in  Juristische Zitierweise (Stüber) (German)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. <i>Doe</i>, Imaginary Journal 2008, 1. This, in turn, refers to the second <i>Doe/Doe</i>, Title #2.
! and then to the third.  <i>Doe u. a.</i>, ABC.
! This paragraph demonstrates the clustering of citations by citing the first and third item. <i>Doe</i>, Imaginary Journal 2008, 1; <i>Doe u. a.</i>, ABC.



## How do I create a bibliography in Juristische Zitierweise (Stüber) (German)?
...
!!! **Bibliography**
!!! <i>Doe, Jane</i>, Title #1, Imaginary Journal  2008, 1–999.
!!! <i>Doe, Jane/ Doe, John </i>, Title #2, https://example.com/ (besucht am 01.05.2021).
!!! <i>Doe, Jane/ Doe, John/ Python, Monty</i>, Title #3, ABC .
