---
title: Romanian Humanities (Romanian)
author: Jospeh Moe
...
When you 're tasked by using "Romanian Humanities (Romanian)" (Urologe) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Romanian Humanities (Romanian)?
...
This sentence refers to the first item from the table. Jane Doe, „Title #1”, <i>Imaginary Journal</i>, vol. 3, 2008. This, in turn, refers to the second Jane Doe, John  Doe, „Title #2”, <u>https://example.com/</u>, data accesării 1 mai 2021.
and then to the third.  Jane Doe, John Doe, Monty Python, „Title #3”, <i>ABC</i>.
This paragraph demonstrates the clustering of citations by citing the first and third item. Jane Doe, „Title #1”; Jane Doe, John Doe, Monty Python, „Title #3”.

:::

## How do I create a bibliography in Romanian Humanities (Romanian)?
...
<span style={{"font-variant":"small-caps"}}>Doe, Jane</span>, „Title #1”, <i>Imaginary Journal</i>, vol. 3, 2008, pp. 1-999.

<span style={{"font-variant":"small-caps"}}>Doe, Jane; Doe, John </span>, „Title #2”, <u>https://example.com/</u>, data accesării 1 mai 2021.
