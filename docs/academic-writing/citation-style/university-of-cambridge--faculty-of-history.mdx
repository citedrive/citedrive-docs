...
When you 're tasked by using "University of Cambridge - Faculty of History" (Educ Stud Math) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  University of Cambridge - Faculty of History

* Title: University of Cambridge - Faculty of History
* Short Title (Id): Educ Stud Math)
* Authors: University of Cambridge - Faculty of History
* Download: University of Cambridge - Faculty of History
 --->

## How can CiteDrive help you with University of Cambridge - Faculty of History?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in University of Cambridge - Faculty of History for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/university-of-cambridge--faculty-of-history.svg "Choose University of Cambridge - Faculty of History in the CiteDrive App")
...
## How do I cite in  University of Cambridge - Faculty of History?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Jane Doe, ‘Title #1’, <i>Imaginary Journal</i>, 3  (2008), pp. 1–999. This, in turn, refers to the second Jane Doe and John  Doe, ‘Title #2’ p. .
! and then to the third.  Jane Doe, John Doe, and Monty Python, ‘Title #3’, <i>ABC</i> p. .
...
## How do I create a bibliography in University of Cambridge - Faculty of History?
...
!!! Doe, Jane and John  Doe, ‘Title #2’ p. .
!!! Doe, Jane, John Doe, and Monty Python, ‘Title #3’, <i>ABC</i> p. .
