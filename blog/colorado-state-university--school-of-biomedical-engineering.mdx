---
title: Colorado State University - School of Biomedical Engineering
author: Jospeh Moe
author_title: CiteDrive Bot
author_url: https://citedrive.com/
tags: [author-date, engineering, medicine]
---

When you 're tasked by using "Colorado State University - School of Biomedical Engineering" (JAAOS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Colorado State University - School of Biomedical Engineering
* **Title:** Colorado State University - School of Biomedical Engineering
* **Type:** author-date
* **Short Title (Id):** JAAOS)
* fields: , engineering, medicine

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Colorado State University - School of Biomedical Engineering? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Colorado State University - School of Biomedical Engineering for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Colorado State University - School of Biomedical Engineering"](images/colorado-state-university--school-of-biomedical-engineering.svg "Choose Colorado State University - School of Biomedical Engineering in the CiteDrive App")
...
## How do I cite in  Colorado State University - School of Biomedical Engineering?
...
This sentence refers to the first item from the table. (<i>Doe, 2008</i>) This, in turn, refers to the second (<i>Doe, n.d.</i>)
and then to the third.  (<i>Doe, n.d.</i>)
This paragraph demonstrates the clustering of citations by citing the first and third item. (<i>Doe, 2008</i>; <i>Doe, n.d.</i>)

:::

## How do I create a bibliography in Colorado State University - School of Biomedical Engineering?
