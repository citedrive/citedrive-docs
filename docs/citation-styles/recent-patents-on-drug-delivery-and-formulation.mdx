...
When you 're tasked by using "Recent Patents on Drug Delivery & Formulation" (IFAO (FR)) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Recent Patents on Drug Delivery & Formulation

* Title: Recent Patents on Drug Delivery & Formulation
* Short Title (Id): IFAO (FR))
* Authors: Recent Patents on Drug Delivery & Formulation
* Download: Recent Patents on Drug Delivery & Formulation
 --->

## How can CiteDrive help you with Recent Patents on Drug Delivery & Formulation?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Recent Patents on Drug Delivery & Formulation for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/recent-patents-on-drug-delivery-and-formulation.svg "Choose Recent Patents on Drug Delivery & Formulation in the CiteDrive App")
...
## How do I cite in  Recent Patents on Drug Delivery & Formulation?
...
## How do I create a bibliography in Recent Patents on Drug Delivery & Formulation?
...
!!! [2]Doe J;Doe J. Title #2. Available at: https://example.com/AccessedMay 1, 2021.
