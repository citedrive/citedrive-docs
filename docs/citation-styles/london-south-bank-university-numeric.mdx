...
<!---
## About  London South Bank University (numeric)

* Title: London South Bank University (numeric)
* Short Title (Id): lsbu-numeric)
* Authors: London South Bank University (numeric)
* Download: London South Bank University (numeric)
 --->
...
![citedrive_style](images/london-south-bank-university-numeric.svg "Choose London South Bank University (numeric) in the CiteDrive App")
