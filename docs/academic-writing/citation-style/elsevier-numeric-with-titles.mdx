...
<!---
## About  Elsevier (numeric, with titles)

* Title: Elsevier (numeric, with titles)
* Short Title (Id): KRCP)
* Authors: Elsevier (numeric, with titles)
* Download: Elsevier (numeric, with titles)
 --->
...
![citedrive_style](images/elsevier-numeric-with-titles.svg "Choose Elsevier (numeric, with titles) in the CiteDrive App")
