...
When you 're tasked by using "Vancouver (superscript, brackets, only year in date)" (NP 405) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Vancouver (superscript, brackets, only year in date)

* Title: Vancouver (superscript, brackets, only year in date)
* Short Title (Id): NP 405)
* Authors: Vancouver (superscript, brackets, only year in date)
* Download: Vancouver (superscript, brackets, only year in date)
 --->

## How can CiteDrive help you with Vancouver (superscript, brackets, only year in date)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Vancouver (superscript, brackets, only year in date) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/vancouver-superscript-brackets-only-year-in-date.svg "Choose Vancouver (superscript, brackets, only year in date) in the CiteDrive App")
...
## How do I cite in  Vancouver (superscript, brackets, only year in date)?
...
## How do I create a bibliography in Vancouver (superscript, brackets, only year in date)?
