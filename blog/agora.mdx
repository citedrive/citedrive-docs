...
When you 're tasked by using "Agora" (Drugs) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
This sentence refers to the first item from the table. Jane Doe, «Title #1», in <i>Imaginary Journal</i> 3, 1–999. This, in turn, refers to the second Jane Doe and John  Doe, <i>Title #2</i>, <u>https://example.com/</u>, May 1, 2021.
and then to the third.  Jane Doe, John Doe and Monty Python, «Title #3», in <i>ABC</i>.
This paragraph demonstrates the clustering of citations by citing the first and third item. J. Doe, «Title #1», art. cit ; J. Doe, J. Doe and M. Python, «Title #3», art. cit.

:::

## How do I create a bibliography in Agora?
