...
When you 're tasked by using "Clinical Physiology and Functional Imaging" (Am J Clin Dermatol) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Clinical Physiology and Functional Imaging
* **Title:** Clinical Physiology and Functional Imaging
* **Type:** author-date
* **Short Title (Id):** Am J Clin Dermatol)
* fields: , medicine

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Clinical Physiology and Functional Imaging? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Clinical Physiology and Functional Imaging for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Clinical Physiology and Functional Imaging"](images/clinical-physiology-and-functional-imaging.svg "Choose Clinical Physiology and Functional Imaging in the CiteDrive App")
...
## How do I cite in  Clinical Physiology and Functional Imaging?
...
## How do I create a bibliography in Clinical Physiology and Functional Imaging?
