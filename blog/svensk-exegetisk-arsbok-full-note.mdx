...
## Details  Svensk exegetisk årsbok (full note)
* **Title:** Svensk exegetisk årsbok (full note)
* **Type:** note
* **Short Title (Id):** SEÅ)
* fields: , theology
...
!["Svensk exegetisk årsbok (full note)"](images/svensk-exegetisk-arsbok-full-note.svg "Choose Svensk exegetisk årsbok (full note) in the CiteDrive App")
