...
<!---
## About  Recherches en Sciences de Gestion (French)

* Title: Recherches en Sciences de Gestion (French)
* Short Title (Id): LUSEM)
* Authors: Recherches en Sciences de Gestion (French)
* Download: Recherches en Sciences de Gestion (French)
 --->
...
![citedrive_style](images/recherches-en-sciences-de-gestion-french.svg "Choose Recherches en Sciences de Gestion (French) in the CiteDrive App")
