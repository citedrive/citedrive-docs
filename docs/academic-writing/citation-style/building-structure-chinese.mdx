...
<!---
## About  Building Structure (Chinese)

* Title: Building Structure (Chinese)
* Short Title (Id): AIAA)
* Authors: Building Structure (Chinese)
* Download: Building Structure (Chinese)
 --->
...
![citedrive_style](images/building-structure-chinese.svg "Choose Building Structure (Chinese) in the CiteDrive App")
