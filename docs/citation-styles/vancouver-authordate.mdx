...
<!---
## About  Vancouver (author-date)

* Title: Vancouver (author-date)
* Short Title (Id): TOPC)
* Authors: Vancouver (author-date)
* Download: Vancouver (author-date)
 --->
...
![citedrive_style](images/vancouver-authordate.svg "Choose Vancouver (author-date) in the CiteDrive App")
