...
<!---
## About  Journalistica (Danish)

* Title: Journalistica (Danish)
* Short Title (Id): Peer-to-Peer Netw. Appl.)
* Authors: Journalistica (Danish)
* Download: Journalistica (Danish)
 --->
...
![citedrive_style](images/journalistica-danish.svg "Choose Journalistica (Danish) in the CiteDrive App")
