...
When you 're tasked by using "Pontificia Universidad Católica del Ecuador (Spanish) - Harvard" (Harvard PUCE) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Pontificia Universidad Católica del Ecuador (Spanish) - Harvard

* Title: Pontificia Universidad Católica del Ecuador (Spanish) - Harvard
* Short Title (Id): Harvard PUCE)
* Authors: Pontificia Universidad Católica del Ecuador (Spanish) - Harvard
* Download: Pontificia Universidad Católica del Ecuador (Spanish) - Harvard
 --->

## How can CiteDrive help you with Pontificia Universidad Católica del Ecuador (Spanish) - Harvard?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Pontificia Universidad Católica del Ecuador (Spanish) - Harvard for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/pontificia-universidad-catolica-del-ecuador-spanish--harvard.svg "Choose Pontificia Universidad Católica del Ecuador (Spanish) - Harvard in the CiteDrive App")
...
## How do I cite in  Pontificia Universidad Católica del Ecuador (Spanish) - Harvard?
...
! and then to the third.  (Doe, Doey Python, s. f.)
! This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe, 2008; Doe, Doey Python, s. f.)



## How do I create a bibliography in Pontificia Universidad Católica del Ecuador (Spanish) - Harvard?
