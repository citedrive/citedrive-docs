...
# Afro-Ásia (Portuguese - Brazil)

When you 're tasked by using "Afro-Ásia (Portuguese - Brazil)" (AA) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Afro-Ásia (Portuguese - Brazil)

* Title: Afro-Ásia (Portuguese - Brazil)
* Short Title (Id): AA)
* Authors: Afro-Ásia (Portuguese - Brazil)
* Download: Afro-Ásia (Portuguese - Brazil)
 --->

## How can CiteDrive help you with Afro-Ásia (Portuguese - Brazil)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Afro-Ásia (Portuguese - Brazil) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/afroasia-portuguese--brazil.svg "Choose Afro-Ásia (Portuguese - Brazil) in the CiteDrive App")
...
## How do I cite in  Afro-Ásia (Portuguese - Brazil)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Jane Doe, “Title #1”, <i>Imaginary Journal</i>, v. 3 (2008), p. 1‑999. This, in turn, refers to the second Jane Doe e John  Doe, “Title #2”, https://example.com/.
! and then to the third.  Jane Doe, John Doe e Monty Python, “Title #3”, <i>ABC</i>, .
! This paragraph demonstrates the clustering of citations by citing the first and third item. Doe, “Title #1”; Doe, Doe e Python, “Title #3”.



## How do I create a bibliography in Afro-Ásia (Portuguese - Brazil)?
...
!!! **Bibliography**
!!! DOE, Jane. “Title #1”. <i>Imaginary Journal</i>, v. 3 (2008), p. 1‑999.
!!! DOE, Jane e DOE, John . “Title #2”. Disponível em: <https://example.com/>.
!!! DOE, Jane, DOE, John e PYTHON, Monty. “Title #3”. <i>ABC</i>, .
