...
When you 're tasked by using "Farmeconomia. Health Economics and Therapeutic Pathways" (Farmeconomia) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Farmeconomia. Health Economics and Therapeutic Pathways

* Title: Farmeconomia. Health Economics and Therapeutic Pathways
* Short Title (Id): Farmeconomia)
* Authors: Farmeconomia. Health Economics and Therapeutic Pathways
* Download: Farmeconomia. Health Economics and Therapeutic Pathways
 --->

## How can CiteDrive help you with Farmeconomia. Health Economics and Therapeutic Pathways?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Farmeconomia. Health Economics and Therapeutic Pathways for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/farmeconomia-health-economics-and-therapeutic-pathways.svg "Choose Farmeconomia. Health Economics and Therapeutic Pathways in the CiteDrive App")
...
## How do I cite in  Farmeconomia. Health Economics and Therapeutic Pathways?
...
## How do I create a bibliography in Farmeconomia. Health Economics and Therapeutic Pathways?
