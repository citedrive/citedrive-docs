...
When you 're tasked by using "The Journal of Hand Surgery (European Volume)" (Anal. Chem.) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  The Journal of Hand Surgery (European Volume)
* **Title:** The Journal of Hand Surgery (European Volume)
* **Type:** author-date
* **Short Title (Id):** Anal. Chem.)
* fields: , medicine

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with The Journal of Hand Surgery (European Volume)? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in The Journal of Hand Surgery (European Volume) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["The Journal of Hand Surgery (European Volume)"](images/the-journal-of-hand-surgery-european-volume.svg "Choose The Journal of Hand Surgery (European Volume) in the CiteDrive App")
...
## How do I cite in  The Journal of Hand Surgery (European Volume)?
...
## How do I create a bibliography in The Journal of Hand Surgery (European Volume)?
