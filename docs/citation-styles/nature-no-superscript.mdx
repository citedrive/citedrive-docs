...
<!---
## About  Nature (no superscript)

* Title: Nature (no superscript)
* Short Title (Id): JWM)
* Authors: Nature (no superscript)
* Download: Nature (no superscript)
 --->
...
![citedrive_style](images/nature-no-superscript.svg "Choose Nature (no superscript) in the CiteDrive App")
