...
* Short Title (Id): HFC)
* Authors: Heart Failure Clinics
* Download: Heart Failure Clinics
 --->
...
![citedrive_style](images/heart-failure-clinics.svg "Choose Heart Failure Clinics in the CiteDrive App")
