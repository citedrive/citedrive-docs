...
## Details  Vancouver (superscript, only year in date, no issue numbers)
* **Title:** Vancouver (superscript, only year in date, no issue numbers)
* **Type:** numeric
...
!["Vancouver (superscript, only year in date, no issue numbers)"](images/vancouver-superscript-only-year-in-date-no-issue-numbers.svg "Choose Vancouver (superscript, only year in date, no issue numbers) in the CiteDrive App")
