...
When you 're tasked by using "Journalistica (Danish)" (Peer-to-Peer Netw. Appl.) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Journalistica (Danish)?
...
and then to the third.  (Doe mfl., u.å.)
This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe, 2008; Doe mfl., u.å.)

:::

## How do I create a bibliography in Journalistica (Danish)?
...
Doe, Jane (2008). Title #1, <i>Imaginary Journal</i>, 3. årgang, s. 1–999..

Doe, Jane &amp; John  Doe (u.å.). 'Title #2',  https://example.com/ (Hentet 1. maj 2021)..

Doe, Jane, John Doe &amp; Monty Python (u.å.). Title #3, <i>ABC</i>, s. ..
