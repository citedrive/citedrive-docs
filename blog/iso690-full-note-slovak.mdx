---
title: ISO-690 (full note, Slovak)
author: Jospeh Moe
...
When you 're tasked by using "ISO-690 (full note, Slovak)" (Precision Agric) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  ISO-690 (full note, Slovak)?
...
This sentence refers to the first item from the table. DOE, J.. Title #1. In: <i>Imaginary Journal</i>. 2008, roč.. 3 This, in turn, refers to the second DOE, J., DOE, J.. Title #2. In:  [cit. 01.05.2021]. Dostupné na internete: https://example.com/
and then to the third.  DOE, J., DOE, J., PYTHON, M.. Title #3. In: <i>ABC</i>
...
## How do I create a bibliography in ISO-690 (full note, Slovak)?
...
DOE, Jane. Title #1. In: <i>Imaginary Journal</i>. 2008, roč.. 3, s. 1-999.

DOE, Jane, DOE, John . Title #2. In:  [cit. 01.05.2021]. Dostupné na internete: https://example.com/

DOE, Jane, DOE, John, PYTHON, Monty. Title #3. In: <i>ABC</i>
