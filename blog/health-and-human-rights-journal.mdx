---
title: Health and Human Rights Journal
author: Jospeh Moe
...
When you 're tasked by using "Health and Human Rights Journal" (HHR) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Health and Human Rights Journal
* **Title:** Health and Human Rights Journal
* **Type:** note
* **Short Title (Id):** HHR)
* fields: , humanities
...
## How do I cite in  Health and Human Rights Journal?
...
This sentence refers to the first item from the table. J. Doe, “Title #1”, <i>Imaginary Journal</i> 3 (2008), pp. 1–999. This, in turn, refers to the second J. Doeand J. Doe, “Title #2”,  (n.d.), Available at https://example.com/.
and then to the third.  J. Doe, J. Doeand M. Python, “Title #3”, <i>ABC</i> (n.d.),.
This paragraph demonstrates the clustering of citations by citing the first and third item. J. Doe, “Title #1”, <i>Imaginary Journal</i> 3 (2008), pp. 1–999.,J. Doe, J. Doeand M. Python, “Title #3”, <i>ABC</i> (n.d.),.

:::

## How do I create a bibliography in Health and Human Rights Journal?
