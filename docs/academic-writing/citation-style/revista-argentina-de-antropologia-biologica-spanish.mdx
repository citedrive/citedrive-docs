...
When you 're tasked by using "Revista Argentina de Antropologia Biologica (Spanish)" (Diplom-LC-UHH) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Revista Argentina de Antropologia Biologica (Spanish)

* Title: Revista Argentina de Antropologia Biologica (Spanish)
* Short Title (Id): Diplom-LC-UHH)
* Authors: Revista Argentina de Antropologia Biologica (Spanish)
* Download: Revista Argentina de Antropologia Biologica (Spanish)
 --->

## How can CiteDrive help you with Revista Argentina de Antropologia Biologica (Spanish)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Revista Argentina de Antropologia Biologica (Spanish) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/revista-argentina-de-antropologia-biologica-spanish.svg "Choose Revista Argentina de Antropologia Biologica (Spanish) in the CiteDrive App")
...
## How do I cite in  Revista Argentina de Antropologia Biologica (Spanish)?
...
## How do I create a bibliography in Revista Argentina de Antropologia Biologica (Spanish)?
...
!!! Doe J, Doe J. Title #2.  [Internet]. Available from: https://example.com/
