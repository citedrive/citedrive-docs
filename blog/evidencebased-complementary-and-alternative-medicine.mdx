...
When you 're tasked by using "Evidence-Based Complementary and Alternative Medicine" (eCAM) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Evidence-Based Complementary and Alternative Medicine
* **Title:** Evidence-Based Complementary and Alternative Medicine
* **Type:** numeric
* **Short Title (Id):** eCAM)
* fields: , medicine
...
** How can CiteDrive help you with Evidence-Based Complementary and Alternative Medicine? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Evidence-Based Complementary and Alternative Medicine for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Evidence-Based Complementary and Alternative Medicine"](images/evidencebased-complementary-and-alternative-medicine.svg "Choose Evidence-Based Complementary and Alternative Medicine in the CiteDrive App")
...
## How do I cite in  Evidence-Based Complementary and Alternative Medicine?
...
## How do I create a bibliography in Evidence-Based Complementary and Alternative Medicine?
...
[2]J. Doe and J. Doe, “Title #2”. [Online]. Available: https://example.com/. [Accessed: 01-May-2021].

[3]J. Doe, J. Doeand M. Python, “Title #3”, <i>ABC</i>.
