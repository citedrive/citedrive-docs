...
When you 're tasked by using "The Journal of Agricultural Science" (Sedimentology) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  The Journal of Agricultural Science

* Title: The Journal of Agricultural Science
* Short Title (Id): Sedimentology)
* Authors: The Journal of Agricultural Science
* Download: The Journal of Agricultural Science
 --->

## How can CiteDrive help you with The Journal of Agricultural Science?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in The Journal of Agricultural Science for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/the-journal-of-agricultural-science.svg "Choose The Journal of Agricultural Science in the CiteDrive App")
...
## How do I cite in  The Journal of Agricultural Science?
...
## How do I create a bibliography in The Journal of Agricultural Science?
...
!!! <span style="font-variant:small-caps;">Doe, J. &amp; Doe, J.</span>. Title #2, https://example.com/
