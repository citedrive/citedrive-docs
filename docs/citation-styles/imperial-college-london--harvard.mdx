...
<!---
## About  Imperial College London - Harvard

* Title: Imperial College London - Harvard
* Short Title (Id): TUD BWL/Logistik (author-date))
* Authors: Imperial College London - Harvard
* Download: Imperial College London - Harvard
 --->
...
![citedrive_style](images/imperial-college-london--harvard.svg "Choose Imperial College London - Harvard in the CiteDrive App")
