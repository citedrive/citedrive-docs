...
When you 're tasked by using "Melbourne School of Theology" (MST) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Melbourne School of Theology?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Jane Doe, “Title #1”, <i>Imaginary Journal</i> 3 (2008), 1–999. This, in turn, refers to the second Jane Doe and John  Doe, “Title #2”,, https://example.com/(accessed 01/05/21).
...
## How do I create a bibliography in Melbourne School of Theology?
...
!!! Doe, Jane and John  Doe. “Title #2”,, https://example.com/(accessed 01/05/21).
