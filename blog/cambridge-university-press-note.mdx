...
When you 're tasked by using "Cambridge University Press (note)" (CUP) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Cambridge University Press (note)
* **Title:** Cambridge University Press (note)
* **Type:** note
* **Short Title (Id):** CUP)
* fields: , generic-base
...
## How do I cite in  Cambridge University Press (note)?
...
This sentence refers to the first item from the table. J. Doe, ‘Title #1’, <i>Imaginary Journal</i>, 3 (2008), 1–999. This, in turn, refers to the second J. Doe and J. Doe, ‘Title #2’.
...
## How do I create a bibliography in Cambridge University Press (note)?
