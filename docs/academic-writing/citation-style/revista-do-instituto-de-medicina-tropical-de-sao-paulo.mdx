...
When you 're tasked by using "Revista do Instituto de Medicina Tropical de São Paulo" (Neurogenetics) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Revista do Instituto de Medicina Tropical de São Paulo

* Title: Revista do Instituto de Medicina Tropical de São Paulo
* Short Title (Id): Neurogenetics)
* Authors: Revista do Instituto de Medicina Tropical de São Paulo
* Download: Revista do Instituto de Medicina Tropical de São Paulo
 --->

## How can CiteDrive help you with Revista do Instituto de Medicina Tropical de São Paulo?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Revista do Instituto de Medicina Tropical de São Paulo for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/revista-do-instituto-de-medicina-tropical-de-sao-paulo.svg "Choose Revista do Instituto de Medicina Tropical de São Paulo in the CiteDrive App")
...
## How do I cite in  Revista do Instituto de Medicina Tropical de São Paulo?
...
## How do I create a bibliography in Revista do Instituto de Medicina Tropical de São Paulo?
...
!!! 2. Doe J, Doe J. Title #2 [Internet].  [cited 2021May1].. Disponível em: https://example.com/
