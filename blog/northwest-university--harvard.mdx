---
title: North-West University - Harvard
author: Jospeh Moe
...
When you 're tasked by using "North-West University - Harvard" (NWU) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  North-West University - Harvard
* **Title:** North-West University - Harvard
* **Type:** author-date
* **Short Title (Id):** NWU)
* fields: , generic-base
...
## How do I cite in  North-West University - Harvard?
...
This sentence refers to the first item from the table. (Doe, in press) This, in turn, refers to the second (Doe &amp; Doe, s.a.)
and then to the third.  (Doe, s.a.)
This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe, in press; Doe, s.a.)

:::

## How do I create a bibliography in North-West University - Harvard?
...
Doe, J. &amp; Doe, J.. s.a.. <i>Title #2</i>. https://example.com/ Date of access: 01 May 2021.

Doe, J., Doe, J. &amp; Python, M.. s.a.. Title #3<i>ABC</i>.
