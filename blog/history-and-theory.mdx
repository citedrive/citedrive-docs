...
When you 're tasked by using "History and Theory" (Transp Porous Med) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  History and Theory?
...
This sentence refers to the first item from the table. Jane Doe, “Title #1”, <i>Imaginary Journal</i> (2008), 3, 1–999. This, in turn, refers to the second Jane Doe and John  Doe, “Title #2”.
and then to the third.  Jane Doe, John Doe, and Monty Python, “Title #3”, <i>ABC</i>.
This paragraph demonstrates the clustering of citations by citing the first and third item. Jane Doe, “Title #1”, <i>Imaginary Journal</i> (2008), 3, 1–999; Jane Doe, John Doe, and Monty Python, “Title #3”, <i>ABC</i>.

:::

## How do I create a bibliography in History and Theory?
