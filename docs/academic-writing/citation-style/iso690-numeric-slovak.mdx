...
<!---
## About  ISO-690 (numeric, Slovak)

* Title: ISO-690 (numeric, Slovak)
* Short Title (Id): Rev Austrian Econ)
* Authors: ISO-690 (numeric, Slovak)
* Download: ISO-690 (numeric, Slovak)
 --->
...
![citedrive_style](images/iso690-numeric-slovak.svg "Choose ISO-690 (numeric, Slovak) in the CiteDrive App")
