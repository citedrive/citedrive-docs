...
<!---
## About  ACM SIG Proceedings ("et al." for 15+ authors)

* Title: ACM SIG Proceedings ("et al." for 15+ authors)
* Short Title (Id): Australasian Plant Dis. Notes)
* Authors: ACM SIG Proceedings ("et al." for 15+ authors)
* Download: ACM SIG Proceedings ("et al." for 15+ authors)
 --->
...
![citedrive_style](images/acm-sig-proceedings-et-al-for-15-authors.svg "Choose ACM SIG Proceedings ("et al." for 15+ authors) in the CiteDrive App")
