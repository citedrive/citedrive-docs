...
When you 're tasked by using "Vancouver (superscript, only year in date, no issue numbers)" (Child Youth Care Forum) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Vancouver (superscript, only year in date, no issue numbers)

* Title: Vancouver (superscript, only year in date, no issue numbers)
* Short Title (Id): Child Youth Care Forum)
* Authors: Vancouver (superscript, only year in date, no issue numbers)
* Download: Vancouver (superscript, only year in date, no issue numbers)
 --->

## How can CiteDrive help you with Vancouver (superscript, only year in date, no issue numbers)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Vancouver (superscript, only year in date, no issue numbers) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/vancouver-superscript-only-year-in-date-no-issue-numbers.svg "Choose Vancouver (superscript, only year in date, no issue numbers) in the CiteDrive App")
...
## How do I cite in  Vancouver (superscript, only year in date, no issue numbers)?
...
## How do I create a bibliography in Vancouver (superscript, only year in date, no issue numbers)?
...
!!! 2. Doe J, Doe J. Title #2 [Internet].  [cited 2021May1].. Available from: https://example.com/
