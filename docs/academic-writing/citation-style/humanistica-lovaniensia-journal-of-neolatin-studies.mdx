...
When you 're tasked by using "Humanistica Lovaniensia. Journal of Neo-Latin Studies" (J Urban Health) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Humanistica Lovaniensia. Journal of Neo-Latin Studies

* Title: Humanistica Lovaniensia. Journal of Neo-Latin Studies
* Short Title (Id): J Urban Health)
* Authors: Humanistica Lovaniensia. Journal of Neo-Latin Studies
* Download: Humanistica Lovaniensia. Journal of Neo-Latin Studies
 --->

## How can CiteDrive help you with Humanistica Lovaniensia. Journal of Neo-Latin Studies?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Humanistica Lovaniensia. Journal of Neo-Latin Studies for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/humanistica-lovaniensia-journal-of-neolatin-studies.svg "Choose Humanistica Lovaniensia. Journal of Neo-Latin Studies in the CiteDrive App")
...
## How do I cite in  Humanistica Lovaniensia. Journal of Neo-Latin Studies?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. J. Doe, “Title #1”, <i>Imaginary Journal</i> 3 (2008) 1–999. This, in turn, refers to the second J. Doe and J. Doe, “Title #2” https://example.com/, accessed 5/1/2021.
...
## How do I create a bibliography in Humanistica Lovaniensia. Journal of Neo-Latin Studies?
