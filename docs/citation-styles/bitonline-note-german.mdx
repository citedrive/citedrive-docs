...
# b.i.t.online (note, German)

When you 're tasked by using "b.i.t.online (note, German)" (ZfS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  b.i.t.online (note, German)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Doe, Jane: Title #1, in: Imaginary Journal 3 (2008), S. 1–999. This, in turn, refers to the second Doe, Jane/ Doe, John : Title #2, S. . https://example.com/ [01.05.2021].
...
## How do I create a bibliography in b.i.t.online (note, German)?
