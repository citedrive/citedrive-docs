...
This paragraph demonstrates the clustering of citations by citing the first and third item. Jane Doe, <i>Title #1</i>, 3  <span style={{"font-variant":"small-caps"}}>Imaginary Journal</span> 1–999 (2008).
