...
# Vita Latina (auteurs anciens, French)

When you 're tasked by using "Vita Latina (auteurs anciens, French)" (VL (text. anc.)) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Vita Latina (auteurs anciens, French)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. non disponible. This, in turn, refers to the second non disponible.
! and then to the third.  non disponible.
! This paragraph demonstrates the clustering of citations by citing the first and third item. non disponible ; non disponible.



## How do I create a bibliography in Vita Latina (auteurs anciens, French)?
...
!!! **Bibliography**
!!!   Doe J., <i>Title #1</i> 3, 2008.
!!!   Doe J. &amp; Doe J., <i>Title #2</i>, s. d..
!!!   Doe J., Doe J., &amp; Python M., <i>Title #3</i>, s. d..
