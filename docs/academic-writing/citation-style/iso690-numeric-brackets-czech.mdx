...
<!---
## About  ISO-690 (numeric, brackets, Czech)

* Title: ISO-690 (numeric, brackets, Czech)
* Short Title (Id): MedMa)
* Authors: ISO-690 (numeric, brackets, Czech)
* Download: ISO-690 (numeric, brackets, Czech)
 --->
...
![citedrive_style](images/iso690-numeric-brackets-czech.svg "Choose ISO-690 (numeric, brackets, Czech) in the CiteDrive App")
