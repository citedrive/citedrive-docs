...
When you 're tasked by using "France (auteurs et al., numérotation, French)" (Ann Nucl Med) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  France (auteurs et al., numérotation, French)

* Title: France (auteurs et al., numérotation, French)
* Short Title (Id): Ann Nucl Med)
* Authors: France (auteurs et al., numérotation, French)
* Download: France (auteurs et al., numérotation, French)
 --->

## How can CiteDrive help you with France (auteurs et al., numérotation, French)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in France (auteurs et al., numérotation, French) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/france-auteurs-et-al-numerotation-french.svg "Choose France (auteurs et al., numérotation, French) in the CiteDrive App")
...
## How do I cite in  France (auteurs et al., numérotation, French)?
...
## How do I create a bibliography in France (auteurs et al., numérotation, French)?
