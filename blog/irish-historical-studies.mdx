---
title: Irish Historical Studies
author: Jospeh Moe
...
When you 're tasked by using "Irish Historical Studies" (IHS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Irish Historical Studies
* **Title:** Irish Historical Studies
* **Type:** note
* **Short Title (Id):** IHS)
* fields: , history
...
## How do I cite in  Irish Historical Studies?
...
This sentence refers to the first item from the table. Jane Doe, ‘Title #1’ in <i>Imaginary Journal</i>, iii (2008), pp 1–999. This, in turn, refers to the second Jane Doe and John  Doe, ‘Title #2’, p. (https://example.com/) (1 May 2021).
and then to the third.  Jane Doe, John Doe and Monty Python, ‘Title #3’ in <i>ABC</i>, p..
...
## How do I create a bibliography in Irish Historical Studies?
...
Doe, Jane, ‘Title #1’ in <i>Imaginary Journal</i>, iii (2008), pp 1–999

Doe, Jane and John  Doe, ‘Title #2’ (https://example.com/) (1 May 2021)

Doe, Jane, John Doe and Monty Python, ‘Title #3’ in <i>ABC</i>, p.
