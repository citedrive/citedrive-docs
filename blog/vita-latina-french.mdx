...
When you 're tasked by using "Vita Latina (French)" (VL) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Vita Latina (French)?
...
This sentence refers to the first item from the table. <span style={{"font-variant":"small-caps"}}>J. Doe</span> 2008. This, in turn, refers to the second <span style={{"font-variant":"small-caps"}}>J. Doe &amp; J. Doe</span>.
and then to the third.  <span style={{"font-variant":"small-caps"}}>J. Doe, J. Doe, &amp; M. Python</span>.
This paragraph demonstrates the clustering of citations by citing the first and third item. <span style={{"font-variant":"small-caps"}}>J. Doe</span> 2008 ; <span style={{"font-variant":"small-caps"}}>J. Doe, J. Doe, &amp; M. Python</span>.

:::

## How do I create a bibliography in Vita Latina (French)?
...
  <span style={{"font-variant":"small-caps"}}>Doe J. &amp; Doe J.</span> s. d.« Title #2 » [<u>https://example.com/</u>] -  consulté le 1/5/2021.
