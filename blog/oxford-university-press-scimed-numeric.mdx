---
title: Oxford University Press SciMed (numeric)
author: Jospeh Moe
author_title: CiteDrive Bot
author_url: https://citedrive.com/
tags: [numeric, medicine, science]
---

When you 're tasked by using "Oxford University Press SciMed (numeric)" (Harvard UTS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Oxford University Press SciMed (numeric)
* **Title:** Oxford University Press SciMed (numeric)
* **Type:** numeric
...
## How do I cite in  Oxford University Press SciMed (numeric)?
...
## How do I create a bibliography in Oxford University Press SciMed (numeric)?
