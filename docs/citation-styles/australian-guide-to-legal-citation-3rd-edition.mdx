...
When you 're tasked by using "Australian Guide to Legal Citation 3rd edition" (AGLC) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Australian Guide to Legal Citation 3rd edition

* Title: Australian Guide to Legal Citation 3rd edition
* Short Title (Id): AGLC)
* Authors: Australian Guide to Legal Citation 3rd edition
* Download: Australian Guide to Legal Citation 3rd edition
 --->

## How can CiteDrive help you with Australian Guide to Legal Citation 3rd edition?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Australian Guide to Legal Citation 3rd edition for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/australian-guide-to-legal-citation-3rd-edition.svg "Choose Australian Guide to Legal Citation 3rd edition in the CiteDrive App")
...
## How do I cite in  Australian Guide to Legal Citation 3rd edition?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. J Doe, ‘Title #1’ (2008) 3 <i>Imaginary Journal</i> 1. This, in turn, refers to the second J Doe and J Doe, <i>Title #2</i> <https://example.com/>.
...
## How do I create a bibliography in Australian Guide to Legal Citation 3rd edition?
...
!!! **Bibliography**
!!! Doe, J, ‘Title #1’ (2008) 3 <i>Imaginary Journal</i> 1
!!! Doe, J and J Doe, <i>Title #2</i> <https://example.com/>
