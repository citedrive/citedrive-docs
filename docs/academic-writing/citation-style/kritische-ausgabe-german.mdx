...
<!---
## About  Kritische Ausgabe (German)

* Title: Kritische Ausgabe (German)
* Short Title (Id): Sports Med)
* Authors: Kritische Ausgabe (German)
* Download: Kritische Ausgabe (German)
 --->
...
![citedrive_style](images/kritische-ausgabe-german.svg "Choose Kritische Ausgabe (German) in the CiteDrive App")
