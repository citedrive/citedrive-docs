...
When you 're tasked by using "European Journal of Clinical Microbiology & Infectious Diseases" (J Parasit Dis) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  European Journal of Clinical Microbiology & Infectious Diseases

* Title: European Journal of Clinical Microbiology & Infectious Diseases
* Short Title (Id): J Parasit Dis)
* Authors: European Journal of Clinical Microbiology & Infectious Diseases
* Download: European Journal of Clinical Microbiology & Infectious Diseases
 --->

## How can CiteDrive help you with European Journal of Clinical Microbiology & Infectious Diseases?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in European Journal of Clinical Microbiology & Infectious Diseases for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/european-journal-of-clinical-microbiology-and-infectious-diseases.svg "Choose European Journal of Clinical Microbiology & Infectious Diseases in the CiteDrive App")
...
## How do I cite in  European Journal of Clinical Microbiology & Infectious Diseases?
...
## How do I create a bibliography in European Journal of Clinical Microbiology & Infectious Diseases?
...
!!! 2. Doe J, Doe J. Title #2 [Internet].  [cited 2021 1];doi: https://example.com/
