...
When you 're tasked by using "Mohr Siebeck - Recht (German - Austria)" (Trauma Berufskrankheit) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Mohr Siebeck - Recht (German - Austria)

* Title: Mohr Siebeck - Recht (German - Austria)
* Short Title (Id): Trauma Berufskrankheit)
* Authors: Mohr Siebeck - Recht (German - Austria)
* Download: Mohr Siebeck - Recht (German - Austria)
 --->

## How can CiteDrive help you with Mohr Siebeck - Recht (German - Austria)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Mohr Siebeck - Recht (German - Austria) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/mohr-siebeck--recht-german--austria.svg "Choose Mohr Siebeck - Recht (German - Austria) in the CiteDrive App")
...
## How do I cite in  Mohr Siebeck - Recht (German - Austria)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. <i>Doe</i>, Imaginary Journal 2008. This, in turn, refers to the second Title #2, <https://example.com/>, Stand 01.05.2021.
! and then to the third.  <i>Doe/Doe/Python</i>, ABC .
! This paragraph demonstrates the clustering of citations by citing the first and third item. <i>Doe</i>, Imaginary Journal 2008, <i>Doe/Doe/Python</i>, ABC .



## How do I create a bibliography in Mohr Siebeck - Recht (German - Austria)?
...
!!! **Bibliography**
!!! <i><i>Doe, Jane</i></i>: Title #1, Imaginary Journal 2008, 1–999.
!!! <i><i>Doe, Jane/Doe, John/Python, Monty</i></i>: Title #3, ABC 
