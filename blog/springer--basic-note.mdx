...
When you 're tasked by using "Springer - Basic (note)" (Adv Data Anal Classif) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Springer - Basic (note)?
...
This sentence refers to the first item from the table. Doe  (2008). This, in turn, refers to the second Doe J, Doe J Title #2. https://example.com/. Accessed 1 May 2021.
...
## How do I create a bibliography in Springer - Basic (note)?
