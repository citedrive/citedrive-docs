...
<!---
## About  Springer - Humanities (numeric, brackets)

* Title: Springer - Humanities (numeric, brackets)
* Short Title (Id): Standort)
* Authors: Springer - Humanities (numeric, brackets)
* Download: Springer - Humanities (numeric, brackets)
 --->
...
![citedrive_style](images/springer--humanities-numeric-brackets.svg "Choose Springer - Humanities (numeric, brackets) in the CiteDrive App")
