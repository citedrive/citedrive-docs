...
When you 're tasked by using "RTF Scan" (Arthropod-Plant Interactions) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
This sentence refers to the first item from the table. {Doe, "Title #1", 2008} This, in turn, refers to the second {Doe et al., "Title #2", n.d.}
and then to the third.  {Doe et al., "Title #3", n.d.}
...
## How do I create a bibliography in RTF Scan?
...
{Doe et al., "Title #2", n.d.}

{Doe et al., "Title #3", n.d.}
