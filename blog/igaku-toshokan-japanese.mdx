...
When you 're tasked by using "Igaku Toshokan (Japanese)" (CRO) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Igaku Toshokan (Japanese)
* **Title:** Igaku Toshokan (Japanese)
* **Type:** numeric
* **Short Title (Id):** CRO)
* fields: , medicine
...
## How do I cite in  Igaku Toshokan (Japanese)?
...
## How do I create a bibliography in Igaku Toshokan (Japanese)?
...
1) Doe J. Title #1. Imaginary Journal. 2008年;3:1–999. 

2) Doe J, Doe J. Title #2. [Internet]. https://example.com/ [参照 2021年5月1日]
