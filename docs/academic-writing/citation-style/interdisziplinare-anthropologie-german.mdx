...
# Interdisziplinäre Anthropologie (German)

When you 're tasked by using "Interdisziplinäre Anthropologie (German)" (IA) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Interdisziplinäre Anthropologie (German)

* Title: Interdisziplinäre Anthropologie (German)
* Short Title (Id): IA)
* Authors: Interdisziplinäre Anthropologie (German)
* Download: Interdisziplinäre Anthropologie (German)
 --->

## How can CiteDrive help you with Interdisziplinäre Anthropologie (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Interdisziplinäre Anthropologie (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/interdisziplinare-anthropologie-german.svg "Choose Interdisziplinäre Anthropologie (German) in the CiteDrive App")
...
## How do I cite in  Interdisziplinäre Anthropologie (German)?
...
## How do I create a bibliography in Interdisziplinäre Anthropologie (German)?
...
!!! Doe, Jane / Doe, John : Title #2, online verfügbar unter: https://example.com/ [01.05.2021].
!!! Doe, Jane / Doe, John / Python, Monty: Title #3, in: ABC (o. J.).
