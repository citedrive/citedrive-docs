...
When you 're tasked by using "Tábula (Spanish)" (NLM) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Tábula (Spanish)?
...
## How do I create a bibliography in Tábula (Spanish)?
...
DOE, Jane. (2008). "Title #1". <i>Imaginary Journal</i>, vol. 3, pp. 1-999. 

DOE, Jane y DOE, John . ([sin fecha]). "Title #2".  [en línea]. {"<"}https://example.com/{">"}.  [Consulta: 01/05/2021].

DOE, Jane, DOE, John y PYTHON, Monty. ([sin fecha]). "Title #3". <i>ABC</i>, 
