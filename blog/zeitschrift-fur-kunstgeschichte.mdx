...
tags: [note, humanities, history]
---

When you 're tasked by using "Zeitschrift für Kunstgeschichte" (ZfK) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Zeitschrift für Kunstgeschichte
* **Title:** Zeitschrift für Kunstgeschichte
* **Type:** note
* **Short Title (Id):** ZfK)
...
## How do I cite in  Zeitschrift für Kunstgeschichte?
...
This sentence refers to the first item from the table. Jane Doe, Title #1in:  <i>Imaginary Journal</i> 3, 2008,  1–999. This, in turn, refers to the second Jane Doe and John  Doe, <i>Title #2</i>, https://example.com/ (accessed 1.5.2021).
and then to the third.  Jane Doe et al., Title #3in:  <i>ABC</i>.
This paragraph demonstrates the clustering of citations by citing the first and third item. Doe 2008; Doe et al..

:::

## How do I create a bibliography in Zeitschrift für Kunstgeschichte?
...
Doe, Jane, Title #1in:  <i>Imaginary Journal</i> 3, 2008,  1–999.

Doe, Jane and John  Doe, <i>Title #2</i>, https://example.com/ (accessed 1.5.2021).

Doe, Jane et al., Title #3in:  <i>ABC</i>.
