---
title: University of Abertay Dundee - Harvard
author: Jospeh Moe
...
When you 're tasked by using "University of Abertay Dundee - Harvard" (Sport Sci Health) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  University of Abertay Dundee - Harvard?
...
This sentence refers to the first item from the table. (Doe 2008, 1–999) This, in turn, refers to the second (Doe and Doe n.d.)
and then to the third.  (Doe, Doe and Python n.d.)
This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe 2008, 1–999; Doe, Doe and Python n.d.)

:::

## How do I create a bibliography in University of Abertay Dundee - Harvard?
...
Doe, J and Doe, J n.d., Title #2, viewed 1 May, 2021, {"<"}https://example.com/{">"}.
