---
title: Zeitschrift für deutsche Philologie (German)
author: Jospeh Moe
...
When you 're tasked by using "Zeitschrift für deutsche Philologie (German)" (ZfdPh) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Zeitschrift für deutsche Philologie (German)?
...
This sentence refers to the first item from the table. Jane Doe: Title #1, in: Imaginary Journal,  32008, S. 1–999. This, in turn, refers to the second Jane Doe, John  Doe: Title #2, S., https://example.com/ [01.05.2021].
and then to the third.  Jane Doe, John Doe, Monty Python: Title #3, in: ABC, S..
This paragraph demonstrates the clustering of citations by citing the first and third item. Doe; Doe, Doe, Python.

:::

## How do I create a bibliography in Zeitschrift für deutsche Philologie (German)?
...
Doe, Jane (2008): Title #1, in: Imaginary Journal,  32008, S. 1–999.

Doe, Jane, Doe, John  Title #2, S., https://example.com/ [01.05.2021].
