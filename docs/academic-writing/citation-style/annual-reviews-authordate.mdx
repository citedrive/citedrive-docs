...
<!---
## About  Annual Reviews (author-date)

* Title: Annual Reviews (author-date)
* Short Title (Id): Harvard - DkIT)
* Authors: Annual Reviews (author-date)
* Download: Annual Reviews (author-date)
 --->
...
![citedrive_style](images/annual-reviews-authordate.svg "Choose Annual Reviews (author-date) in the CiteDrive App")
