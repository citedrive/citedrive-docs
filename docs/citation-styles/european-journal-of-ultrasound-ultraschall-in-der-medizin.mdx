...
When you 're tasked by using "European Journal of Ultrasound (Ultraschall in der Medizin)" (Form Methods Syst Des) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  European Journal of Ultrasound (Ultraschall in der Medizin)

* Title: European Journal of Ultrasound (Ultraschall in der Medizin)
* Short Title (Id): Form Methods Syst Des)
* Authors: European Journal of Ultrasound (Ultraschall in der Medizin)
* Download: European Journal of Ultrasound (Ultraschall in der Medizin)
 --->

## How can CiteDrive help you with European Journal of Ultrasound (Ultraschall in der Medizin)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in European Journal of Ultrasound (Ultraschall in der Medizin) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/european-journal-of-ultrasound-ultraschall-in-der-medizin.svg "Choose European Journal of Ultrasound (Ultraschall in der Medizin) in the CiteDrive App")
...
## How do I cite in  European Journal of Ultrasound (Ultraschall in der Medizin)?
...
## How do I create a bibliography in European Journal of Ultrasound (Ultraschall in der Medizin)?
...
!!! 2<i>Doe J, Doe J</i>. Title #2 [cited 2021].Available at: https://example.com/.
!!! 3<i>Doe J, Doe J, Python M</i>. Title #3. ABC.
