...
<!---
## About  ArchéoSciences (French)

* Title: ArchéoSciences (French)
* Short Title (Id): J Ind Microbiol Biotechnol)
* Authors: ArchéoSciences (French)
* Download: ArchéoSciences (French)
 --->
...
![citedrive_style](images/archeosciences-french.svg "Choose ArchéoSciences (French) in the CiteDrive App")
