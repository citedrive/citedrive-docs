...
When you 're tasked by using "Art History" (Protein J) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
This sentence refers to the first item from the table. Jane Doe, ‘Title #1’, Imaginary Journal, 3, 2008, 1–999. This, in turn, refers to the second Jane Doe and John  Doe, ‘Title #2’.
and then to the third.  Jane Doe, John Doe, and Monty Python, ‘Title #3’, ABC.
...
## How do I create a bibliography in Art History?
