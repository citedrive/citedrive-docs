...
<!---
## About  Studia BAS (Polish)

* Title: Studia BAS (Polish)
* Short Title (Id): APA (numeric, superscript, brackets))
* Authors: Studia BAS (Polish)
* Download: Studia BAS (Polish)
 --->
...
![citedrive_style](images/studia-bas-polish.svg "Choose Studia BAS (Polish) in the CiteDrive App")
