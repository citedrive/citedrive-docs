...
<!---
## About  Springer - Humanities (author-date)

* Title: Springer - Humanities (author-date)
* Short Title (Id): Knowl Inf Syst)
* Authors: Springer - Humanities (author-date)
* Download: Springer - Humanities (author-date)
 --->
...
![citedrive_style](images/springer--humanities-authordate.svg "Choose Springer - Humanities (author-date) in the CiteDrive App")
