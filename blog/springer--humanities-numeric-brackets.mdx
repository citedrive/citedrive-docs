...
tags: [numeric, generic-base, humanities]
---

When you 're tasked by using "Springer - Humanities (numeric, brackets)" (Standort) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Springer - Humanities (numeric, brackets)?
...
## How do I create a bibliography in Springer - Humanities (numeric, brackets)?
...
1. Doe, Jane. 2008. Title #1. <i>Imaginary Journal</i> 3: 1–999.

2. Doe, Jane, and John  Doe. 2021. Title #2. https://example.com/Accessed May 1.

3. Doe, Jane, John Doe, and Monty Python. Title #3. <i>ABC</i>.
