...
<!---
## About  ACM SIG Proceedings ("et al." for 3+ authors)

* Title: ACM SIG Proceedings ("et al." for 3+ authors)
* Short Title (Id): Patient)
* Authors: ACM SIG Proceedings ("et al." for 3+ authors)
* Download: ACM SIG Proceedings ("et al." for 3+ authors)
 --->
...
![citedrive_style](images/acm-sig-proceedings-et-al-for-3-authors.svg "Choose ACM SIG Proceedings ("et al." for 3+ authors) in the CiteDrive App")
