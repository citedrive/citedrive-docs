...
<!---
## About  ISO-690 (author-date, Spanish)

* Title: ISO-690 (author-date, Spanish)
* Short Title (Id): TOMS)
* Authors: ISO-690 (author-date, Spanish)
* Download: ISO-690 (author-date, Spanish)
 --->
...
![citedrive_style](images/iso690-authordate-spanish.svg "Choose ISO-690 (author-date, Spanish) in the CiteDrive App")
