...
# Postępy Higieny i Medycyny Doświadczalnej (Polish)

When you 're tasked by using "Postępy Higieny i Medycyny Doświadczalnej (Polish)" (PHiMD) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Postępy Higieny i Medycyny Doświadczalnej (Polish)

* Title: Postępy Higieny i Medycyny Doświadczalnej (Polish)
* Short Title (Id): PHiMD)
* Authors: Postępy Higieny i Medycyny Doświadczalnej (Polish)
* Download: Postępy Higieny i Medycyny Doświadczalnej (Polish)
 --->

## How can CiteDrive help you with Postępy Higieny i Medycyny Doświadczalnej (Polish)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Postępy Higieny i Medycyny Doświadczalnej (Polish) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/postepy-higieny-i-medycyny-doswiadczalnej-polish.svg "Choose Postępy Higieny i Medycyny Doświadczalnej (Polish) in the CiteDrive App")
...
## How do I cite in  Postępy Higieny i Medycyny Doświadczalnej (Polish)?
...
## How do I create a bibliography in Postępy Higieny i Medycyny Doświadczalnej (Polish)?
