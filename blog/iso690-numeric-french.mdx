...
When you 're tasked by using "ISO-690 (numeric, French)" (RPOR) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  ISO-690 (numeric, French)
* **Title:** ISO-690 (numeric, French)
* **Type:** numeric
* **Short Title (Id):** RPOR)
* fields: , generic-base
...
## How do I cite in  ISO-690 (numeric, French)?
...
## How do I create a bibliography in ISO-690 (numeric, French)?
...
1. DOE, Jane. Title #1. <i>Imaginary Journal</i>. 2008. Vol. 3, pp. 1‑999. 

2. DOE, Jane et DOE, John . Title #2.  [en ligne].  [Consulté le 1 mai 2021]. Disponible à l'adresse : https://example.com/

3. DOE, Jane, DOE, John et PYTHON, Monty. Title #3. <i>ABC</i>. 
