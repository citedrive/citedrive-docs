...
When you 're tasked by using "Bluebook Law Review" (medizinische genetik) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Bluebook Law Review?
...
This sentence refers to the first item from the table. Jane Doe, <i>Title #1</i>, 3  <span style={{"font-variant":"small-caps"}}>Imaginary Journal</span> 1–999 (2008). This, in turn, refers to the second Jane Doe &amp; John  Doe, <i>Title #2</i>, https://example.com/ (last visited May 1, 2021).
and then to the third.  Jane Doe, John Doe &amp; Monty Python, <i>Title #3</i>,  <span style={{"font-variant":"small-caps"}}>ABC</span>.
...
## How do I create a bibliography in Bluebook Law Review?
