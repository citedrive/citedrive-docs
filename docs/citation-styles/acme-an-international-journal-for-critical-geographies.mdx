...
When you 're tasked by using "ACME: An International Journal for Critical Geographies" (AIP) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  ACME: An International Journal for Critical Geographies

* Title: ACME: An International Journal for Critical Geographies
* Short Title (Id): AIP)
* Authors: ACME: An International Journal for Critical Geographies
* Download: ACME: An International Journal for Critical Geographies
 --->

## How can CiteDrive help you with ACME: An International Journal for Critical Geographies?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in ACME: An International Journal for Critical Geographies for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/acme-an-international-journal-for-critical-geographies.svg "Choose ACME: An International Journal for Critical Geographies in the CiteDrive App")
...
## How do I cite in  ACME: An International Journal for Critical Geographies?
...
## How do I create a bibliography in ACME: An International Journal for Critical Geographies?
...
!!! Doe, J, J Doeand M Python. Title #3 . ABC.
