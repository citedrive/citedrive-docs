...
<!---
## About  Smithsonian Institution Scholarly Press (note)

* Title: Smithsonian Institution Scholarly Press (note)
* Short Title (Id): SISP)
* Authors: Smithsonian Institution Scholarly Press (note)
* Download: Smithsonian Institution Scholarly Press (note)
 --->
...
![citedrive_style](images/smithsonian-institution-scholarly-press-note.svg "Choose Smithsonian Institution Scholarly Press (note) in the CiteDrive App")
