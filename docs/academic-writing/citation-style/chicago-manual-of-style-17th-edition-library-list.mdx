...
When you 're tasked by using "Chicago Manual of Style 17th edition (library list)" (Euro Jnl Phil Sci) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Chicago Manual of Style 17th edition (library list)

* Title: Chicago Manual of Style 17th edition (library list)
* Short Title (Id): Euro Jnl Phil Sci)
* Authors: Chicago Manual of Style 17th edition (library list)
* Download: Chicago Manual of Style 17th edition (library list)
 --->

## How can CiteDrive help you with Chicago Manual of Style 17th edition (library list)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Chicago Manual of Style 17th edition (library list) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/chicago-manual-of-style-17th-edition-library-list.svg "Choose Chicago Manual of Style 17th edition (library list) in the CiteDrive App")
...
## How do I cite in  Chicago Manual of Style 17th edition (library list)?
...
## How do I create a bibliography in Chicago Manual of Style 17th edition (library list)?
