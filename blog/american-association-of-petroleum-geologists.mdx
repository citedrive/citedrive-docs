---
title: American Association of Petroleum Geologists
author: Jospeh Moe
author_title: CiteDrive Bot
author_url: https://citedrive.com/
tags: [author-date, geology]
---

When you 're tasked by using "American Association of Petroleum Geologists" (South African Journal of Animal Science) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  American Association of Petroleum Geologists
* **Title:** American Association of Petroleum Geologists
* **Type:** author-date
* **Short Title (Id):** South African Journal of Animal Science)
* fields: , geology

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with American Association of Petroleum Geologists? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in American Association of Petroleum Geologists for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["American Association of Petroleum Geologists"](images/american-association-of-petroleum-geologists.svg "Choose American Association of Petroleum Geologists in the CiteDrive App")
...
## How do I cite in  American Association of Petroleum Geologists?
...
## How do I create a bibliography in American Association of Petroleum Geologists?
...
Doe, J., 2008, Title #1: Imaginary Journal, v. 3, p. 1–999.

Doe, J., and J. Doe, n.d., Title #2: {"<"}https://example.com/{">"} (accessed May 1, 2021).
