...
* Authors: IEEE Transactions on Medical Imaging
* Download: IEEE Transactions on Medical Imaging
 --->
...
![citedrive_style](images/ieee-transactions-on-medical-imaging.svg "Choose IEEE Transactions on Medical Imaging in the CiteDrive App")
