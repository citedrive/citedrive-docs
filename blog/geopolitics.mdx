...
When you 're tasked by using "Geopolitics" (APA (6th ed., no DOI)) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
This sentence refers to the first item from the table. J. Doe, ‘Title #1’, <i>Imaginary Journal</i>, 3 (2008). This, in turn, refers to the second J. Doe and J. Doe, ‘Title #2’, n.d., https://example.com/.
...
## How do I create a bibliography in Geopolitics?
