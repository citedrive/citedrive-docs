...
<!---
## About  Oxford University Press SciMed (numeric)

* Title: Oxford University Press SciMed (numeric)
* Short Title (Id): Harvard UTS)
* Authors: Oxford University Press SciMed (numeric)
* Download: Oxford University Press SciMed (numeric)
 --->
...
![citedrive_style](images/oxford-university-press-scimed-numeric.svg "Choose Oxford University Press SciMed (numeric) in the CiteDrive App")
