...
# Institut national de santé publique du Québec - NAPP (French - Canada)

When you 're tasked by using "Institut national de santé publique du Québec - NAPP (French - Canada)" (INSPQ-NAPP) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Institut national de santé publique du Québec - NAPP (French - Canada)

* Title: Institut national de santé publique du Québec - NAPP (French - Canada)
* Short Title (Id): INSPQ-NAPP)
* Authors: Institut national de santé publique du Québec - NAPP (French - Canada)
* Download: Institut national de santé publique du Québec - NAPP (French - Canada)
 --->

## How can CiteDrive help you with Institut national de santé publique du Québec - NAPP (French - Canada)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Institut national de santé publique du Québec - NAPP (French - Canada) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/institut-national-de-sante-publique-du-quebec--napp-french--canada.svg "Choose Institut national de santé publique du Québec - NAPP (French - Canada) in the CiteDrive App")
...
## How do I cite in  Institut national de santé publique du Québec - NAPP (French - Canada)?
...
## How do I create a bibliography in Institut national de santé publique du Québec - NAPP (French - Canada)?
