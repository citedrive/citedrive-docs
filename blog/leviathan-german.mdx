...
When you 're tasked by using "Leviathan (German)" (USFS PNWRS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Leviathan (German)?
...
This sentence refers to the first item from the table. Doe 2008 This, in turn, refers to the second <i>Title #2</i> https://example.com/ (zugegriffen 1.5.2021)
...
## How do I create a bibliography in Leviathan (German)?
...
Doe, Jane; Doe, John . <i>Title #2</i> https://example.com/ (zugegriffen 1.5.2021).
