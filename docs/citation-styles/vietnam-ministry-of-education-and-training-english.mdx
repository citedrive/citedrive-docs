...
When you 're tasked by using "Vietnam Ministry of Education and Training (English)" (BGDDT_TA) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Vietnam Ministry of Education and Training (English)

* Title: Vietnam Ministry of Education and Training (English)
* Short Title (Id): BGDDT_TA)
* Authors: Vietnam Ministry of Education and Training (English)
* Download: Vietnam Ministry of Education and Training (English)
 --->

## How can CiteDrive help you with Vietnam Ministry of Education and Training (English)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Vietnam Ministry of Education and Training (English) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/vietnam-ministry-of-education-and-training-english.svg "Choose Vietnam Ministry of Education and Training (English) in the CiteDrive App")
...
## How do I cite in  Vietnam Ministry of Education and Training (English)?
...
## How do I create a bibliography in Vietnam Ministry of Education and Training (English)?
...
!!! 2.Doe J. and Doe J.  Title #2. <https://example.com/>, accessed: 05/01/2021.
