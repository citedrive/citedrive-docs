...
When you 're tasked by using "Bursa Uludağ Üniversitesi - Sağlık Bilimleri Enstitüsü" (BUUSaglik) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Bursa Uludağ Üniversitesi - Sağlık Bilimleri Enstitüsü

* Title: Bursa Uludağ Üniversitesi - Sağlık Bilimleri Enstitüsü
* Short Title (Id): BUUSaglik)
* Authors: Bursa Uludağ Üniversitesi - Sağlık Bilimleri Enstitüsü
* Download: Bursa Uludağ Üniversitesi - Sağlık Bilimleri Enstitüsü
 --->

## How can CiteDrive help you with Bursa Uludağ Üniversitesi - Sağlık Bilimleri Enstitüsü?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Bursa Uludağ Üniversitesi - Sağlık Bilimleri Enstitüsü for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/bursa-uludag-universitesi--saglk-bilimleri-enstitusu.svg "Choose Bursa Uludağ Üniversitesi - Sağlık Bilimleri Enstitüsü in the CiteDrive App")
...
## How do I cite in  Bursa Uludağ Üniversitesi - Sağlık Bilimleri Enstitüsü?
...
## How do I create a bibliography in Bursa Uludağ Üniversitesi - Sağlık Bilimleri Enstitüsü?
