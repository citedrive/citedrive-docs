...
<!---
## About  Discovery Medicine

* Title: Discovery Medicine
* Short Title (Id): DM)
* Authors: Discovery Medicine
* Download: Discovery Medicine
 --->
...
![citedrive_style](images/discovery-medicine.svg "Choose Discovery Medicine in the CiteDrive App")
