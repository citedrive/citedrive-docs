...
# Cirugia Cardiovascular (Spanish)

When you 're tasked by using "Cirugia Cardiovascular (Spanish)" (CIRCV) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Cirugia Cardiovascular (Spanish)

* Title: Cirugia Cardiovascular (Spanish)
* Short Title (Id): CIRCV)
* Authors: Cirugia Cardiovascular (Spanish)
* Download: Cirugia Cardiovascular (Spanish)
 --->

## How can CiteDrive help you with Cirugia Cardiovascular (Spanish)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Cirugia Cardiovascular (Spanish) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/cirugia-cardiovascular-spanish.svg "Choose Cirugia Cardiovascular (Spanish) in the CiteDrive App")
...
## How do I cite in  Cirugia Cardiovascular (Spanish)?
...
## How do I create a bibliography in Cirugia Cardiovascular (Spanish)?
