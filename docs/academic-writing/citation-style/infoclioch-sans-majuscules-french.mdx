...
<!---
## About  infoclio.ch (sans majuscules, French)

* Title: infoclio.ch (sans majuscules, French)
* Short Title (Id): EER)
* Authors: infoclio.ch (sans majuscules, French)
* Download: infoclio.ch (sans majuscules, French)
 --->
...
![citedrive_style](images/infoclioch-sans-majuscules-french.svg "Choose infoclio.ch (sans majuscules, French) in the CiteDrive App")
