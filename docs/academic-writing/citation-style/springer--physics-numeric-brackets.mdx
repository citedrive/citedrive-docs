...
<!---
## About  Springer - Physics (numeric, brackets)

* Title: Springer - Physics (numeric, brackets)
* Short Title (Id): Appl Health Econ Health Policy)
* Authors: Springer - Physics (numeric, brackets)
* Download: Springer - Physics (numeric, brackets)
 --->
...
![citedrive_style](images/springer--physics-numeric-brackets.svg "Choose Springer - Physics (numeric, brackets) in the CiteDrive App")
