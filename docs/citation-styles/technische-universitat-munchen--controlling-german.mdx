...
# Technische Universität München - Controlling (German)

When you 're tasked by using "Technische Universität München - Controlling (German)" (TUM Controlling) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Technische Universität München - Controlling (German)

* Title: Technische Universität München - Controlling (German)
* Short Title (Id): TUM Controlling)
* Authors: Technische Universität München - Controlling (German)
* Download: Technische Universität München - Controlling (German)
 --->

## How can CiteDrive help you with Technische Universität München - Controlling (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Technische Universität München - Controlling (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/technische-universitat-munchen--controlling-german.svg "Choose Technische Universität München - Controlling (German) in the CiteDrive App")
...
## How do I cite in  Technische Universität München - Controlling (German)?
...
## How do I create a bibliography in Technische Universität München - Controlling (German)?
...
!!! **Bibliography**
!!! Doe, Jane (2008): Title #1, in: Imaginary Journal (3) 20081–999.
!!! Doe, Jane  /  Doe, John  (2021): Title #2, URL: https://example.com/,  01.05.2021.
!!! Doe, Jane et. al.: Title #3, in: ABC.
