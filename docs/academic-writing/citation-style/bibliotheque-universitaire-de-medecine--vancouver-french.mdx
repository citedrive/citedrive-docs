...
When you 're tasked by using "Bibliothèque universitaire de médecine - Vancouver (French)" (BiUM Vancouver) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Bibliothèque universitaire de médecine - Vancouver (French)

* Title: Bibliothèque universitaire de médecine - Vancouver (French)
* Short Title (Id): BiUM Vancouver)
* Authors: Bibliothèque universitaire de médecine - Vancouver (French)
* Download: Bibliothèque universitaire de médecine - Vancouver (French)
 --->

## How can CiteDrive help you with Bibliothèque universitaire de médecine - Vancouver (French)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Bibliothèque universitaire de médecine - Vancouver (French) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/bibliotheque-universitaire-de-medecine--vancouver-french.svg "Choose Bibliothèque universitaire de médecine - Vancouver (French) in the CiteDrive App")
...
## How do I cite in  Bibliothèque universitaire de médecine - Vancouver (French)?
...
## How do I create a bibliography in Bibliothèque universitaire de médecine - Vancouver (French)?
...
!!! 2. Doe J, Doe J. [En ligne]. Title #2 [cité le 1mai2021]. Disponible: https://example.com/
