...
# ÉTS - École de technologie supérieure (French - Canada)

When you 're tasked by using "ÉTS - École de technologie supérieure (French - Canada)" (ÉTS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  ÉTS - École de technologie supérieure (French - Canada)

* Title: ÉTS - École de technologie supérieure (French - Canada)
* Short Title (Id): ÉTS)
* Authors: ÉTS - École de technologie supérieure (French - Canada)
* Download: ÉTS - École de technologie supérieure (French - Canada)
 --->

## How can CiteDrive help you with ÉTS - École de technologie supérieure (French - Canada)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in ÉTS - École de technologie supérieure (French - Canada) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/ets--ecole-de-technologie-superieure-french--canada.svg "Choose ÉTS - École de technologie supérieure (French - Canada) in the CiteDrive App")
...
## How do I cite in  ÉTS - École de technologie supérieure (French - Canada)?
...
## How do I create a bibliography in ÉTS - École de technologie supérieure (French - Canada)?
...
!!! **Bibliography**
!!! Doe, Jane. 2008. « Title #1 ». <i>Imaginary Journal</i>, vol. 3, n<sup>o</sup>, p. 1‑999.
!!! Doe, Jane et John  Doe. [s d]. « Title #2 ». <https://example.com/>. Consulté le 1 mai 2021.
!!! Doe, Jane, John Doe et Monty Python. [s d]. « Title #3 ». <i>ABC</i>, n<sup>o</sup>.
