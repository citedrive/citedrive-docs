...
When you 're tasked by using "Anthropologie et Sociétés (French)" (Employ Respons Rights J) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Anthropologie et Sociétés (French)

* Title: Anthropologie et Sociétés (French)
* Short Title (Id): Employ Respons Rights J)
* Authors: Anthropologie et Sociétés (French)
* Download: Anthropologie et Sociétés (French)
 --->

## How can CiteDrive help you with Anthropologie et Sociétés (French)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Anthropologie et Sociétés (French) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/anthropologie-et-societes-french.svg "Choose Anthropologie et Sociétés (French) in the CiteDrive App")
...
## How do I cite in  Anthropologie et Sociétés (French)?
...
## How do I create a bibliography in Anthropologie et Sociétés (French)?
...
!!! <SPAN STYLE="FONT-VARIANT:SMALL-CAPS;">DOE</SPAN> J. ET J. <SPAN STYLE="FONT-VARIANT:SMALL-CAPS;">DOE</SPAN>, s. d. « Title #2 », site internet (https://example.com/), consulté le 1 mai 2021.
!!! <SPAN STYLE="FONT-VARIANT:SMALL-CAPS;">DOE</SPAN> J., J. <SPAN STYLE="FONT-VARIANT:SMALL-CAPS;">DOE</SPAN> ET M. <SPAN STYLE="FONT-VARIANT:SMALL-CAPS;">PYTHON</SPAN>, s. d. « Title #3 », <i>ABC</i>..
