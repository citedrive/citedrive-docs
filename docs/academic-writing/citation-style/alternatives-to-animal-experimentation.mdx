...
<!---
## About  Alternatives to Animal Experimentation

* Title: Alternatives to Animal Experimentation
* Short Title (Id): ALTEX)
* Authors: Alternatives to Animal Experimentation
* Download: Alternatives to Animal Experimentation
 --->
...
![citedrive_style](images/alternatives-to-animal-experimentation.svg "Choose Alternatives to Animal Experimentation in the CiteDrive App")
