...
When you 're tasked by using "Springer - Basic (author-date)" (JBCS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Springer - Basic (author-date)
* **Title:** Springer - Basic (author-date)
* **Type:** author-date
* **Short Title (Id):** JBCS)
* fields: , generic-base
...
## How do I cite in  Springer - Basic (author-date)?
...
## How do I create a bibliography in Springer - Basic (author-date)?
