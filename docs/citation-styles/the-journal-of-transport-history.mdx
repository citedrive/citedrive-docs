...
When you 're tasked by using "The Journal of Transport History" (JTH) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  The Journal of Transport History

* Title: The Journal of Transport History
* Short Title (Id): JTH)
* Authors: The Journal of Transport History
* Download: The Journal of Transport History
 --->

## How can CiteDrive help you with The Journal of Transport History?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in The Journal of Transport History for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/the-journal-of-transport-history.svg "Choose The Journal of Transport History in the CiteDrive App")
...
## How do I cite in  The Journal of Transport History?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Jane Doe, “Title #1”,, in , <i>Imaginary Journal</i> 3 (2008), 1–999. This, in turn, refers to the second Jane Doe and John  Doe, “Title #2”, in , <https://example.com/> [accessed 1 May 2021].
! and then to the third.  Jane Doe, John Doe and Monty Python, “Title #3”,, in , <i>ABC</i>.
...
## How do I create a bibliography in The Journal of Transport History?
...
!!! **Bibliography**
!!! Jane Doe, “Title #1”,, in , <i>Imaginary Journal</i> 3 (2008), 1–999.
!!! Jane Doe and John  Doe, “Title #2”, in , <https://example.com/> [accessed 1 May 2021].
!!! Jane Doe, John Doe and Monty Python, “Title #3”,, in , <i>ABC</i>.
