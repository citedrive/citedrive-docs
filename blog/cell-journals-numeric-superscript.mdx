...
## Details  Cell journals (numeric, superscript)
* **Title:** Cell journals (numeric, superscript)
* **Type:** numeric
...
!["Cell journals (numeric, superscript)"](images/cell-journals-numeric-superscript.svg "Choose Cell journals (numeric, superscript) in the CiteDrive App")
