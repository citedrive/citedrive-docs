...
When you 're tasked by using "Ithaque (French - Canada)" (OLC) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Ithaque (French - Canada)?
...
This sentence refers to the first item from the table. Doe, J. (2008), « Title #1 ». This, in turn, refers to the second Doe, J. et J. Doe ([s. d.]), « Title #2 ».
and then to the third.  Doe, J. ([s. d.]), « Title #3 ».
This paragraph demonstrates the clustering of citations by citing the first and third item. Doe, J. (2008), « Title #1 » ; Doe, J. ([s. d.]), « Title #3 ».

:::

## How do I create a bibliography in Ithaque (French - Canada)?
...
Doe, J. et J. Doe ([s. d.]), « Title #2 », {"<"}https://example.com/{">"}, consulté le 1 mai 2021.

Doe, J. ([s. d.]), « Title #3 », <i>ABC</i>,.
