...
# historia.scribere (German)

When you 're tasked by using "historia.scribere (German)" (ULg) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  historia.scribere (German)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Jane Doe, Title #1, in: Imaginary Journal 3 (2008), S. 1–999. This, in turn, refers to the second Jane Doe, John  Doe, Title #2, [https://example.com/], eingesehen 1.5.2021.
...
## How do I create a bibliography in historia.scribere (German)?
...
!!! Doe, Jane, Doe, John , Title #2, [https://example.com/], eingesehen 1.5.2021.
