...
When you 're tasked by using "Interactive CardioVascular and Thoracic Surgery" (ICVTS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Interactive CardioVascular and Thoracic Surgery

* Title: Interactive CardioVascular and Thoracic Surgery
* Short Title (Id): ICVTS)
* Authors: Interactive CardioVascular and Thoracic Surgery
* Download: Interactive CardioVascular and Thoracic Surgery
 --->

## How can CiteDrive help you with Interactive CardioVascular and Thoracic Surgery?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Interactive CardioVascular and Thoracic Surgery for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/interactive-cardiovascular-and-thoracic-surgery.svg "Choose Interactive CardioVascular and Thoracic Surgery in the CiteDrive App")
...
## How do I cite in  Interactive CardioVascular and Thoracic Surgery?
...
## How do I create a bibliography in Interactive CardioVascular and Thoracic Surgery?
...
!!! [2] Doe J, Doe J. Title #2.  [accessed 2021] .Available from https://example.com/.
