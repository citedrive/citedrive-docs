      ...
      if (direction === 'rtl') {
        postCssOptions.plugins.push(_postcss.default.plugin('RtlCssPlugin', () => {
          ...
          return function (root) {
            ...
            const file = root === null || root === void 0 ? void 0 : (_root$source = root.source) === null || _root$source === void 0 ? void 0 : _root$source.input.file; // Skip Infima as we are using the its RTL version.
