...
When you 're tasked by using "Austrian Legal (German - Austria)" (Comput Manag Sci) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Austrian Legal (German - Austria)

* Title: Austrian Legal (German - Austria)
* Short Title (Id): Comput Manag Sci)
* Authors: Austrian Legal (German - Austria)
* Download: Austrian Legal (German - Austria)
 --->

## How can CiteDrive help you with Austrian Legal (German - Austria)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Austrian Legal (German - Austria) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/austrian-legal-german--austria.svg "Choose Austrian Legal (German - Austria) in the CiteDrive App")
...
## How do I cite in  Austrian Legal (German - Austria)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. <i>Doe</i>, Title #1, Imaginary Journal 2008, 1–999. This, in turn, refers to the second <i>Doe/Doe</i>, Title #2, <https://example.com/>.
! and then to the third.  <i>Doe/Doe/Python</i>, Title #3, ABC.
! This paragraph demonstrates the clustering of citations by citing the first and third item. <i>Doe</i>, Imaginary Journal 2008, 1–999; <i>Doe/Doe/Python</i>, ABC.



## How do I create a bibliography in Austrian Legal (German - Austria)?
...
!!! **Bibliography**
!!! <i>Doe</i>, Title #1, Imaginary Journal 2008, 1–999
