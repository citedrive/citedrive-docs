...
When you 're tasked by using "Ephemerides Theologicae Lovanienses" (ETL) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Ephemerides Theologicae Lovanienses

* Title: Ephemerides Theologicae Lovanienses
* Short Title (Id): ETL)
* Authors: Ephemerides Theologicae Lovanienses
* Download: Ephemerides Theologicae Lovanienses
 --->

## How can CiteDrive help you with Ephemerides Theologicae Lovanienses?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Ephemerides Theologicae Lovanienses for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/ephemerides-theologicae-lovanienses.svg "Choose Ephemerides Theologicae Lovanienses in the CiteDrive App")
...
## How do I cite in  Ephemerides Theologicae Lovanienses?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. <span style="font-variant:small-caps;">J. Doe</span>, <i>Title #1</i>, in <i>Imaginary Journal</i> 3 (2008), 1–999. This, in turn, refers to the second <span style="font-variant:small-caps;">J. Doe — J. Doe</span>, <i>Title #2</i>, n.d., [cited May 1, 2021]. Online: https://example.com/.
! and then to the third.  <span style="font-variant:small-caps;">J. Doe — J. Doe — M. Python</span>, <i>Title #3</i>, in <i>ABC</i> (n.d.).
...
## How do I create a bibliography in Ephemerides Theologicae Lovanienses?
