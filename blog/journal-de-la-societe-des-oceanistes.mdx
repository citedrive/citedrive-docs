...
tags: [author-date, social_science, science]
---

When you 're tasked by using "Journal de la Société des Océanistes" (JSO) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Journal de la Société des Océanistes
* **Title:** Journal de la Société des Océanistes
* **Type:** author-date
* **Short Title (Id):** JSO)
* fields: , social_science, science

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Journal de la Société des Océanistes? **
...
!["Journal de la Société des Océanistes"](images/journal-de-la-societe-des-oceanistes.svg "Choose Journal de la Société des Océanistes in the CiteDrive App")
...
## How do I cite in  Journal de la Société des Océanistes?
...
## How do I create a bibliography in Journal de la Société des Océanistes?
...
<span style={{"font-variant":"small-caps"}}>Doe</span> Jane,  2008. Title #1. <i>Imaginary Journal</i>, 3, pp. 1–999.

<span style={{"font-variant":"small-caps"}}>Doe</span> Jane and John  <span style={{"font-variant":"small-caps"}}>Doe</span>,  2021. Title #2. [online].  [viewed 1 May 2021] Available from: https://example.com/.
