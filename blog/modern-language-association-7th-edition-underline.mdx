...
When you 're tasked by using "Modern Language Association 7th edition (underline)" (MLA) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Modern Language Association 7th edition (underline)
* **Title:** Modern Language Association 7th edition (underline)
* **Type:** author
* **Short Title (Id):** MLA)
* fields: , generic-base
...
## How do I cite in  Modern Language Association 7th edition (underline)?
...
This sentence refers to the first item from the table. (Doe, “Title #1”) This, in turn, refers to the second (Doe &amp; Doe, “Title #2”)
and then to the third.  (Doe, Doe, &amp; Python, “Title #3”)
...
## How do I create a bibliography in Modern Language Association 7th edition (underline)?
...
Doe, Jane. “Title #1”. <u>Imaginary Journal</u> 3 (2008): 1–999.

Doe, Jane, and John  Doe. “Title #2”. 1 May 2021 {"<"}https://example.com/{">"}.

Doe, Jane, John Doe, and Monty Python. “Title #3”. <u>ABC</u>.
