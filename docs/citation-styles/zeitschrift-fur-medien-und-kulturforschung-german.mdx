...
# Zeitschrift für Medien- und Kulturforschung (German)

When you 're tasked by using "Zeitschrift für Medien- und Kulturforschung (German)" (ZMK) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Zeitschrift für Medien- und Kulturforschung (German)

* Title: Zeitschrift für Medien- und Kulturforschung (German)
* Short Title (Id): ZMK)
* Authors: Zeitschrift für Medien- und Kulturforschung (German)
* Download: Zeitschrift für Medien- und Kulturforschung (German)
 --->

## How can CiteDrive help you with Zeitschrift für Medien- und Kulturforschung (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Zeitschrift für Medien- und Kulturforschung (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/zeitschrift-fur-medien-und-kulturforschung-german.svg "Choose Zeitschrift für Medien- und Kulturforschung (German) in the CiteDrive App")
...
## How do I cite in  Zeitschrift für Medien- und Kulturforschung (German)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Jane Doe: Title #1, in: Imaginary journal 3 (2008), 1–999. This, in turn, refers to the second Jane Doe und John  Doe: Title #2, o. J., unter: https://example.com/ (1.5.2021).
! and then to the third.  Jane Doe, John Doe und Monty Python: Title #3, in: ABC (o. J.).
! This paragraph demonstrates the clustering of citations by citing the first and third item. Doe: Title #1; Doe, Doe und Python: Title #3.



## How do I create a bibliography in Zeitschrift für Medien- und Kulturforschung (German)?
