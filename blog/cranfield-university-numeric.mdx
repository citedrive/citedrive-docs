---
title: Cranfield University (numeric)
author: Jospeh Moe
...
When you 're tasked by using "Cranfield University (numeric)" (Patient) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Cranfield University (numeric)
* **Title:** Cranfield University (numeric)
* **Type:** numeric
...
## How do I cite in  Cranfield University (numeric)?
...
## How do I create a bibliography in Cranfield University (numeric)?
...
2. Doe J, Doe J. Title #2. Available at: https://example.com/ (Accessed: 1May2021)
