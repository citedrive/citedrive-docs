...
# Cite Them Right 10th edition - Harvard (no "et al.")

When you 're tasked by using "Cite Them Right 10th edition - Harvard (no "et al.")" (Acta Med Peru) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Cite Them Right 10th edition - Harvard (no "et al.")

* Title: Cite Them Right 10th edition - Harvard (no "et al.")
* Short Title (Id): Acta Med Peru)
* Authors: Cite Them Right 10th edition - Harvard (no "et al.")
* Download: Cite Them Right 10th edition - Harvard (no "et al.")
 --->

## How can CiteDrive help you with Cite Them Right 10th edition - Harvard (no "et al.")?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Cite Them Right 10th edition - Harvard (no "et al.") for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/cite-them-right-10th-edition--harvard-no-et-al.svg "Choose Cite Them Right 10th edition - Harvard (no "et al.") in the CiteDrive App")
...
## How do I cite in  Cite Them Right 10th edition - Harvard (no "et al.")?
...
## How do I create a bibliography in Cite Them Right 10th edition - Harvard (no "et al.")?
