...
<!---
## About  Modern Phytomorphology

* Title: Modern Phytomorphology
* Short Title (Id): ModPhytomorphol)
* Authors: Modern Phytomorphology
* Download: Modern Phytomorphology
 --->
...
![citedrive_style](images/modern-phytomorphology.svg "Choose Modern Phytomorphology in the CiteDrive App")
