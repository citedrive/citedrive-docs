---
title: Cambridge University Press (numeric)
author: Jospeh Moe
...
When you 're tasked by using "Cambridge University Press (numeric)" (memo) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Cambridge University Press (numeric)
* **Title:** Cambridge University Press (numeric)
* **Type:** numeric
* **Short Title (Id):** memo)
* fields: , generic-base
...
## How do I cite in  Cambridge University Press (numeric)?
...
## How do I create a bibliography in Cambridge University Press (numeric)?
...
2.J. Doe &amp; J. Doe, Title #2. (n.d.). https://example.com/ (accessed May 1, 2021).

3.J. Doe, J. Doe&amp; M. Python, Title #3. <i>ABC</i>, (n.d.).
