---
title: Building Structure (Chinese)
author: Jospeh Moe
...
When you 're tasked by using "Building Structure (Chinese)" (AIAA) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Building Structure (Chinese)
* **Title:** Building Structure (Chinese)
* **Type:** numeric
* **Short Title (Id):** AIAA)
...
## How do I cite in  Building Structure (Chinese)?
...
## How do I create a bibliography in Building Structure (Chinese)?
...
[1]Doe Jane. Title #1[J]. Imaginary Journal,2008, 3:1–999.

[2]Doe Jane,Doe John . Title #2[J]. ; https://example.com/.

[3]Doe Jane 等. Title #3[J]. ABC.
