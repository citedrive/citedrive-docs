...
When you 're tasked by using "Nature Neuroscience (brief communications)" (Nat Resour Res) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Nature Neuroscience (brief communications)

* Title: Nature Neuroscience (brief communications)
* Short Title (Id): Nat Resour Res)
* Authors: Nature Neuroscience (brief communications)
* Download: Nature Neuroscience (brief communications)
 --->

## How can CiteDrive help you with Nature Neuroscience (brief communications)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Nature Neuroscience (brief communications) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/nature-neuroscience-brief-communications.svg "Choose Nature Neuroscience (brief communications) in the CiteDrive App")
...
## How do I cite in  Nature Neuroscience (brief communications)?
...
## How do I create a bibliography in Nature Neuroscience (brief communications)?
...
!!! **Bibliography**
!!! 1.Doe, J. <i>Imaginary Journal</i> <b>3</b>, 1–999 (2008).
!!! 2.Doe, J. &amp; Doe, J.at <https://example.com/>
