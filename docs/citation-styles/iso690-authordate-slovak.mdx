...
<!---
## About  ISO-690 (author-date, Slovak)

* Title: ISO-690 (author-date, Slovak)
* Short Title (Id): AIP)
* Authors: ISO-690 (author-date, Slovak)
* Download: ISO-690 (author-date, Slovak)
 --->
...
![citedrive_style](images/iso690-authordate-slovak.svg "Choose ISO-690 (author-date, Slovak) in the CiteDrive App")
