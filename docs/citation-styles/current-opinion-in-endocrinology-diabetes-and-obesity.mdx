...
When you 're tasked by using "Current Opinion in Endocrinology, Diabetes and Obesity" (LAS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Current Opinion in Endocrinology, Diabetes and Obesity

* Title: Current Opinion in Endocrinology, Diabetes and Obesity
* Short Title (Id): LAS)
* Authors: Current Opinion in Endocrinology, Diabetes and Obesity
* Download: Current Opinion in Endocrinology, Diabetes and Obesity
 --->

## How can CiteDrive help you with Current Opinion in Endocrinology, Diabetes and Obesity?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Current Opinion in Endocrinology, Diabetes and Obesity for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/current-opinion-in-endocrinology-diabetes-and-obesity.svg "Choose Current Opinion in Endocrinology, Diabetes and Obesity in the CiteDrive App")
...
## How do I cite in  Current Opinion in Endocrinology, Diabetes and Obesity?
...
## How do I create a bibliography in Current Opinion in Endocrinology, Diabetes and Obesity?
...
!!! **Bibliography**
!!! <b>1</b>.Doe J.. Title #1. Imaginary Journal 2008; 3:1–999.
!!! <b>2</b>.Doe J, Doe J.. Title #2.  https://example.com/ (1 May 2021, date last accessed)..
!!! <b>3</b>.Doe J, Doe J, Python M.. Title #3. ABC.
