...
# ISO-690 (full note, Czech)

When you 're tasked by using "ISO-690 (full note, Czech)" (ASCSA) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  ISO-690 (full note, Czech)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. DOE, Jane. Title #1. <i>Imaginary Journal</i>. 2008, roč. 3. This, in turn, refers to the second DOE, Jane a John  DOE. Title #2. In:  [cit. 01.05.2021]. Dostupné z: https://example.com/
! and then to the third.  DOE, Jane, John DOE a Monty PYTHON. Title #3. <i>ABC</i>.
! This paragraph demonstrates the clustering of citations by citing the first and third item. DOE, Jane. <i>Title #1</i>.; DOE, Jane, John DOE a Monty PYTHON. <i>Title #3</i>.



## How do I create a bibliography in ISO-690 (full note, Czech)?
...
!!! DOE, Jane a John  DOE. Title #2. In: , s.  [cit. 01.05.2021]. Dostupné z: https://example.com/
!!! DOE, Jane, John DOE a Monty PYTHON. Title #3. <i>ABC</i>, s. .
