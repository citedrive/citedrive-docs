...
When you 're tasked by using "Studii Teologice" (J Ethol) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Studii Teologice?
...
This sentence refers to the first item from the table. Jane <span style={{"font-variant":"small-caps"}}>Doe</span>, “Title #1”, in: <i>Imaginary Journal</i>, 3 (2008). This, in turn, refers to the second Jane <span style={{"font-variant":"small-caps"}}>Doe</span>, John  <span style={{"font-variant":"small-caps"}}>Doe</span>, “Title #2”, {"<"}https://example.com/{">"}, 1 may 2021.
and then to the third.  Jane <span style={{"font-variant":"small-caps"}}>Doe</span> et al., “Title #3”, in: <i>ABC</i>.
This paragraph demonstrates the clustering of citations by citing the first and third item. J. <span style={{"font-variant":"small-caps"}}>Doe</span>, “Title #1”; J. <span style={{"font-variant":"small-caps"}}>Doe</span> et al., “Title #3”.

:::

## How do I create a bibliography in Studii Teologice?
