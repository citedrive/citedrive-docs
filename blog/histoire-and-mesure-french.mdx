...
When you 're tasked by using "Histoire & Mesure (French)" (JRS) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Histoire & Mesure (French)
* **Title:** Histoire & Mesure (French)
* **Type:** note
* **Short Title (Id):** JRS)
...
## How do I cite in  Histoire & Mesure (French)?
...
This sentence refers to the first item from the table. Doe, J., 2008. This, in turn, refers to the second Doe, J. et J. Doe,  consulté le  1 mai 2021.
and then to the third.  Doe, J., J. Doeet M. Python.
This paragraph demonstrates the clustering of citations by citing the first and third item. Doe, J., « Title #1 », <i>op. cit.</i>. ; Doe, J., J. Doeet M. Python, « Title #3 », <i>op. cit.</i>..

:::

## How do I create a bibliography in Histoire & Mesure (French)?
...
Doe, Jane &amp; John  Doe, <i>Title #2</i>, <u>https://example.com/</u>,  consulté le  1 mai 2021.
