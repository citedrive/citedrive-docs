...
<!---
## About  Elsevier (numeric, without titles)

* Title: Elsevier (numeric, without titles)
* Short Title (Id): J Econ Inequal)
* Authors: Elsevier (numeric, without titles)
* Download: Elsevier (numeric, without titles)
 --->
...
![citedrive_style](images/elsevier-numeric-without-titles.svg "Choose Elsevier (numeric, without titles) in the CiteDrive App")
