---
title: Cahiers d''ethnomusicologie (French)
author: Jospeh Moe
...
When you 're tasked by using "Cahiers d''ethnomusicologie (French)" (JCM) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Cahiers d''ethnomusicologie (French)
* **Title:** Cahiers d''ethnomusicologie (French)
* **Type:** author-date
* **Short Title (Id):** JCM)
* fields: , humanities
...
## How do I cite in  Cahiers d''ethnomusicologie (French)?
...
## How do I create a bibliography in Cahiers d''ethnomusicologie (French)?
...
DOE Jane2008« Title #1 ». <i>Imaginary Journal</i> 3 : 1‑999. 

DOE Jane et John  DOE[sans date]« Title #2 ». .  [Consulté le 1 mai 2021]. Disponible à l'adresse : https://example.com/. 

DOE Jane, John DOE et Monty PYTHON[sans date]« Title #3 ». <i>ABC</i> 
