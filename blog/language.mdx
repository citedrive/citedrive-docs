...
When you 're tasked by using "Language" (Curr Neurol Neurosci Rep) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I create a bibliography in Language?
...
<span style={{"font-variant":"small-caps"}}>Doe</span>, <span style={{"font-variant":"small-caps"}}>Jane</span>. 2008. Title #1. <i>Imaginary Journal</i> 3..1–999.

<span style={{"font-variant":"small-caps"}}>Doe</span>, <span style={{"font-variant":"small-caps"}}>Jane</span>; and <span style={{"font-variant":"small-caps"}}>John </span> <span style={{"font-variant":"small-caps"}}>Doe</span>. Title #2. https://example.com/.

<span style={{"font-variant":"small-caps"}}>Doe</span>, <span style={{"font-variant":"small-caps"}}>Jane</span>; <span style={{"font-variant":"small-caps"}}>John</span> <span style={{"font-variant":"small-caps"}}>Doe</span>; and <span style={{"font-variant":"small-caps"}}>Monty</span> <span style={{"font-variant":"small-caps"}}>Python</span>. Title #3. <i>ABC</i>.
