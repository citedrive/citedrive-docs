...
When you 're tasked by using "cultural geographies" (cg) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  cultural geographies?
...
This sentence refers to the first item from the table. J. Doe, ‘Title #1’, Imaginary Journal III (2008), pp. 1–999 This, in turn, refers to the second J. Doe and J. Doe, Title #2 (n.d.)
and then to the third.  J. Doe, J. Doe and M. Python, ‘Title #3’, ABC (n.d.)
This paragraph demonstrates the clustering of citations by citing the first and third item. J. Doe; J. Doe, J. Doe and M. Python

:::

## How do I create a bibliography in cultural geographies?
...
J. Doe and J. Doe, Title #2, n.d.. Available at: https://example.com/. [Accessed: 01-May-2021].
