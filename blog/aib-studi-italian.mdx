...
When you 're tasked by using "AIB studi (Italian)" (Drug Deliv. and Transl. Res.) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  AIB studi (Italian)?
...
This sentence refers to the first item from the table. Jane Doe, <i>Title #1</i>, «Imaginary Journal», 3 (2008), p. 1–999. This, in turn, refers to the second Jane Doe, John  Doe, <i>Title #2</i>{"<"}https://example.com/{">"}
and then to the third.  Jane Doe, John Doe, Monty Python, <i>Title #3</i>, «ABC»
This paragraph demonstrates the clustering of citations by citing the first and third item. Jane Doe, <i>Title #1</i>, cit.; Jane Doe, John Doe, Monty Python, <i>Title #3</i>, cit.

:::

## How do I create a bibliography in AIB studi (Italian)?
