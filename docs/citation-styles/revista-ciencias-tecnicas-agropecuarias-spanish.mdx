...
# Revista Ciencias Técnicas Agropecuarias (Spanish)

When you 're tasked by using "Revista Ciencias Técnicas Agropecuarias (Spanish)" (rcta) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Revista Ciencias Técnicas Agropecuarias (Spanish)

* Title: Revista Ciencias Técnicas Agropecuarias (Spanish)
* Short Title (Id): rcta)
* Authors: Revista Ciencias Técnicas Agropecuarias (Spanish)
* Download: Revista Ciencias Técnicas Agropecuarias (Spanish)
 --->

## How can CiteDrive help you with Revista Ciencias Técnicas Agropecuarias (Spanish)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Revista Ciencias Técnicas Agropecuarias (Spanish) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/revista-ciencias-tecnicas-agropecuarias-spanish.svg "Choose Revista Ciencias Técnicas Agropecuarias (Spanish) in the CiteDrive App")
...
## How do I cite in  Revista Ciencias Técnicas Agropecuarias (Spanish)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. (Doe, 2008) This, in turn, refers to the second (Doe y Doe, [s.f])
! and then to the third.  (Doe, [s.f])
! This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe, 2008; Doe, [s.f])



## How do I create a bibliography in Revista Ciencias Técnicas Agropecuarias (Spanish)?
...
!!! DOE, J.; DOE, J.:  <i>Title #2</i>, <i>[en línea] </i><i>Disponible en: https://example.com/</i> <i> [Consulta: 1 de mayo de 2021]</i>. 
