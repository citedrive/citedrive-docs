...
When you 're tasked by using "The Journal of Pure and Applied Chemistry Research" (JPACR) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  The Journal of Pure and Applied Chemistry Research

* Title: The Journal of Pure and Applied Chemistry Research
* Short Title (Id): JPACR)
* Authors: The Journal of Pure and Applied Chemistry Research
* Download: The Journal of Pure and Applied Chemistry Research
 --->

## How can CiteDrive help you with The Journal of Pure and Applied Chemistry Research?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in The Journal of Pure and Applied Chemistry Research for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/the-journal-of-pure-and-applied-chemistry-research.svg "Choose The Journal of Pure and Applied Chemistry Research in the CiteDrive App")
...
## How do I cite in  The Journal of Pure and Applied Chemistry Research?
...
## How do I create a bibliography in The Journal of Pure and Applied Chemistry Research?
...
!!! **Bibliography**
!!! (1) Doe, J.. <i>Imaginary Journal</i> <b>2008</b>, <i>3</i>, 1–999.
!!! (2) Doe, J., Doe, J.. Title #2 https://example.com/ (Accessed date May 1,  2021).
