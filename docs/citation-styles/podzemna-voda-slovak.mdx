...
<!---
## About  Podzemná voda (Slovak)

* Title: Podzemná voda (Slovak)
* Short Title (Id): Insights Imaging)
* Authors: Podzemná voda (Slovak)
* Download: Podzemná voda (Slovak)
 --->
...
![citedrive_style](images/podzemna-voda-slovak.svg "Choose Podzemná voda (Slovak) in the CiteDrive App")
