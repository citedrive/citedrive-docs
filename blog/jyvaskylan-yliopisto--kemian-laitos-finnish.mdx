---
title: Jyväskylän yliopisto - Kemian laitos (Finnish)
author: Jospeh Moe
...
When you 're tasked by using "Jyväskylän yliopisto - Kemian laitos (Finnish)" (JYU-Kem) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Jyväskylän yliopisto - Kemian laitos (Finnish)
* **Title:** Jyväskylän yliopisto - Kemian laitos (Finnish)
* **Type:** numeric
* **Short Title (Id):** JYU-Kem)
* fields: , chemistry

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with Jyväskylän yliopisto - Kemian laitos (Finnish)? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Jyväskylän yliopisto - Kemian laitos (Finnish) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Jyväskylän yliopisto - Kemian laitos (Finnish)"](images/jyvaskylan-yliopisto--kemian-laitos-finnish.svg "Choose Jyväskylän yliopisto - Kemian laitos (Finnish) in the CiteDrive App")
...
## How do I cite in  Jyväskylän yliopisto - Kemian laitos (Finnish)?
...
## How do I create a bibliography in Jyväskylän yliopisto - Kemian laitos (Finnish)?
...
2.Doe, J. ja Doe, J., Title #2, https://example.com/ (1.5.2021).

3.Doe, J.; Doe, J. ja Python, M., Title #3, <i>ABC</i>.
