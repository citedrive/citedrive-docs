...
<!---
## About  natbib - plainnat (author-date)

* Title: natbib - plainnat (author-date)
* Short Title (Id): Insights Imaging)
* Authors: natbib - plainnat (author-date)
* Download: natbib - plainnat (author-date)
 --->
...
![citedrive_style](images/natbib--plainnat-authordate.svg "Choose natbib - plainnat (author-date) in the CiteDrive App")
