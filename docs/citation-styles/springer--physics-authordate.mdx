...
<!---
## About  Springer - Physics (author-date)

* Title: Springer - Physics (author-date)
* Short Title (Id): HEDU)
* Authors: Springer - Physics (author-date)
* Download: Springer - Physics (author-date)
 --->
...
![citedrive_style](images/springer--physics-authordate.svg "Choose Springer - Physics (author-date) in the CiteDrive App")
