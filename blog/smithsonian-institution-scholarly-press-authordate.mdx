---
title: Smithsonian Institution Scholarly Press (author-date)
author: Jospeh Moe
...
When you 're tasked by using "Smithsonian Institution Scholarly Press (author-date)" (SISP) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Smithsonian Institution Scholarly Press (author-date)
* **Title:** Smithsonian Institution Scholarly Press (author-date)
* **Type:** author-date
* **Short Title (Id):** SISP)
* fields: , generic-base
...
** How can CiteDrive help you with Smithsonian Institution Scholarly Press (author-date)? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Smithsonian Institution Scholarly Press (author-date) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Smithsonian Institution Scholarly Press (author-date)"](images/smithsonian-institution-scholarly-press-authordate.svg "Choose Smithsonian Institution Scholarly Press (author-date) in the CiteDrive App")
...
## How do I cite in  Smithsonian Institution Scholarly Press (author-date)?
...
## How do I create a bibliography in Smithsonian Institution Scholarly Press (author-date)?
...
Doe, J., and Doe, J..  (n.d.). “Title #2”. https://example.com/ (accessed 1 May 2021).
