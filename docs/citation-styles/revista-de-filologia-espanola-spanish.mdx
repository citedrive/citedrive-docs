...
# Revista de Filología Española (Spanish)

When you 're tasked by using "Revista de Filología Española (Spanish)" (RFE parentético) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Revista de Filología Española (Spanish)

* Title: Revista de Filología Española (Spanish)
* Short Title (Id): RFE parentético)
* Authors: Revista de Filología Española (Spanish)
* Download: Revista de Filología Española (Spanish)
 --->

## How can CiteDrive help you with Revista de Filología Española (Spanish)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Revista de Filología Española (Spanish) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/revista-de-filologia-espanola-spanish.svg "Choose Revista de Filología Española (Spanish) in the CiteDrive App")
...
## How do I cite in  Revista de Filología Española (Spanish)?
...
! This paragraph demonstrates the clustering of citations by citing the first and third item. (Doe, 2008; Doe, Doe &amp; Python, s. f.)



## How do I create a bibliography in Revista de Filología Española (Spanish)?
...
!!! Doe, J. y J. Doe (s. f.): «Title #2»,  en línea:  <https://example.com/> [accedido: 01/05/2021].
!!! Doe, J., J. Doe y M. Python (s. f.): «Title #3»,  <i>ABC</i>, p. .
