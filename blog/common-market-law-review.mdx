...
When you 're tasked by using "Common Market Law Review" (CMLR) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Common Market Law Review
* **Title:** Common Market Law Review
* **Type:** note
* **Short Title (Id):** CMLR)
* fields: , law
...
## How do I cite in  Common Market Law Review?
...
This sentence refers to the first item from the table. Doe, “Title #1”, 3 <i>Imaginary Journal</i>  (2008), 1–999. This, in turn, refers to the second Doe and Doe, Title #2, {"<"}https://example.com/{">"}.
and then to the third.  Doe, Doeand Python, “Title #3”, <i>ABC</i> .
This paragraph demonstrates the clustering of citations by citing the first and third item. Doe, “Title #1”, 3 <i>Imaginary Journal</i>  (2008), 1–999; Doe, Doeand Python, “Title #3”, <i>ABC</i> .

:::

## How do I create a bibliography in Common Market Law Review?
