...
When you 're tasked by using "University of the West of England (Bristol) - Harvard" (UWE Bristol) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  University of the West of England (Bristol) - Harvard

* Title: University of the West of England (Bristol) - Harvard
* Short Title (Id): UWE Bristol)
* Authors: University of the West of England (Bristol) - Harvard
* Download: University of the West of England (Bristol) - Harvard
 --->

## How can CiteDrive help you with University of the West of England (Bristol) - Harvard?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in University of the West of England (Bristol) - Harvard for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/university-of-the-west-of-england-bristol--harvard.svg "Choose University of the West of England (Bristol) - Harvard in the CiteDrive App")
...
## How do I cite in  University of the West of England (Bristol) - Harvard?
...
## How do I create a bibliography in University of the West of England (Bristol) - Harvard?
...
!!! Doe, J. and Doe, J. (no date) <i>Title #2</i>. Available from: https://example.com/ [Accessed 1 May 2021].
