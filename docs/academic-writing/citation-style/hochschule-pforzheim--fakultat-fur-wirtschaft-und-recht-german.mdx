...
When you 're tasked by using "Hochschule Pforzheim - Fakultät für Wirtschaft und Recht (German)" (Electron Markets) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Hochschule Pforzheim - Fakultät für Wirtschaft und Recht (German)

* Title: Hochschule Pforzheim - Fakultät für Wirtschaft und Recht (German)
* Short Title (Id): Electron Markets)
* Authors: Hochschule Pforzheim - Fakultät für Wirtschaft und Recht (German)
* Download: Hochschule Pforzheim - Fakultät für Wirtschaft und Recht (German)
 --->

## How can CiteDrive help you with Hochschule Pforzheim - Fakultät für Wirtschaft und Recht (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Hochschule Pforzheim - Fakultät für Wirtschaft und Recht (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/hochschule-pforzheim--fakultat-fur-wirtschaft-und-recht-german.svg "Choose Hochschule Pforzheim - Fakultät für Wirtschaft und Recht (German) in the CiteDrive App")
...
## How do I cite in  Hochschule Pforzheim - Fakultät für Wirtschaft und Recht (German)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Doe (2008) This, in turn, refers to the second Doe; Doe (URL)
...
## How do I create a bibliography in Hochschule Pforzheim - Fakultät für Wirtschaft und Recht (German)?
