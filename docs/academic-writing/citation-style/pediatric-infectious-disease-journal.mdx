...
<!---
## About  Pediatric Infectious Disease Journal

* Title: Pediatric Infectious Disease Journal
* Short Title (Id): PIDJ)
* Authors: Pediatric Infectious Disease Journal
* Download: Pediatric Infectious Disease Journal
 --->
...
![citedrive_style](images/pediatric-infectious-disease-journal.svg "Choose Pediatric Infectious Disease Journal in the CiteDrive App")
