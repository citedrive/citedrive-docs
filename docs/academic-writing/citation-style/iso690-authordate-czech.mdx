...
<!---
## About  ISO-690 (author-date, Czech)

* Title: ISO-690 (author-date, Czech)
* Short Title (Id): Curr Bladder Dysfunct Rep)
* Authors: ISO-690 (author-date, Czech)
* Download: ISO-690 (author-date, Czech)
 --->
...
![citedrive_style](images/iso690-authordate-czech.svg "Choose ISO-690 (author-date, Czech) in the CiteDrive App")
