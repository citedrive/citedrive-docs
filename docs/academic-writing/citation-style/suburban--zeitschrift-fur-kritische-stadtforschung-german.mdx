...
# sub_urban - Zeitschrift für kritische Stadtforschung (German)

When you 're tasked by using "sub_urban - Zeitschrift für kritische Stadtforschung (German)" (AGE) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  sub_urban - Zeitschrift für kritische Stadtforschung (German)
* **Title:** sub_urban - Zeitschrift für kritische Stadtforschung (German)
* **Short Title (Id):** AGE)
* **fields:** social_science

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with sub_urban - Zeitschrift für kritische Stadtforschung (German)? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in sub_urban - Zeitschrift für kritische Stadtforschung (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["sub_urban - Zeitschrift für kritische Stadtforschung (German)"](images/suburban--zeitschrift-fur-kritische-stadtforschung-german.svg "Choose sub_urban - Zeitschrift für kritische Stadtforschung (German) in the CiteDrive App")
...
## How do I cite in  sub_urban - Zeitschrift für kritische Stadtforschung (German)?
...
## How do I create a bibliography in sub_urban - Zeitschrift für kritische Stadtforschung (German)?
