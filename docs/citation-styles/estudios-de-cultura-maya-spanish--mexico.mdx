...
When you 're tasked by using "Estudios de Cultura Maya (Spanish - Mexico)" (GCEE) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Estudios de Cultura Maya (Spanish - Mexico)

* Title: Estudios de Cultura Maya (Spanish - Mexico)
* Short Title (Id): GCEE)
* Authors: Estudios de Cultura Maya (Spanish - Mexico)
* Download: Estudios de Cultura Maya (Spanish - Mexico)
 --->

## How can CiteDrive help you with Estudios de Cultura Maya (Spanish - Mexico)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Estudios de Cultura Maya (Spanish - Mexico) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/estudios-de-cultura-maya-spanish--mexico.svg "Choose Estudios de Cultura Maya (Spanish - Mexico) in the CiteDrive App")
...
## How do I cite in  Estudios de Cultura Maya (Spanish - Mexico)?
...
## How do I create a bibliography in Estudios de Cultura Maya (Spanish - Mexico)?
...
!!! Doe, J. y J. Doe“Title #2”, . <https://example.com/>.
!!! Doe, J., J. Doey M. Python“Title #3”, <i>ABC</i>.
