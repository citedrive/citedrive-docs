...
When you 're tasked by using "United Nations Conference on Trade and Development" (UNCTAD) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  United Nations Conference on Trade and Development
* **Title:** United Nations Conference on Trade and Development
* **Type:** author-date
* **Short Title (Id):** UNCTAD)
* fields: , social_science

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with United Nations Conference on Trade and Development? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in United Nations Conference on Trade and Development for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["United Nations Conference on Trade and Development"](images/united-nations-conference-on-trade-and-development.svg "Choose United Nations Conference on Trade and Development in the CiteDrive App")
...
## How do I cite in  United Nations Conference on Trade and Development?
...
## How do I create a bibliography in United Nations Conference on Trade and Development?
...
Title #2 (2021). Available at https://example.com/ (accessed 1 May 2021).
