...
When you 're tasked by using "The International Journal of Tuberculosis and Lung Disease" (IJTLD) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  The International Journal of Tuberculosis and Lung Disease

* Title: The International Journal of Tuberculosis and Lung Disease
* Short Title (Id): IJTLD)
* Authors: The International Journal of Tuberculosis and Lung Disease
* Download: The International Journal of Tuberculosis and Lung Disease
 --->

## How can CiteDrive help you with The International Journal of Tuberculosis and Lung Disease?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in The International Journal of Tuberculosis and Lung Disease for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/the-international-journal-of-tuberculosis-and-lung-disease.svg "Choose The International Journal of Tuberculosis and Lung Disease in the CiteDrive App")
...
## How do I cite in  The International Journal of Tuberculosis and Lung Disease?
...
## How do I create a bibliography in The International Journal of Tuberculosis and Lung Disease?
...
!!! 2Doe J, Doe J. Title #2. https://example.com/ (accessed May 1, 2021).
!!! 3Doe J, Doe J, Python M. Title #3. ABC [Epub ahead of print].
