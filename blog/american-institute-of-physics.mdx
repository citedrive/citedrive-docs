...
When you 're tasked by using "American Institute of Physics" (AIP) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  American Institute of Physics
* **Title:** American Institute of Physics
* **Type:** numeric
* **Short Title (Id):** AIP)
* fields: , physics
...
## How do I cite in  American Institute of Physics?
...
## How do I create a bibliography in American Institute of Physics?
...
<sup>1</sup> J. Doe, Imaginary Journal <b>3</b>, 1 (2008).

<sup>2</sup> J. Doe and J. Doe, (n.d.).

<sup>3</sup> J. Doe, J. Doe, and M. Python, ABC (n.d.).
