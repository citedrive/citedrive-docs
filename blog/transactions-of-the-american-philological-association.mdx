---
title: Transactions of the American Philological Association
author: Jospeh Moe
...
When you 're tasked by using "Transactions of the American Philological Association" (TAPA) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Transactions of the American Philological Association
* **Title:** Transactions of the American Philological Association
* **Type:** author-date
* **Short Title (Id):** TAPA)
* fields: , linguistics
...
** How can CiteDrive help you with Transactions of the American Philological Association? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Transactions of the American Philological Association for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["Transactions of the American Philological Association"](images/transactions-of-the-american-philological-association.svg "Choose Transactions of the American Philological Association in the CiteDrive App")
...
## How do I cite in  Transactions of the American Philological Association?
...
## How do I create a bibliography in Transactions of the American Philological Association?
...
Doe, J.and Doe, J.. 2021. “Title #2”. Accessed May 1. https://example.com/.
