...
tags: [author-date, psychology, medicine]
---

When you 're tasked by using "The International Journal of Psychoanalysis" (J. Plant Biochem. Biotechnol.) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  The International Journal of Psychoanalysis
* **Title:** The International Journal of Psychoanalysis
* **Type:** author-date
* **Short Title (Id):** J. Plant Biochem. Biotechnol.)
* fields: , psychology, medicine

## Reference tools?
### CiteDrive - citedrive.com
** How can CiteDrive help you with The International Journal of Psychoanalysis? **
We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in The International Journal of Psychoanalysis for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


!["The International Journal of Psychoanalysis"](images/the-international-journal-of-psychoanalysis.svg "Choose The International Journal of Psychoanalysis in the CiteDrive App")
...
## How do I cite in  The International Journal of Psychoanalysis?
...
## How do I create a bibliography in The International Journal of Psychoanalysis?
...
Doe J, Doe J  Title #2Available from: https://example.com/.
