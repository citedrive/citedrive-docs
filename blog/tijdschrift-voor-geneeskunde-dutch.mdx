---
title: Tijdschrift voor Geneeskunde (Dutch)
author: Jospeh Moe
...
When you 're tasked by using "Tijdschrift voor Geneeskunde (Dutch)" (TvG) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Tijdschrift voor Geneeskunde (Dutch)
* **Title:** Tijdschrift voor Geneeskunde (Dutch)
* **Type:** numeric
* **Short Title (Id):** TvG)
* fields: , medicine
...
## How do I cite in  Tijdschrift voor Geneeskunde (Dutch)?
...
## How do I create a bibliography in Tijdschrift voor Geneeskunde (Dutch)?
...
2. Doe J, Doe J. Title #2 [Internet].  [geciteerd 1 mei 2021].. Beschikbaar op: https://example.com/
