---
title: Ausonius Éditions (French)
author: Jospeh Moe
...
When you 're tasked by using "Ausonius Éditions (French)" (Artif Life Robotics) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Ausonius Éditions (French)?
...
This sentence refers to the first item from the table. Doe 2008 This, in turn, refers to the second Doe &amp; Doe à paraître
and then to the third.  Doe à paraître
This paragraph demonstrates the clustering of citations by citing the first and third item. Doe 2008 ; Doe à paraître

:::

## How do I create a bibliography in Ausonius Éditions (French)?
...
Doe, J. et J. Doe (à paraître) : <i>Title #2</i> (https://example.com/,  consulté le 1 mai 2021).

Doe, J., J. Doe et M. Python (à paraître) : “Title #3”, <i>ABC</i>..
