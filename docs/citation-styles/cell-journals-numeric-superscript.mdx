...
When you 're tasked by using "Cell journals (numeric, superscript)" (J Struct Funct Genomics) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Cell journals (numeric, superscript)

* Title: Cell journals (numeric, superscript)
* Short Title (Id): J Struct Funct Genomics)
* Authors: Cell journals (numeric, superscript)
* Download: Cell journals (numeric, superscript)
 --->

## How can CiteDrive help you with Cell journals (numeric, superscript)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Cell journals (numeric, superscript) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/cell-journals-numeric-superscript.svg "Choose Cell journals (numeric, superscript) in the CiteDrive App")
...
## How do I cite in  Cell journals (numeric, superscript)?
...
## How do I create a bibliography in Cell journals (numeric, superscript)?
...
!!! **Bibliography**
!!! 1.Doe, J. (2008). Title #1. Imaginary Journal <i>3</i>, 1–999..
!!! 2.Doe, J., and Doe, J. Title #2. https://example.com/.
!!! 3.Doe, J., Doe, J., and Python, M. Title #3. ABC..
