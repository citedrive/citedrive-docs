...
# Zeitschrift für Parlamentsfragen (German)

When you 're tasked by using "Zeitschrift für Parlamentsfragen (German)" (ZParl) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Zeitschrift für Parlamentsfragen (German)

* Title: Zeitschrift für Parlamentsfragen (German)
* Short Title (Id): ZParl)
* Authors: Zeitschrift für Parlamentsfragen (German)
* Download: Zeitschrift für Parlamentsfragen (German)
 --->

## How can CiteDrive help you with Zeitschrift für Parlamentsfragen (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Zeitschrift für Parlamentsfragen (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/zeitschrift-fur-parlamentsfragen-german.svg "Choose Zeitschrift für Parlamentsfragen (German) in the CiteDrive App")
...
## How do I cite in  Zeitschrift für Parlamentsfragen (German)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. <i>Jane Doe</i>: Title #1, in: Imaginary Journal, 3 (2008), S. 1–999. This, in turn, refers to the second <i>Jane Doe / John  Doe</i>: Title #2.
! and then to the third.  <i>Jane Doe / John Doe / Monty Python</i>: Title #3, in: ABC, .
...
## How do I create a bibliography in Zeitschrift für Parlamentsfragen (German)?
