---
title: WHO Regional Office for Europe (numeric)
author: Jospeh Moe
...
When you 're tasked by using "WHO Regional Office for Europe (numeric)" (chicago-figures) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  WHO Regional Office for Europe (numeric)
* **Title:** WHO Regional Office for Europe (numeric)
* **Type:** numeric
...
## How do I cite in  WHO Regional Office for Europe (numeric)?
...
This paragraph demonstrates the clustering of citations by citing the first and third item. <i>(1,3)</i>

:::

## How do I create a bibliography in WHO Regional Office for Europe (numeric)?
...
2. Doe J, Doe J. Title #2 [web site]. (https://example.com/, accessed 1 May 2021).
