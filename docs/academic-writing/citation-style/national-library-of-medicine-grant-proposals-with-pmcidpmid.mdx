...
When you 're tasked by using "National Library of Medicine (grant proposals with PMCID/PMID)" (NLM) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  National Library of Medicine (grant proposals with PMCID/PMID)

* Title: National Library of Medicine (grant proposals with PMCID/PMID)
* Short Title (Id): NLM)
* Authors: National Library of Medicine (grant proposals with PMCID/PMID)
* Download: National Library of Medicine (grant proposals with PMCID/PMID)
 --->

## How can CiteDrive help you with National Library of Medicine (grant proposals with PMCID/PMID)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in National Library of Medicine (grant proposals with PMCID/PMID) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/national-library-of-medicine-grant-proposals-with-pmcidpmid.svg "Choose National Library of Medicine (grant proposals with PMCID/PMID) in the CiteDrive App")
...
## How do I cite in  National Library of Medicine (grant proposals with PMCID/PMID)?
...
## How do I create a bibliography in National Library of Medicine (grant proposals with PMCID/PMID)?
