...
# Gewerblicher Rechtsschutz und Urheberrecht (German)

When you 're tasked by using "Gewerblicher Rechtsschutz und Urheberrecht (German)" (GRUR) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Gewerblicher Rechtsschutz und Urheberrecht (German)

* Title: Gewerblicher Rechtsschutz und Urheberrecht (German)
* Short Title (Id): GRUR)
* Authors: Gewerblicher Rechtsschutz und Urheberrecht (German)
* Download: Gewerblicher Rechtsschutz und Urheberrecht (German)
 --->

## How can CiteDrive help you with Gewerblicher Rechtsschutz und Urheberrecht (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Gewerblicher Rechtsschutz und Urheberrecht (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/gewerblicher-rechtsschutz-und-urheberrecht-german.svg "Choose Gewerblicher Rechtsschutz und Urheberrecht (German) in the CiteDrive App")
...
## How do I cite in  Gewerblicher Rechtsschutz und Urheberrecht (German)?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. <i>Doe</i>, 2008, 1 This, in turn, refers to the second <i>Doe/Doe</i>, Title #2
! and then to the third.  <i>Doe/Doe/Python</i>
! This paragraph demonstrates the clustering of citations by citing the first and third item. <i>Doe</i>, 2008, 1; <i>Doe/Doe/Python</i>



## How do I create a bibliography in Gewerblicher Rechtsschutz und Urheberrecht (German)?
...
!!! **Bibliography**
!!! <i>Doe</i>, Title #1, 2008, 1
!!! <i>Doe/Doe/Python</i>, Title #3
