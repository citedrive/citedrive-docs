...
<!---
## About  JACC: Cardiovascular Imaging

* Title: JACC: Cardiovascular Imaging
* Short Title (Id): JCMG)
* Authors: JACC: Cardiovascular Imaging
* Download: JACC: Cardiovascular Imaging
 --->
...
![citedrive_style](images/jacc-cardiovascular-imaging.svg "Choose JACC: Cardiovascular Imaging in the CiteDrive App")
