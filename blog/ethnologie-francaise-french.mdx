---
title: Ethnologie française (French)
author: Jospeh Moe
...
When you 're tasked by using "Ethnologie française (French)" (J Reconstr Microsurg) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Ethnologie française (French)?
...
## How do I create a bibliography in Ethnologie française (French)?
...
<span style={{"font-variant":"small-caps"}}>Doe</span> Jane, 2008, « Title #1 », <i>Imaginary Journal</i>, vol. 3 : 1‑999.

<span style={{"font-variant":"small-caps"}}>Doe</span> Jane et <span style={{"font-variant":"small-caps"}}>Doe</span> John , [s. d.], <i>Title #2</i>, https://example.com/ (consulté le 1 mai 2021).

<span style={{"font-variant":"small-caps"}}>Doe</span> Jane, <span style={{"font-variant":"small-caps"}}>Doe</span> John, et <span style={{"font-variant":"small-caps"}}>Python</span> Monty, [s. d.], « Title #3 », <i>ABC</i>.
