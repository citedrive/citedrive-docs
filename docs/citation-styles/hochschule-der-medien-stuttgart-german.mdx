...
# Hochschule der Medien Stuttgart (German)

When you 're tasked by using "Hochschule der Medien Stuttgart (German)" (HdM Stuttgart) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Hochschule der Medien Stuttgart (German)

* Title: Hochschule der Medien Stuttgart (German)
* Short Title (Id): HdM Stuttgart)
* Authors: Hochschule der Medien Stuttgart (German)
* Download: Hochschule der Medien Stuttgart (German)
 --->

## How can CiteDrive help you with Hochschule der Medien Stuttgart (German)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Hochschule der Medien Stuttgart (German) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/hochschule-der-medien-stuttgart-german.svg "Choose Hochschule der Medien Stuttgart (German) in the CiteDrive App")
...
## How do I cite in  Hochschule der Medien Stuttgart (German)?
...
## How do I create a bibliography in Hochschule der Medien Stuttgart (German)?
...
!!! **Bibliography**
!!! <b>Doe, Jane (2008):</b> Title #1. In: <i>Imaginary Journal</i>, Band 3, 20081–999
!!! <b>Doe, Jane; Doe, John  (2021):</b> Title #2. 1.5.2021, URL: https://example.com/ [Zugriff: 1.5.2021]
!!! <b>Doe, Jane; Doe, John; Python, Monty</b> Title #3. In: <i>ABC</i>
