...
<!---
## About  Springer - MathPhys (numeric, brackets)

* Title: Springer - MathPhys (numeric, brackets)
* Short Title (Id): Popul Environ)
* Authors: Springer - MathPhys (numeric, brackets)
* Download: Springer - MathPhys (numeric, brackets)
 --->
...
![citedrive_style](images/springer--mathphys-numeric-brackets.svg "Choose Springer - MathPhys (numeric, brackets) in the CiteDrive App")
