...
When you 're tasked by using "Journal of the Indian Law Institute" (JILI) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Journal of the Indian Law Institute?

Let us produce some example in-text-citations:

! This sentence refers to the first item from the table. Jane Doe,, “Title #1”, 3 <i>Imaginary Journal</i> 1–999 (2008). This, in turn, refers to the second Jane Doe and John  Doe,, “Title #2”<i>available at</i>: https://example.com/ (last visited May 1, 2021).
! and then to the third.  Jane Doe, John Doe and Monty Python,, “Title #3” <i>ABC</i>.
! This paragraph demonstrates the clustering of citations by citing the first and third item. Jane Doe,, “Title #1”, 3 <i>Imaginary Journal</i> 1–999 (2008); Jane Doe, John Doe and Monty Python,, “Title #3” <i>ABC</i>.



## How do I create a bibliography in Journal of the Indian Law Institute?
