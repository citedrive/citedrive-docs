...
# Vietnam Ministry of Education and Training (Vietnamese)

When you 're tasked by using "Vietnam Ministry of Education and Training (Vietnamese)" (BGDDT_TV) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Vietnam Ministry of Education and Training (Vietnamese)

* Title: Vietnam Ministry of Education and Training (Vietnamese)
* Short Title (Id): BGDDT_TV)
* Authors: Vietnam Ministry of Education and Training (Vietnamese)
* Download: Vietnam Ministry of Education and Training (Vietnamese)
 --->

## How can CiteDrive help you with Vietnam Ministry of Education and Training (Vietnamese)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Vietnam Ministry of Education and Training (Vietnamese) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/vietnam-ministry-of-education-and-training-vietnamese.svg "Choose Vietnam Ministry of Education and Training (Vietnamese) in the CiteDrive App")
...
## How do I cite in  Vietnam Ministry of Education and Training (Vietnamese)?
...
## How do I create a bibliography in Vietnam Ministry of Education and Training (Vietnamese)?
...
!!! 2.Doe J. và Doe J.  Title #2. <https://example.com/>, accessed: 01/05/2021.
!!! 3.Doe J., Doe J.và Python M.  Title #3. <i>ABC</i>..
