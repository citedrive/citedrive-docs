...
When you 're tasked by using "Sylwan (Polish)" (TOSEM) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I cite in  Sylwan (Polish)?
...
This sentence refers to the first item from the table. [Doe 2008] This, in turn, refers to the second [Doe, Doe b.d.]
and then to the third.  [Doe b.d.]
This paragraph demonstrates the clustering of citations by citing the first and third item. [Doe 2008; Doe b.d.]

:::

## How do I create a bibliography in Sylwan (Polish)?
...
Doe J., Doe J.  (b.d.) Title #2.. https://example.com/ (udostępniono 1 maj 2021)

Doe J., Doe J., Python M.  (b.d.) Title #3. <i>ABC</i>.
