...
When you 're tasked by using "The Auk" (APA (numeric, superscript, brackets)) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## How do I create a bibliography in The Auk?
...
Doe, J., and J. Doe (no date). Title #2. [Online.] Available at https://example.com/.

Doe, J., J. Doe, and M. Python (no date). Title #3. ABC.
