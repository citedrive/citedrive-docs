---
title: Smithsonian Institution Scholarly Press (note)
author: Jospeh Moe
...
When you 're tasked by using "Smithsonian Institution Scholarly Press (note)" (SISP) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Smithsonian Institution Scholarly Press (note)
* **Title:** Smithsonian Institution Scholarly Press (note)
* **Type:** note
* **Short Title (Id):** SISP)
* fields: , generic-base
...
## How do I cite in  Smithsonian Institution Scholarly Press (note)?
...
This sentence refers to the first item from the table. J. Doe, “Title #1”, <i>Imaginary Journal</i> 3 (2008): 1–999. This, in turn, refers to the second J. Doe and J. Doe, “Title #2”, accessed May 1, 2021.
and then to the third.  J. Doe, J. Doeand M. Python, “Title #3”, <i>ABC</i>, n.d..
...
## How do I create a bibliography in Smithsonian Institution Scholarly Press (note)?
...
Doe, J.and J. Doe. “Title #2”. Accessed May 1, 2021. https://example.com/.
