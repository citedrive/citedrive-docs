...
<!---
## About  Nature (no "et al.")

* Title: Nature (no "et al.")
* Short Title (Id): Int J Digit Libr)
* Authors: Nature (no "et al.")
* Download: Nature (no "et al.")
 --->
...
![citedrive_style](images/nature-no-et-al.svg "Choose Nature (no "et al.") in the CiteDrive App")
