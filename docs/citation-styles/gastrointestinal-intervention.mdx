...
* Short Title (Id): GII)
* Authors: Gastrointestinal Intervention
* Download: Gastrointestinal Intervention
 --->
...
![citedrive_style](images/gastrointestinal-intervention.svg "Choose Gastrointestinal Intervention in the CiteDrive App")
