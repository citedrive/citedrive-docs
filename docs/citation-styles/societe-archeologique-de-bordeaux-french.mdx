...
When you 're tasked by using "Société Archéologique de Bordeaux (French)" (SAB) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
<!---
## About  Société Archéologique de Bordeaux (French)

* Title: Société Archéologique de Bordeaux (French)
* Short Title (Id): SAB)
* Authors: Société Archéologique de Bordeaux (French)
* Download: Société Archéologique de Bordeaux (French)
 --->

## How can CiteDrive help you with Société Archéologique de Bordeaux (French)?

We designed CiteDrive from the ground up to be as simple and easy to use as possible - you 've got more important things to do than to worry about bibliographies. Simply with CiteDrive, you create a library for your work. Collect all the items you need to cite, and we do the rest. Click on "create bibliography" when you 're ready. We then create citations and the bibliography in Société Archéologique de Bordeaux (French) for you. For in-text-citations, simply select one or multiple items and press on the "cite"-button. Add collaborators to your project if you are working with other students on your project. Anyone can make changes at any time.


![citedrive_style](images/societe-archeologique-de-bordeaux-french.svg "Choose Société Archéologique de Bordeaux (French) in the CiteDrive App")
...
## How do I cite in  Société Archéologique de Bordeaux (French)?
...
## How do I create a bibliography in Société Archéologique de Bordeaux (French)?
...
!!! **Bibliography**
!!! Doe, Jane. « Title #1, <i>Imaginary Journal</i>, 2008, 3, 1‑999..
!!! Doe, Jane et Doe, John . <i><i>Title #2</i></i> , (https://example.com/) [consulté le 1 mai 2021].
