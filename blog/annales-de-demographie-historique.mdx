---
title: Annales de démographie historique
author: Jospeh Moe
author_title: CiteDrive Bot
author_url: https://citedrive.com/
tags: [author-date, history]
---

When you 're tasked by using "Annales de démographie historique" (ADH) for your term paper, bachelor 's, or master 's thesis to create citations and bibliographies.
...
## Details  Annales de démographie historique
* **Title:** Annales de démographie historique
* **Type:** author-date
* **Short Title (Id):** ADH)
* fields: , history
...
## How do I cite in  Annales de démographie historique?
...
## How do I create a bibliography in Annales de démographie historique?
...
<span style={{"font-variant":"small-caps"}}>Doe, Jane</span> (2008),  “Title #1”, Imaginary Journal, <i><i>Imaginary Journal</i></i>,  3, 1–999..

<span style={{"font-variant":"small-caps"}}>Doe, Jane, Doe, John </span>  (n.d.),  “Title #2”,  Retrieved  May 1, 2021,  from https://example.com/.

<span style={{"font-variant":"small-caps"}}>Doe, Jane, Doe, John, Python, Monty</span>  (n.d.),  “Title #3”, ABC, <i><i>ABC</i></i>, .
